 ...
 */
MBEDTLS_CHECK_RETURN_TYPICAL
static inline int mbedtls_md_file(const mbedtls_md_info_t *md_info, const char *path,
                    unsigned char *output);
#endif /* MBEDTLS_FS_IO */
 ...
 */
MBEDTLS_CHECK_RETURN_TYPICAL
static inline int mbedtls_md_hmac_starts(mbedtls_md_context_t *ctx, const unsigned char *key,
                           size_t keylen);
 ...
 */
MBEDTLS_CHECK_RETURN_TYPICAL
static inline int mbedtls_md_hmac_update(mbedtls_md_context_t *ctx, const unsigned char *input,
                           size_t ilen);
 ...
 */
MBEDTLS_CHECK_RETURN_TYPICAL
static inline int mbedtls_md_hmac(const mbedtls_md_info_t *md_info, const unsigned char *key, size_t keylen,
