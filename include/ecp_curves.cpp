...
static inline  const unsigned char curve25519_part_of_n[] = {
...
static inline  const unsigned char curve448_part_of_n[] = {
 ...
 */
static inline  void mbedtls_ecp_fix_negative(mbedtls_mpi *N, signed char c, size_t bits)
{
    size_t i;
