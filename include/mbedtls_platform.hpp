...
/* For size_t */
#include <stddef.h>
static inline  void *mbedtls_calloc(size_t n, size_t size);
...
/* We need FILE * */
#include <stdio.h>
static inline  int (*mbedtls_fprintf)(FILE *stream, const char *format, ...);
 ...
 * \return               \c 0.
 */
static inline int mbedtls_platform_set_fprintf(int (*fprintf_func)(FILE *stream, const char *,
                                                     ...));
#else
...
//static inline  int (*mbedtls_snprintf)(char *s, size_t n, const char *format, ...);
...
#include <stdarg.h>
//static inline  int (*mbedtls_vsnprintf)(char *s, size_t n, const char *format, va_list arg);
 ...
 *                         `buf` equal to `NULL`.
 */
static inline  void (*mbedtls_setbuf)(FILE *stream, char *buf);
 ...
 * \return                 \c 0
 */
static inline int mbedtls_platform_set_setbuf(void (*setbuf_func)(
...
static inline  void (*mbedtls_exit)(int status);
