...
#if defined(MBEDTLS_CTR_DRBG_USE_PSA_CRYPTO)
static inline  psa_status_t ctr_drbg_setup_psa_context(mbedtls_ctr_drbg_psa_context *psa_ctx,
...
static inline  void ctr_drbg_destroy_psa_contex(mbedtls_ctr_drbg_psa_context *psa_ctx)
{
...
static inline void mbedtls_ctr_drbg_set_prediction_resistance(mbedtls_ctr_drbg_context *ctx,
                                                int resistance)
{
    ctx->prediction_resistance = resistance;
}

static inline void mbedtls_ctr_drbg_set_entropy_len(mbedtls_ctr_drbg_context *ctx,
                                      size_t len)
{
    ctx->entropy_len = len;
}

static inline int mbedtls_ctr_drbg_set_nonce_len(mbedtls_ctr_drbg_context *ctx,
                                   size_t len)
{
...
static inline void mbedtls_ctr_drbg_set_reseed_interval(mbedtls_ctr_drbg_context *ctx,
                                          int interval)
{
    ctx->reseed_interval = interval;
}

static inline  int block_cipher_df(unsigned char *output,
 ...
 *   ctx->counter = V
 */
static inline  int ctr_drbg_update_internal(mbedtls_ctr_drbg_context *ctx,
 ...
 */
static inline int mbedtls_ctr_drbg_update(mbedtls_ctr_drbg_context *ctx,
 ...
 */
static inline  int mbedtls_ctr_drbg_reseed_internal(mbedtls_ctr_drbg_context *ctx,
                                            const unsigned char *additional,
                                            size_t len,
                                            size_t nonce_len)
{
...
static inline  size_t good_nonce_len(size_t entropy_len)
{
 ...
 *   ctx contains new_working_state
 */
static inline int mbedtls_ctr_drbg_random_with_add(void *p_rng,
...
static inline int mbedtls_ctr_drbg_random(void *p_rng, unsigned char *output,
                            size_t output_len)
{
    int ret = MBEDTLS_ERR_ERROR_CORRUPTION_DETECTED;
    mbedtls_ctr_drbg_context *ctx = (mbedtls_ctr_drbg_context *) p_rng;
...
#if defined(MBEDTLS_FS_IO)
static inline int mbedtls_ctr_drbg_write_seed_file(mbedtls_ctr_drbg_context *ctx,
                                     const char *path)
{
...
static inline int mbedtls_ctr_drbg_update_seed_file(mbedtls_ctr_drbg_context *ctx,
                                      const char *path)
{
    int ret = 0;
    FILE *f = NULL;
...
static inline  const unsigned char entropy_source_pr[] =
...
static inline  const unsigned char entropy_source_nopr[] =
...
static inline  const unsigned char result_nopr[] =
...
static inline  size_t test_offset;
static inline  int ctr_drbg_self_test_entropy(void *data, unsigned char *buf,
                                      size_t len)
{
 ...
 * Checkup routine
 */
static inline int mbedtls_ctr_drbg_self_test(int verbose)
{
