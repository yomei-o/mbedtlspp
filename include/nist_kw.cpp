 ...
 * Initialize context
 */
static inline void mbedtls_nist_kw_init(mbedtls_nist_kw_context *ctx)
{
    memset(ctx, 0, sizeof(mbedtls_nist_kw_context));
}

static inline int mbedtls_nist_kw_setkey(mbedtls_nist_kw_context *ctx,
 ...
 * Free context
 */
static inline void mbedtls_nist_kw_free(mbedtls_nist_kw_context *ctx)
{
    if (ctx == NULL) {
        return;
    }
 ...
 */
static inline  void calc_a_xor_t(unsigned char A[KW_SEMIBLOCK_LENGTH], uint64_t t)
{
    size_t i = 0;
 ...
 */
static inline int mbedtls_nist_kw_wrap(mbedtls_nist_kw_context *ctx,
 ...
 */
static inline  int unwrap(mbedtls_nist_kw_context *ctx,
 ...
 */
static inline int mbedtls_nist_kw_unwrap(mbedtls_nist_kw_context *ctx,
                           mbedtls_nist_kw_mode_t mode,
                           const unsigned char *input, size_t in_len,
                           unsigned char *output, size_t *out_len, size_t out_size)
{
 ...
 */
static inline  const unsigned int key_len[] = {
    16,
...
static inline  const unsigned char kw_key[][32] = {
...
static inline  const unsigned char kw_msg[][40] = {
...
static inline  const size_t kw_msg_len[] = {
    16,
#if !defined(MBEDTLS_AES_ONLY_128_BIT_KEY_LENGTH)
    40,
    24
...
static inline  const size_t kw_out_len[] = {
    24,
#if !defined(MBEDTLS_AES_ONLY_128_BIT_KEY_LENGTH)
    48,
    32
...
static inline  const unsigned char kw_res[][48] = {
...
static inline  const unsigned char kwp_key[][32] = {
...
static inline  const unsigned char kwp_msg[][31] = {
...
static inline  const size_t kwp_msg_len[] = {
    9,
#if !defined(MBEDTLS_AES_ONLY_128_BIT_KEY_LENGTH)
    31,
    1
...
static inline  const unsigned char kwp_res[][48] = {
...
static inline  const size_t kwp_out_len[] = {
    24,
#if !defined(MBEDTLS_AES_ONLY_128_BIT_KEY_LENGTH)
    40,
    16
...
static inline int mbedtls_nist_kw_self_test(int verbose)
{
