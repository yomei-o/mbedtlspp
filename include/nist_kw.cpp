...
static inline  int verify_input(mbedtls_svc_key_id_t *key)
{
    int ret = PSA_SUCCESS;
 ...
 */
static inline psa_status_t mbedtls_nist_kw_wrap(mbedtls_svc_key_id_t key,
 ...
 */
static inline  int unwrap(const unsigned char *input, size_t semiblocks,
 ...
 */
static inline psa_status_t mbedtls_nist_kw_unwrap(mbedtls_svc_key_id_t key,
                                    mbedtls_nist_kw_mode_t mode,
                                    const unsigned char *input, size_t input_length,
