 ...
 */
static inline int mbedtls_pk_wrap_psa(mbedtls_pk_context *ctx,
 ...
 *          this function.
 */
static inline  int is_alg_compatible_with_key(psa_algorithm_t check_alg,
...
static inline  int is_psa_key_compatible_with_alg_usage(mbedtls_svc_key_id_t key_id,
                                                psa_algorithm_t alg,
                                                psa_key_usage_t usage)
{
...
static inline int mbedtls_pk_can_do_psa(const mbedtls_pk_context *pk, psa_algorithm_t alg,
                          psa_key_usage_t usage)
{
    /* A context with null pk_info is not set up yet and can't do anything. */
 ...
 */
static inline int mbedtls_pk_verify_ext(mbedtls_pk_sigalg_t type,
 ...
 */
static inline int mbedtls_pk_sign_ext(mbedtls_pk_sigalg_t pk_type,
