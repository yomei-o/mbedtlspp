 ...
 */
static inline const mbedtls_pk_info_t *mbedtls_pk_info_from_type(mbedtls_pk_type_t pk_type);
 ...
 *                  This must not be \c NULL.
 */
static inline void mbedtls_pk_restart_init(mbedtls_pk_restart_ctx *ctx);
 ...
 *                  If this is \c NULL, this function does nothing.
 */
static inline void mbedtls_pk_restart_free(mbedtls_pk_restart_ctx *ctx);
#endif /* MBEDTLS_ECDSA_C && MBEDTLS_ECP_RESTARTABLE */
 ...
 */
static inline int mbedtls_pk_setup(mbedtls_pk_context *ctx, const mbedtls_pk_info_t *info);
 ...
 */
static inline int mbedtls_pk_setup_opaque(mbedtls_pk_context *ctx,
 ...
 */
static inline int mbedtls_pk_setup_rsa_alt(mbedtls_pk_context *ctx, void *key,
 ...
 */
static inline int mbedtls_pk_can_do(const mbedtls_pk_context *ctx, mbedtls_pk_type_t type);
 ...
 */
static inline int mbedtls_pk_can_do_ext(const mbedtls_pk_context *ctx, psa_algorithm_t alg,
 ...
 *                  Another error code on other failures.
 */
static inline int mbedtls_pk_import_into_psa(const mbedtls_pk_context *pk,
 ...
 */
static inline int mbedtls_pk_copy_from_psa(mbedtls_svc_key_id_t key_id, mbedtls_pk_context *pk);
 ...
 *                  parameters are not correct.
 */
static inline int mbedtls_pk_copy_public_from_psa(mbedtls_svc_key_id_t key_id, mbedtls_pk_context *pk);
 ...
 */
static inline int mbedtls_pk_verify(mbedtls_pk_context *ctx, mbedtls_md_type_t md_alg,
 ...
 */
static inline int mbedtls_pk_verify_restartable(mbedtls_pk_context *ctx,
 ...
 */
static inline int mbedtls_pk_verify_ext(mbedtls_pk_type_t type, const void *options,
 ...
 *
 */
static inline int mbedtls_pk_sign_ext(mbedtls_pk_type_t pk_type,
 ...
 *                  operations was reached: see \c mbedtls_ecp_set_max_ops().
 */
static inline int mbedtls_pk_sign_restartable(mbedtls_pk_context *ctx,
                                mbedtls_md_type_t md_alg,
                                const unsigned char *hash, size_t hash_len,
                                unsigned char *sig, size_t sig_size, size_t *sig_len,
 ...
 * \return          0 on success, or a specific error code.
 */
static inline int mbedtls_pk_decrypt(mbedtls_pk_context *ctx,
 ...
 * \return          0 on success, or a specific error code.
 */
static inline int mbedtls_pk_encrypt(mbedtls_pk_context *ctx,
                       const unsigned char *input, size_t ilen,
                       unsigned char *output, size_t *olen, size_t osize,
                       int (*f_rng)(void *, unsigned char *, size_t), void *p_rng);
 ...
 * \return          0 if successful, or a specific PK or PEM error code
 */
static inline int mbedtls_pk_parse_keyfile(mbedtls_pk_context *ctx,
 ...
 * \return          0 if successful, or a specific PK or PEM error code
 */
static inline int mbedtls_pk_parse_public_keyfile(mbedtls_pk_context *ctx, const char *path);
#endif /* MBEDTLS_FS_IO */
 ...
 *                  error code
 */
static inline int mbedtls_pk_write_key_der(const mbedtls_pk_context *ctx, unsigned char *buf, size_t size);
 ...
 *                  error code
 */
static inline int mbedtls_pk_write_pubkey_der(const mbedtls_pk_context *ctx, unsigned char *buf, size_t size);
 ...
 */
static inline int mbedtls_pk_write_pubkey_pem(const mbedtls_pk_context *ctx, unsigned char *buf, size_t size);
 ...
 * \return          0 if successful, or a specific error code
 */
static inline int mbedtls_pk_write_key_pem(const mbedtls_pk_context *ctx, unsigned char *buf, size_t size);
 ...
 */
static inline int mbedtls_pk_parse_subpubkey(unsigned char **p, const unsigned char *end,
 ...
 */
static inline int mbedtls_pk_write_pubkey(unsigned char **p, unsigned char *start,
