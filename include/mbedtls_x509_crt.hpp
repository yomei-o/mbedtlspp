 ...
 *                  are supported.
 */
static inline int mbedtls_x509write_crt_set_subject_alternative_name(mbedtls_x509write_cert *ctx,
 ...
 *
 */
static inline int mbedtls_x509_crt_parse(mbedtls_x509_crt *chain, const unsigned char *buf, size_t buflen);
 ...
 */
static inline void mbedtls_x509write_crt_init(mbedtls_x509write_cert *ctx);
 ...
 */
static inline void mbedtls_x509write_crt_set_version(mbedtls_x509write_cert *ctx, int version);
 ...
 */
static inline int MBEDTLS_DEPRECATED mbedtls_x509write_crt_set_serial(
 ...
 */
static inline int mbedtls_x509write_crt_set_validity(mbedtls_x509write_cert *ctx, const char *not_before,
 ...
 *                  a specific error code
 */
static inline int mbedtls_x509write_crt_set_issuer_name(mbedtls_x509write_cert *ctx,
 ...
 *                  a specific error code
 */
static inline int mbedtls_x509write_crt_set_subject_name(mbedtls_x509write_cert *ctx,
 ...
 */
static inline void mbedtls_x509write_crt_set_subject_key(mbedtls_x509write_cert *ctx, mbedtls_pk_context *key);
 ...
 */
static inline void mbedtls_x509write_crt_set_issuer_key(mbedtls_x509write_cert *ctx, mbedtls_pk_context *key);
 ...
 */
static inline void mbedtls_x509write_crt_set_md_alg(mbedtls_x509write_cert *ctx, mbedtls_md_type_t md_alg);
 ...
 */
static inline int mbedtls_x509write_crt_set_extension(mbedtls_x509write_cert *ctx,
 ...
 * \return          0 if successful, or a MBEDTLS_ERR_X509_ALLOC_FAILED
 */
static inline int mbedtls_x509write_crt_set_basic_constraints(mbedtls_x509write_cert *ctx,
 ...
 * \return          0 if successful, or a MBEDTLS_ERR_X509_ALLOC_FAILED
 */
static inline int mbedtls_x509write_crt_set_subject_key_identifier(mbedtls_x509write_cert *ctx);
 ...
 * \return          0 if successful, or a MBEDTLS_ERR_X509_ALLOC_FAILED
 */
static inline int mbedtls_x509write_crt_set_authority_key_identifier(mbedtls_x509write_cert *ctx);
 ...
 * \return          0 if successful, or MBEDTLS_ERR_X509_ALLOC_FAILED
 */
static inline int mbedtls_x509write_crt_set_key_usage(mbedtls_x509write_cert *ctx,
 ...
 * \return          0 if successful, or MBEDTLS_ERR_X509_ALLOC_FAILED
 */
static inline int mbedtls_x509write_crt_set_ext_key_usage(mbedtls_x509write_cert *ctx,
 ...
 * \return          0 if successful, or MBEDTLS_ERR_X509_ALLOC_FAILED
 */
static inline int mbedtls_x509write_crt_set_ns_cert_type(mbedtls_x509write_cert *ctx,
 ...
 */
static inline void mbedtls_x509write_crt_free(mbedtls_x509write_cert *ctx);
 ...
 */
static inline int mbedtls_x509write_crt_der(mbedtls_x509write_cert *ctx, unsigned char *buf, size_t size,
 ...
 * \note            \p f_rng is used for the signature operation.
 */
static inline int mbedtls_x509write_crt_pem(mbedtls_x509write_cert *ctx, unsigned char *buf, size_t size,
                              int (*f_rng)(void *, unsigned char *, size_t),
                              void *p_rng);
