...
static inline  int ssl_write_hostname_ext(mbedtls_ssl_context *ssl,
                                  unsigned char *buf,
 ...
 */
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_write_alpn_ext(mbedtls_ssl_context *ssl,
                              unsigned char *buf,
                              const unsigned char *end,
                              size_t *out_len)
{
...
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_write_supported_groups_ext(mbedtls_ssl_context *ssl,
                                          unsigned char *buf,
                                          const unsigned char *end,
                                          int flags,
                                          size_t *out_len)
...
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_write_client_hello_cipher_suites(
 ...
 */
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_write_client_hello_body(mbedtls_ssl_context *ssl,
                                       unsigned char *buf,
                                       unsigned char *end,
                                       size_t *out_len,
                                       size_t *binders_len)
...
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_generate_random(mbedtls_ssl_context *ssl)
{
...
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_prepare_client_hello(mbedtls_ssl_context *ssl)
{
    int ret;
 ...
 */
static inline int mbedtls_ssl_write_client_hello(mbedtls_ssl_context *ssl)
{
    int ret = 0;
    unsigned char *buf;
