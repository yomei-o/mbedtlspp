...
static inline void mbedtls_md5_clone(mbedtls_md5_context *dst,
...
static inline int mbedtls_internal_md5_process(mbedtls_md5_context *ctx,
 ...
 */
static inline  const unsigned char md5_test_buf[7][81] =
{
    { "" },
    { "a" },
    { "abc" },
...
static inline  const size_t md5_test_buflen[7] =
{
    0, 1, 3, 14, 26, 62, 80
};

static inline  const unsigned char md5_test_sum[7][16] =
{
 ...
 * Checkup routine
 */
static inline int mbedtls_md5_self_test(int verbose)
{
    int i, ret = 0;
