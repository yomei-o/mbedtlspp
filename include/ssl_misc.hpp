...
#include "ssl_ciphersuites_internal.hpp"
...
struct mbedtls_ssl_handshake_params {
    ...
    struct {
        ...
        struct mbedtls_ssl_hs_buffer hs[MBEDTLS_SSL_MAX_BUFFERED_HS];
 ...
 */
MBEDTLS_CHECK_RETURN_CRITICAL
static inline int mbedtls_ssl_tls12_write_client_hello_exts(mbedtls_ssl_context *ssl,
                                              unsigned char *buf,
 ...
 */
static inline void mbedtls_ssl_transform_free(mbedtls_ssl_transform *transform);
...
static inline void mbedtls_ssl_set_inbound_transform(mbedtls_ssl_context *ssl,
                                       mbedtls_ssl_transform *transform);

/* set outbound transform of ssl context */
static inline void mbedtls_ssl_set_outbound_transform(mbedtls_ssl_context *ssl,
                                        mbedtls_ssl_transform *transform);

MBEDTLS_CHECK_RETURN_CRITICAL
static inline int mbedtls_ssl_handshake_client_step(mbedtls_ssl_context *ssl);
MBEDTLS_CHECK_RETURN_CRITICAL
static inline int mbedtls_ssl_handshake_server_step(mbedtls_ssl_context *ssl);
 ...
 */
static inline const char *mbedtls_ssl_states_str(mbedtls_ssl_states state);
#endif
...
MBEDTLS_CHECK_RETURN_CRITICAL
static inline int mbedtls_ssl_send_fatal_handshake_failure(mbedtls_ssl_context *ssl);
...
MBEDTLS_CHECK_RETURN_CRITICAL
static inline int mbedtls_ssl_handle_message_type(mbedtls_ssl_context *ssl);
MBEDTLS_CHECK_RETURN_CRITICAL
static inline int mbedtls_ssl_prepare_handshake_record(mbedtls_ssl_context *ssl);
MBEDTLS_CHECK_RETURN_CRITICAL
static inline int mbedtls_ssl_update_handshake_status(mbedtls_ssl_context *ssl);
 ...
 */
MBEDTLS_CHECK_RETURN_CRITICAL
static inline int mbedtls_ssl_read_record(mbedtls_ssl_context *ssl,
                            unsigned update_hs_digest);
MBEDTLS_CHECK_RETURN_CRITICAL
static inline int mbedtls_ssl_fetch_input(mbedtls_ssl_context *ssl, size_t nb_want);

/*
 * Write handshake message header
 */
MBEDTLS_CHECK_RETURN_CRITICAL
static inline int mbedtls_ssl_start_handshake_msg(mbedtls_ssl_context *ssl, unsigned char hs_type,
                                    unsigned char **buf, size_t *buf_len);

MBEDTLS_CHECK_RETURN_CRITICAL
static inline int mbedtls_ssl_write_handshake_msg_ext(mbedtls_ssl_context *ssl,
                                        int update_checksum,
                                        int force_flush);
 ...
 */
MBEDTLS_CHECK_RETURN_CRITICAL
static inline int mbedtls_ssl_finish_handshake_msg(mbedtls_ssl_context *ssl,
                                     size_t buf_len, size_t msg_len);

MBEDTLS_CHECK_RETURN_CRITICAL
static inline int mbedtls_ssl_write_record(mbedtls_ssl_context *ssl, int force_flush);
MBEDTLS_CHECK_RETURN_CRITICAL
static inline int mbedtls_ssl_flush_output(mbedtls_ssl_context *ssl);
...
MBEDTLS_CHECK_RETURN_CRITICAL
static inline int mbedtls_ssl_parse_change_cipher_spec(mbedtls_ssl_context *ssl);
MBEDTLS_CHECK_RETURN_CRITICAL
static inline int mbedtls_ssl_write_change_cipher_spec(mbedtls_ssl_context *ssl);
...
#if !defined(MBEDTLS_USE_PSA_CRYPTO)
MBEDTLS_CHECK_RETURN_CRITICAL
static inline int mbedtls_ssl_psk_derive_premaster(mbedtls_ssl_context *ssl,
...
static inline void mbedtls_ssl_write_version(unsigned char version[2], int transport,
                               mbedtls_ssl_protocol_version tls_version);
static inline uint16_t mbedtls_ssl_read_version(const unsigned char version[2],
                                  int transport);
...
#if defined(MBEDTLS_SSL_PROTO_DTLS)
static inline void mbedtls_ssl_send_flight_completed(mbedtls_ssl_context *ssl);
static inline void mbedtls_ssl_recv_flight_completed(mbedtls_ssl_context *ssl);
MBEDTLS_CHECK_RETURN_CRITICAL
static inline int mbedtls_ssl_resend(mbedtls_ssl_context *ssl);
MBEDTLS_CHECK_RETURN_CRITICAL
static inline int mbedtls_ssl_flight_transmit(mbedtls_ssl_context *ssl);
#endif

/* Visible for testing purposes only */
#if defined(MBEDTLS_SSL_DTLS_ANTI_REPLAY)
MBEDTLS_CHECK_RETURN_CRITICAL
static inline int mbedtls_ssl_dtls_replay_check(mbedtls_ssl_context const *ssl);
static inline void mbedtls_ssl_dtls_replay_update(mbedtls_ssl_context *ssl);
#endif
...
MBEDTLS_CHECK_RETURN_CRITICAL
static inline int mbedtls_ssl_encrypt_buf(mbedtls_ssl_context *ssl,
                            mbedtls_ssl_transform *transform,
                            mbedtls_record *rec,
                            int (*f_rng)(void *, unsigned char *, size_t),
                            void *p_rng);
MBEDTLS_CHECK_RETURN_CRITICAL
static inline int mbedtls_ssl_decrypt_buf(mbedtls_ssl_context const *ssl,
                            mbedtls_ssl_transform *transform,
                            mbedtls_record *rec);
...
static inline void mbedtls_ssl_set_timer(mbedtls_ssl_context *ssl, uint32_t millisecs);
MBEDTLS_CHECK_RETURN_CRITICAL
static inline int mbedtls_ssl_check_timer(mbedtls_ssl_context *ssl);

static inline void mbedtls_ssl_reset_in_pointers(mbedtls_ssl_context *ssl);
static inline void mbedtls_ssl_update_in_pointers(mbedtls_ssl_context *ssl);
static inline void mbedtls_ssl_reset_out_pointers(mbedtls_ssl_context *ssl);
static inline void mbedtls_ssl_update_out_pointers(mbedtls_ssl_context *ssl,
                                     mbedtls_ssl_transform *transform);
 ...
 */
MBEDTLS_CHECK_RETURN_CRITICAL
static inline int mbedtls_ssl_handle_pending_alert(mbedtls_ssl_context *ssl);

/*
 * Set pending fatal alert flag.
 */
static inline void mbedtls_ssl_pend_fatal_alert(mbedtls_ssl_context *ssl,
...
#if defined(MBEDTLS_SSL_DTLS_ANTI_REPLAY)
static inline void mbedtls_ssl_dtls_replay_reset(mbedtls_ssl_context *ssl);
#endif
...
static inline void mbedtls_ssl_buffering_free(mbedtls_ssl_context *ssl);
static inline void mbedtls_ssl_flight_free(mbedtls_ssl_flight_item *flight);
#endif /* MBEDTLS_SSL_PROTO_DTLS */
...
//static inlone const uint8_t mbedtls_ssl_tls13_hello_retry_request_magic[
//    MBEDTLS_SERVER_HELLO_RANDOM_LEN];
MBEDTLS_CHECK_RETURN_CRITICAL
static inline int mbedtls_ssl_tls13_process_finished_message(mbedtls_ssl_context *ssl);
MBEDTLS_CHECK_RETURN_CRITICAL
static inline int mbedtls_ssl_tls13_write_finished_message(mbedtls_ssl_context *ssl);
static inline void mbedtls_ssl_tls13_handshake_wrapup(mbedtls_ssl_context *ssl);
 ...
 */
MBEDTLS_CHECK_RETURN_CRITICAL
static inline int mbedtls_ssl_tls13_write_client_hello_exts(mbedtls_ssl_context *ssl,
                                              unsigned char *buf,
                                              unsigned char *end,
                                              size_t *out_len);
 ...
 */
MBEDTLS_CHECK_RETURN_CRITICAL
static inline int mbedtls_ssl_tls13_handshake_client_step(mbedtls_ssl_context *ssl);
 ...
 */
MBEDTLS_CHECK_RETURN_CRITICAL
static inline int mbedtls_ssl_tls13_handshake_server_step(mbedtls_ssl_context *ssl);
...
MBEDTLS_CHECK_RETURN_CRITICAL
static inline int mbedtls_ssl_tls13_check_received_extension(
    mbedtls_ssl_context *ssl,
    int hs_msg_type,
 ...
 */
MBEDTLS_CHECK_RETURN_CRITICAL
static inline int mbedtls_ssl_tls13_fetch_handshake_msg(mbedtls_ssl_context *ssl,
                                          unsigned hs_type,
                                          unsigned char **buf,
                                          size_t *buf_len);
 ...
 */
MBEDTLS_CHECK_RETURN_CRITICAL
static inline int mbedtls_ssl_tls13_is_supported_versions_ext_present_in_exts(
    mbedtls_ssl_context *ssl,
 ...
 */
MBEDTLS_CHECK_RETURN_CRITICAL
static inline int mbedtls_ssl_tls13_process_certificate(mbedtls_ssl_context *ssl);
 ...
 */
MBEDTLS_CHECK_RETURN_CRITICAL
static inline int mbedtls_ssl_tls13_write_certificate(mbedtls_ssl_context *ssl);

/*
 * Handler of TLS 1.3 write Certificate Verify message
 */
MBEDTLS_CHECK_RETURN_CRITICAL
static inline int mbedtls_ssl_tls13_write_certificate_verify(mbedtls_ssl_context *ssl);
 ...
 */
MBEDTLS_CHECK_RETURN_CRITICAL
static inline int mbedtls_ssl_tls13_process_certificate_verify(mbedtls_ssl_context *ssl);

/*
 * Write of dummy-CCS's for middlebox compatibility
 */
MBEDTLS_CHECK_RETURN_CRITICAL
static inline int mbedtls_ssl_tls13_write_change_cipher_spec(mbedtls_ssl_context *ssl);

MBEDTLS_CHECK_RETURN_CRITICAL
static inline int mbedtls_ssl_reset_transcript_for_hrr(mbedtls_ssl_context *ssl);

#if defined(PSA_WANT_ALG_ECDH) || defined(PSA_WANT_ALG_FFDH)
MBEDTLS_CHECK_RETURN_CRITICAL
static inline int mbedtls_ssl_tls13_generate_and_write_xxdh_key_exchange(
    mbedtls_ssl_context *ssl,
...
#if defined(MBEDTLS_SSL_EARLY_DATA)
static inline int mbedtls_ssl_tls13_write_early_data_ext(mbedtls_ssl_context *ssl,
                                           int in_new_session_ticket,
                                           unsigned char *buf,
                                           const unsigned char *end,
                                           size_t *out_len);

static inline int mbedtls_ssl_tls13_check_early_data_len(mbedtls_ssl_context *ssl,
...
MBEDTLS_CHECK_RETURN_CRITICAL
static inline int mbedtls_ssl_tls13_check_sig_alg_cert_key_match(uint16_t sig_alg,
...
MBEDTLS_CHECK_RETURN_CRITICAL
static inline int mbedtls_ssl_tls13_read_public_xxdhe_share(mbedtls_ssl_context *ssl,
                                              const unsigned char *buf,
                                              size_t buf_len);
...
MBEDTLS_CHECK_RETURN_CRITICAL
static inline int mbedtls_ssl_tls13_parse_record_size_limit_ext(mbedtls_ssl_context *ssl,
                                                  const unsigned char *buf,
                                                  const unsigned char *end);

MBEDTLS_CHECK_RETURN_CRITICAL
static inline int mbedtls_ssl_tls13_write_record_size_limit_ext(mbedtls_ssl_context *ssl,
                                                  unsigned char *buf,
                                                  const unsigned char *end,
                                                  size_t *out_len);
#endif /* MBEDTLS_SSL_RECORD_SIZE_LIMIT */
...
#if defined(MBEDTLS_TEST_HOOKS)
static inline int mbedtls_ssl_check_dtls_clihlo_cookie(
    mbedtls_ssl_context *ssl,
 ...
 */
MBEDTLS_CHECK_RETURN_CRITICAL
static inline int mbedtls_ssl_tls13_write_identities_of_pre_shared_key_ext(
    mbedtls_ssl_context *ssl,
 ...
 */
MBEDTLS_CHECK_RETURN_CRITICAL
static inline int mbedtls_ssl_tls13_write_binders_of_pre_shared_key_ext(
    mbedtls_ssl_context *ssl,
    unsigned char *buf, unsigned char *end);
...
static inline int mbedtls_ssl_tls13_finalize_client_hello(mbedtls_ssl_context *ssl);
#endif
 ...
 */
#if defined(MBEDTLS_USE_PSA_CRYPTO)
static inline int mbedtls_ct_hmac(mbedtls_svc_key_id_t key,
...
#else
static inline int mbedtls_ct_hmac(mbedtls_md_context_t *ctx,
                    const unsigned char *add_data,
                    size_t add_data_len,
                    const unsigned char *data,
                    size_t data_len_secret,
