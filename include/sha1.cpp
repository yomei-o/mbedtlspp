 ...
 */
static inline  const unsigned char sha1_test_buf[3][57] =
{
    { "abc" },
...
static inline  const size_t sha1_test_buflen[3] =
{
    3, 56, 1000
};

static inline  const unsigned char sha1_test_sum[3][20] =
{
 ...
 * Checkup routine
 */
static inline int mbedtls_sha1_self_test(int verbose)
{
