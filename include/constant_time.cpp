 ...
 * the implementation").
 */
//static inline volatile mbedtls_ct_uint_t mbedtls_ct_zero = 0;
#endif
...
static inline int mbedtls_ct_memcmp(const void *a,
                      const void *b,
                      size_t n)
{
    size_t i = 0;
...
static inline int mbedtls_ct_memcmp_partial(const void *a,
                              const void *b,
                              size_t n,
                              size_t skip_head,
                              size_t skip_tail)
...
static inline void mbedtls_ct_memcpy_offset(unsigned char *dest,
