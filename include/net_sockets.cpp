...
#include "mbedtls_net_sockets.hpp"
...
static inline  int wsa_init_done = 0;
 ...
 */
static inline  int net_prepare(void)
{
#if (defined(_WIN32) || defined(_WIN32_WCE)) && !defined(EFIX64) && \
    !defined(EFI32)
    WSADATA wsaData;
 ...
 */
static inline  int check_fd(int fd, int for_select)
{
    if (fd < 0) {
 ...
 */
static inline void mbedtls_net_init(mbedtls_net_context *ctx)
{
    ctx->fd = -1;
}
 ...
 */
static inline int mbedtls_net_bind(mbedtls_net_context *ctx, const char *bind_ip, const char *port, int proto)
{
    int n, ret;
    struct addrinfo hints, *addr_list, *cur;
 ...
 */
static inline  int net_would_block(const mbedtls_net_context *ctx)
{
    ((void) ctx);
 ...
 */
static inline int mbedtls_net_set_block(mbedtls_net_context *ctx)
{
#if (defined(_WIN32) || defined(_WIN32_WCE)) && !defined(EFIX64) && \
    !defined(EFI32)
    u_long n = 0;
...
static inline int mbedtls_net_set_nonblock(mbedtls_net_context *ctx)
{
#if (defined(_WIN32) || defined(_WIN32_WCE)) && !defined(EFIX64) && \
    !defined(EFI32)
    u_long n = 1;
 ...
 */
static inline void mbedtls_net_usleep(unsigned long usec)
{
#if defined(_WIN32)
    Sleep((usec + 999) / 1000);
#else
 ...
 */
static inline int mbedtls_net_recv_timeout(void *ctx, unsigned char *buf,
 ...
 */
static inline void mbedtls_net_close(mbedtls_net_context *ctx)
{
    if (ctx->fd == -1) {
        return;
    }
