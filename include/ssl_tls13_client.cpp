...
static inline  int local_err_translation_4(psa_status_t status)
{
...
#define PSA_TO_MBEDTLS_ERR(status) local_err_translation_4(status)
#endif
...
static inline  int ssl_tls13_write_supported_versions_ext(mbedtls_ssl_context *ssl,
                                                  unsigned char *buf,
                                                  unsigned char *end,
                                                  size_t *out_len)
{
...
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_tls13_parse_supported_versions_ext(mbedtls_ssl_context *ssl,
...
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_tls13_parse_alpn_ext(mbedtls_ssl_context *ssl,
...
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_tls13_reset_key_share(mbedtls_ssl_context *ssl)
{
...
#if defined(MBEDTLS_SSL_TLS1_3_KEY_EXCHANGE_MODE_SOME_EPHEMERAL_ENABLED)
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_tls13_get_default_group_id(mbedtls_ssl_context *ssl,
                                          uint16_t *group_id)
{
 ...
 */
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_tls13_write_key_share_ext(mbedtls_ssl_context *ssl,
                                         unsigned char *buf,
                                         unsigned char *end,
                                         size_t *out_len)
{
 ...
 */
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_tls13_parse_hrr_key_share_ext(mbedtls_ssl_context *ssl,
                                             const unsigned char *buf,
                                             const unsigned char *end)
{
#if defined(PSA_WANT_ALG_ECDH) || defined(PSA_WANT_ALG_FFDH)
 ...
 */
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_tls13_parse_key_share_ext(mbedtls_ssl_context *ssl,
                                         const unsigned char *buf,
                                         const unsigned char *end)
{
    int ret = MBEDTLS_ERR_ERROR_CORRUPTION_DETECTED;
 ...
 */
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_tls13_parse_cookie_ext(mbedtls_ssl_context *ssl,
                                      const unsigned char *buf,
                                      const unsigned char *end)
{
    uint16_t cookie_len;
    ...
    handshake->cookie = (unsigned char*)mbedtls_calloc(1, cookie_len);
...
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_tls13_write_cookie_ext(mbedtls_ssl_context *ssl,
                                      unsigned char *buf,
                                      unsigned char *end,
                                      size_t *out_len)
{
 ...
 */
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_tls13_write_psk_key_exchange_modes_ext(mbedtls_ssl_context *ssl,
                                                      unsigned char *buf,
                                                      unsigned char *end,
                                                      size_t *out_len)
{
...
static inline  psa_algorithm_t ssl_tls13_get_ciphersuite_hash_alg(int ciphersuite)
{
...
static inline  int ssl_tls13_has_configured_ticket(mbedtls_ssl_context *ssl)
{
...
static inline  int ssl_tls13_early_data_has_valid_ticket(mbedtls_ssl_context *ssl)
{
    mbedtls_ssl_session *session = ssl->session_negotiate;
    return ssl->handshake->resume &&
...
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_tls13_ticket_get_identity(mbedtls_ssl_context *ssl,
...
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_tls13_ticket_get_psk(mbedtls_ssl_context *ssl,
                                    psa_algorithm_t *hash_alg,
...
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_tls13_psk_get_identity(mbedtls_ssl_context *ssl,
                                      psa_algorithm_t *hash_alg,
                                      const unsigned char **identity,
                                      size_t *identity_len)
{
...
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_tls13_psk_get_psk(mbedtls_ssl_context *ssl,
                                 psa_algorithm_t *hash_alg,
                                 const unsigned char **psk,
                                 size_t *psk_len)
{
...
static inline  int ssl_tls13_get_configured_psk_count(mbedtls_ssl_context *ssl)
{
...
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_tls13_write_identity(mbedtls_ssl_context *ssl,
                                    unsigned char *buf,
                                    unsigned char *end,
                                    const unsigned char *identity,
                                    size_t identity_len,
...
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_tls13_write_binder(mbedtls_ssl_context *ssl,
                                  unsigned char *buf,
                                  unsigned char *end,
                                  int psk_type,
                                  psa_algorithm_t hash_alg,
 ...
 */
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_tls13_parse_server_pre_shared_key_ext(mbedtls_ssl_context *ssl,
                                                     const unsigned char *buf,
                                                     const unsigned char *end)
{
    int ret = MBEDTLS_ERR_ERROR_CORRUPTION_DETECTED;
 ...
 */
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_tls13_is_supported_versions_ext_present(
 ...
 */
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_tls13_is_downgrade_negotiation(mbedtls_ssl_context *ssl,
                                              const unsigned char *buf,
                                              const unsigned char *end)
{
...
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_server_hello_is_hrr(mbedtls_ssl_context *ssl,
                                   const unsigned char *buf,
                                   const unsigned char *end)
{
...
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_tls13_preprocess_server_hello(mbedtls_ssl_context *ssl,
                                             const unsigned char *buf,
                                             const unsigned char *end)
{
    int ret = MBEDTLS_ERR_ERROR_CORRUPTION_DETECTED;
...
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_tls13_check_server_hello_session_id_echo(mbedtls_ssl_context *ssl,
                                                        const unsigned char **buf,
                                                        const unsigned char *end)
{
    const unsigned char *p = *buf;
 ...
 */
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_tls13_parse_server_hello(mbedtls_ssl_context *ssl,
                                        const unsigned char *buf,
                                        const unsigned char *end,
                                        int is_hrr)
{
...
static inline  const char *ssl_tls13_get_kex_mode_str(int mode)
{
    switch (mode) {
...
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_tls13_postprocess_server_hello(mbedtls_ssl_context *ssl)
{
    int ret = MBEDTLS_ERR_ERROR_CORRUPTION_DETECTED;
    mbedtls_ssl_handshake_params *handshake = ssl->handshake;
...
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_tls13_postprocess_hrr(mbedtls_ssl_context *ssl)
{
    int ret = MBEDTLS_ERR_ERROR_CORRUPTION_DETECTED;
 ...
 */
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_tls13_process_server_hello(mbedtls_ssl_context *ssl)
{
    int ret = MBEDTLS_ERR_ERROR_CORRUPTION_DETECTED;
 ...
 */
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_tls13_parse_encrypted_extensions(mbedtls_ssl_context *ssl,
                                                const unsigned char *buf,
                                                const unsigned char *end)
{
    int ret = 0;
...
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_tls13_process_encrypted_extensions(mbedtls_ssl_context *ssl)
{
    int ret;
    unsigned char *buf;
    size_t buf_len;
...
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_tls13_write_end_of_early_data(mbedtls_ssl_context *ssl)
{
    int ret = MBEDTLS_ERR_ERROR_CORRUPTION_DETECTED;
    unsigned char *buf = NULL;
    size_t buf_len;
 ...
 */
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_tls13_certificate_request_coordinate(mbedtls_ssl_context *ssl)
{
    int ret = MBEDTLS_ERR_ERROR_CORRUPTION_DETECTED;
 ...
 */
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_tls13_parse_certificate_request(mbedtls_ssl_context *ssl,
                                               const unsigned char *buf,
                                               const unsigned char *end)
{
    int ret = MBEDTLS_ERR_ERROR_CORRUPTION_DETECTED;
    ...
    if (certificate_request_context_len > 0) {
        ...
        handshake->certificate_request_context =(unsigned char*)
 ...
 */
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_tls13_process_certificate_request(mbedtls_ssl_context *ssl)
{
    int ret = MBEDTLS_ERR_ERROR_CORRUPTION_DETECTED;
 ...
 */
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_tls13_process_server_certificate(mbedtls_ssl_context *ssl)
{
    int ret;
 ...
 */
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_tls13_process_certificate_verify(mbedtls_ssl_context *ssl)
{
    int ret;
 ...
 */
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_tls13_process_server_finished(mbedtls_ssl_context *ssl)
{
    int ret;
 ...
 */
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_tls13_write_client_certificate(mbedtls_ssl_context *ssl)
{
 ...
 */
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_tls13_write_client_certificate_verify(mbedtls_ssl_context *ssl)
{
 ...
 */
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_tls13_write_client_finished(mbedtls_ssl_context *ssl)
{
    int ret;
 ...
 */
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_tls13_flush_buffers(mbedtls_ssl_context *ssl)
{
 ...
 */
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_tls13_handshake_wrapup(mbedtls_ssl_context *ssl)
{
 ...
 */
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_tls13_parse_new_session_ticket_early_data_ext(
    mbedtls_ssl_context *ssl,
    const unsigned char *buf,
    const unsigned char *end)
{
...
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_tls13_parse_new_session_ticket_exts(mbedtls_ssl_context *ssl,
                                                   const unsigned char *buf,
                                                   const unsigned char *end)
{
    mbedtls_ssl_handshake_params *handshake = ssl->handshake;
 ...
 */
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_tls13_parse_new_session_ticket(mbedtls_ssl_context *ssl,
                                              unsigned char *buf,
                                              unsigned char *end,
...
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_tls13_postprocess_new_session_ticket(mbedtls_ssl_context *ssl,
                                                    unsigned char *ticket_nonce,
                                                    size_t ticket_nonce_len)
{
    int ret = MBEDTLS_ERR_ERROR_CORRUPTION_DETECTED;
 ...
 */
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_tls13_process_new_session_ticket(mbedtls_ssl_context *ssl)
{
    int ret = MBEDTLS_ERR_ERROR_CORRUPTION_DETECTED;
    unsigned char *buf;
    size_t buf_len;
