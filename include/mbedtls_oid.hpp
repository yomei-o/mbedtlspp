 ...
 */
static inline int mbedtls_oid_get_numeric_string(char *buf, size_t size, const mbedtls_asn1_buf *oid);
 ...
 *                  allocate oid->buf
 */
static inline int mbedtls_oid_from_numeric_string(mbedtls_asn1_buf *oid, const char *oid_str, size_t size);
 ...
 */
static inline int mbedtls_oid_get_x509_ext_type(const mbedtls_asn1_buf *oid, int *ext_type);
 ...
 * \return         0 if successful, or MBEDTLS_ERR_OID_NOT_FOUND
 */
static inline int mbedtls_oid_get_attr_short_name(const mbedtls_asn1_buf *oid, const char **short_name);
 ...
 * \return         0 if successful, or MBEDTLS_ERR_OID_NOT_FOUND
 */
static inline int mbedtls_oid_get_pk_alg(const mbedtls_asn1_buf *oid, mbedtls_pk_type_t *pk_alg);
 ...
 * \return         0 if successful, or MBEDTLS_ERR_OID_NOT_FOUND
 */
static inline int mbedtls_oid_get_oid_by_pk_alg(mbedtls_pk_type_t pk_alg,
 ...
 * \return         0 if successful, or MBEDTLS_ERR_OID_NOT_FOUND
 */
static inline int mbedtls_oid_get_ec_grp(const mbedtls_asn1_buf *oid, mbedtls_ecp_group_id *grp_id);
 ...
 * \return         0 if successful, or MBEDTLS_ERR_OID_NOT_FOUND
 */
static inline int mbedtls_oid_get_oid_by_ec_grp(mbedtls_ecp_group_id grp_id,
                                  const char **oid, size_t *olen);
 ...
 * \return         0 if successful, or MBEDTLS_ERR_OID_NOT_FOUND
 */
static inline int mbedtls_oid_get_ec_grp_algid(const mbedtls_asn1_buf *oid, mbedtls_ecp_group_id *grp_id);
 ...
 * \return         0 if successful, or MBEDTLS_ERR_OID_NOT_FOUND
 */
static inline int mbedtls_oid_get_oid_by_ec_grp_algid(mbedtls_ecp_group_id grp_id,
                                        const char **oid, size_t *olen);
 ...
 * \return         0 if successful, or MBEDTLS_ERR_OID_NOT_FOUND
 */
static inline int mbedtls_oid_get_sig_alg(const mbedtls_asn1_buf *oid,
 ...
 * \return         0 if successful, or MBEDTLS_ERR_OID_NOT_FOUND
 */
static inline int mbedtls_oid_get_sig_alg_desc(const mbedtls_asn1_buf *oid, const char **desc);
 ...
 * \return         0 if successful, or MBEDTLS_ERR_OID_NOT_FOUND
 */
static inline int mbedtls_oid_get_oid_by_sig_alg(mbedtls_pk_type_t pk_alg, mbedtls_md_type_t md_alg,
                                   const char **oid, size_t *olen);
 ...
 * \return         0 if successful, or MBEDTLS_ERR_OID_NOT_FOUND
 */
static inline int mbedtls_oid_get_md_hmac(const mbedtls_asn1_buf *oid, mbedtls_md_type_t *md_hmac);
 ...
 * \return         0 if successful, or MBEDTLS_ERR_OID_NOT_FOUND
 */
static inline int mbedtls_oid_get_md_alg(const mbedtls_asn1_buf *oid, mbedtls_md_type_t *md_alg);
 ...
 * \return         0 if successful, or MBEDTLS_ERR_OID_NOT_FOUND
 */
static inline int mbedtls_oid_get_extended_key_usage(const mbedtls_asn1_buf *oid, const char **desc);
#endif
 ...
 * \return         0 if successful, or MBEDTLS_ERR_OID_NOT_FOUND
 */
static inline int mbedtls_oid_get_certificate_policies(const mbedtls_asn1_buf *oid, const char **desc);
 ...
 * \return         0 if successful, or MBEDTLS_ERR_OID_NOT_FOUND
 */
static inline int mbedtls_oid_get_oid_by_md(mbedtls_md_type_t md_alg, const char **oid, size_t *olen);
 ...
 * \return         0 if successful, or MBEDTLS_ERR_OID_NOT_FOUND
 */
static inline int mbedtls_oid_get_cipher_alg(const mbedtls_asn1_buf *oid, mbedtls_cipher_type_t *cipher_alg);
 ...
 * \return         0 if successful, or MBEDTLS_ERR_OID_NOT_FOUND
 */
static inline int mbedtls_oid_get_pkcs12_pbe_alg(const mbedtls_asn1_buf *oid, mbedtls_md_type_t *md_alg,
