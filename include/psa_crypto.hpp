...
#else
#include "psa_crypto_platform.hpp"
#endif
 ...
 *         results in this error code.
 */
static inline psa_status_t psa_purge_key(mbedtls_svc_key_id_t key);
 ...
 */
static inline  psa_sign_operation_t psa_sign_operation_init(void);
 ...
 */
static inline  psa_verify_operation_t psa_verify_operation_init(void);
 ...
 *         results in this error code.
 */
static inline psa_status_t psa_key_derivation_setup(
    psa_key_derivation_operation_t *operation,
    psa_algorithm_t alg);
 ...
 *         results in this error code.
 */
static inline psa_status_t psa_key_derivation_get_capacity(
 ...
 *         results in this error code.
 */
static inline psa_status_t psa_key_derivation_set_capacity(
    psa_key_derivation_operation_t *operation,
    size_t capacity);
 ...
 *         results in this error code.
 */
static inline psa_status_t psa_key_derivation_key_agreement(
    psa_key_derivation_operation_t *operation,
    psa_key_derivation_step_t step,
 ...
 *         results in this error code.
 */
static inline psa_status_t psa_key_derivation_abort(
    psa_key_derivation_operation_t *operation);
 ...
 *         results in this error code.
 */
static inline psa_status_t psa_generate_random(uint8_t *output,
                                 size_t output_size);
 ...
 *                              far.
 */
static inline uint32_t psa_key_agreement_iop_get_num_ops(psa_key_agreement_iop_t *operation);
 ...
 *                              far.
 */
static inline uint32_t psa_generate_key_iop_get_num_ops(psa_generate_key_iop_t *operation);
