 ...
 */
static inline int mbedtls_mps_reader_init(mbedtls_mps_reader *reader,
                            unsigned char *acc,
 ...
 * \return          A negative \c MBEDTLS_ERR_READER_XXX error code on failure.
 */
static inline int mbedtls_mps_reader_free(mbedtls_mps_reader *reader);
 ...
 */
static inline int mbedtls_mps_reader_feed(mbedtls_mps_reader *reader,
                            unsigned char *buf,
 ...
 * \return          A negative \c MBEDTLS_ERR_READER_XXX error code on failure.
 */
static inline int mbedtls_mps_reader_reclaim(mbedtls_mps_reader *reader,
                               int *paused);
 ...
 *                  afterwards.
 */
static inline int mbedtls_mps_reader_get(mbedtls_mps_reader *reader,
 ...
 *
 */
static inline int mbedtls_mps_reader_commit(mbedtls_mps_reader *reader);
