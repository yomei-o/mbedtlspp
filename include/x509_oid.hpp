 ...
 */
static inline int mbedtls_x509_oid_get_x509_ext_type(const mbedtls_asn1_buf *oid, int *ext_type);
 ...
 * \return         0 if successful, or MBEDTLS_ERR_X509_UNKNOWN_OID
 */
static inline int mbedtls_x509_oid_get_attr_short_name(const mbedtls_asn1_buf *oid, const char **short_name);
 ...
 * \return         0 if successful, or MBEDTLS_ERR_X509_UNKNOWN_OID
 */
static inline int mbedtls_x509_oid_get_sig_alg(const mbedtls_asn1_buf *oid,
 ...
 * \return         0 if successful, or MBEDTLS_ERR_X509_UNKNOWN_OID
 */
static inline int mbedtls_x509_oid_get_sig_alg_desc(const mbedtls_asn1_buf *oid, const char **desc);
 ...
 * \return         0 if successful, or MBEDTLS_ERR_X509_UNKNOWN_OID
 */
static inline int mbedtls_x509_oid_get_oid_by_sig_alg(mbedtls_pk_sigalg_t pk_alg, mbedtls_md_type_t md_alg,
 ...
 * \return         0 if successful, or MBEDTLS_ERR_X509_UNKNOWN_OID
 */
static inline int mbedtls_x509_oid_get_md_alg(const mbedtls_asn1_buf *oid, mbedtls_md_type_t *md_alg);
 ...
 * \return         0 if successful, or MBEDTLS_ERR_X509_UNKNOWN_OID
 */
static inline int mbedtls_x509_oid_get_extended_key_usage(const mbedtls_asn1_buf *oid, const char **desc);
 ...
 * \return         0 if successful, or MBEDTLS_ERR_X509_UNKNOWN_OID
 */
static inline int mbedtls_x509_oid_get_certificate_policies(const mbedtls_asn1_buf *oid, const char **desc);
