...
static inline void psa_random_internal_init(mbedtls_psa_random_context_t *rng)
{
...
static inline void psa_random_internal_free(mbedtls_psa_random_context_t *rng)
{
    mbedtls_psa_drbg_free(&rng->drbg);
    rng->entropy_free(&rng->entropy);
}
static inline psa_status_t psa_random_internal_seed(mbedtls_psa_random_context_t *rng)
{
...
#if defined(MBEDTLS_PLATFORM_IS_UNIXLIKE)
static inline  psa_status_t psa_random_internal_reseed_child(
...
static inline psa_status_t psa_random_internal_generate(
    mbedtls_psa_random_context_t *rng,
