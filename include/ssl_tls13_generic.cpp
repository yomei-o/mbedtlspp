 ...
 */
static inline  void ssl_tls13_create_verify_structure(const unsigned char *transcript_hash,
...
static inline  int ssl_tls13_parse_certificate_verify(mbedtls_ssl_context *ssl,
...
static inline int mbedtls_ssl_tls13_parse_certificate(mbedtls_ssl_context *ssl,
                                        const unsigned char *buf,
                                        const unsigned char *end)
{
    int ret = MBEDTLS_ERR_ERROR_CORRUPTION_DETECTED;
    ...
    if ((ssl->session_negotiate->peer_cert =(mbedtls_x509_crt*)
...
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_tls13_validate_certificate(mbedtls_ssl_context *ssl)
{
 ...
 */
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_tls13_write_certificate_body(mbedtls_ssl_context *ssl,
                                            unsigned char *buf,
                                            unsigned char *end,
                                            size_t *out_len)
{
...
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_tls13_write_certificate_verify_body(mbedtls_ssl_context *ssl,
                                                   unsigned char *buf,
                                                   unsigned char *end,
                                                   size_t *out_len)
{
...
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_tls13_preprocess_finished_message(mbedtls_ssl_context *ssl)
{
    int ret;
...
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_tls13_parse_finished_message(mbedtls_ssl_context *ssl,
                                            const unsigned char *buf,
                                            const unsigned char *end)
{
    /*
...
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_tls13_prepare_finished_message(mbedtls_ssl_context *ssl)
{
    int ret;
...
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_tls13_write_finished_message_body(mbedtls_ssl_context *ssl,
                                                 unsigned char *buf,
                                                 unsigned char *end,
                                                 size_t *out_len)
{
...
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_tls13_write_change_cipher_spec_body(mbedtls_ssl_context *ssl,
                                                   unsigned char *buf,
                                                   unsigned char *end,
                                                   size_t *olen)
{
...
static inline  psa_status_t mbedtls_ssl_get_psa_ffdh_info_from_tls_id(
