 ...
 */
static inline psa_status_t mbedtls_psa_external_get_random(
 ...
 */
static inline psa_status_t mbedtls_psa_platform_get_builtin_key(
 ...
 *         results in this error code.
 */
static inline psa_status_t psa_pake_setup(psa_pake_operation_t *operation,
                            const psa_pake_cipher_suite_t *cipher_suite);
 ...
 *         results in this error code.
 */
static inline psa_status_t psa_pake_set_password_key(psa_pake_operation_t *operation,
 ...
 *         results in this error code.
 */
static inline psa_status_t psa_pake_set_user(psa_pake_operation_t *operation,
 ...
 *         results in this error code.
 */
static inline psa_status_t psa_pake_set_peer(psa_pake_operation_t *operation,
 ...
 *         results in this error code.
 */
static inline psa_status_t psa_pake_set_role(psa_pake_operation_t *operation,
 ...
 *         results in this error code.
 */
static inline psa_status_t psa_pake_output(psa_pake_operation_t *operation,
 ...
 *         results in this error code.
 */
static inline psa_status_t psa_pake_input(psa_pake_operation_t *operation,
                            psa_pake_step_t step,
                            const uint8_t *input,
                            size_t input_length);
 ...
 *         results in this error code.
 */
static inline psa_status_t psa_pake_get_implicit_key(psa_pake_operation_t *operation,
 ...
 *         results in this error code.
 */
static inline psa_status_t psa_pake_abort(psa_pake_operation_t *operation);
