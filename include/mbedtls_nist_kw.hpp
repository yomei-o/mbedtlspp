 ...
 * \return          cipher-specific error code on failure of the underlying cipher.
 */
static inline int mbedtls_nist_kw_wrap(mbedtls_nist_kw_context *ctx, mbedtls_nist_kw_mode_t mode,
 ...
 * \return          cipher-specific error code on failure of the underlying cipher.
 */
static inline int mbedtls_nist_kw_unwrap(mbedtls_nist_kw_context *ctx, mbedtls_nist_kw_mode_t mode,
                           const unsigned char *input, size_t in_len,
                           unsigned char *output, size_t *out_len, size_t out_size);
