...
static inline  int supported_init = 0;
...
static inline const int *mbedtls_cipher_list(void)
{
...
static inline const mbedtls_cipher_info_t *mbedtls_cipher_info_from_type(
...
static inline const mbedtls_cipher_info_t *mbedtls_cipher_info_from_string(
...
static inline const mbedtls_cipher_info_t *mbedtls_cipher_info_from_values(
...
static inline void mbedtls_cipher_init(mbedtls_cipher_context_t *ctx)
{
    memset(ctx, 0, sizeof(mbedtls_cipher_context_t));
}

static inline void mbedtls_cipher_free(mbedtls_cipher_context_t *ctx)
{
    if (ctx == NULL) {
        return;
    }
...
static inline int mbedtls_cipher_setup(mbedtls_cipher_context_t *ctx,
...
#if defined(MBEDTLS_USE_PSA_CRYPTO) && !defined(MBEDTLS_DEPRECATED_REMOVED)
static inline int mbedtls_cipher_setup_psa(mbedtls_cipher_context_t *ctx,
                             const mbedtls_cipher_info_t *cipher_info,
                             size_t taglen)
{
    psa_algorithm_t alg;
...
static inline int mbedtls_cipher_setkey(mbedtls_cipher_context_t *ctx,
...
static inline int mbedtls_cipher_set_iv(mbedtls_cipher_context_t *ctx,
...
static inline int mbedtls_cipher_reset(mbedtls_cipher_context_t *ctx)
{
    if (ctx->cipher_info == NULL) {
        return MBEDTLS_ERR_CIPHER_BAD_INPUT_DATA;
    }
...
static inline int mbedtls_cipher_update_ad(mbedtls_cipher_context_t *ctx,
...
static inline int mbedtls_cipher_update(mbedtls_cipher_context_t *ctx, const unsigned char *input,
 ...
 */
static inline  void add_pkcs_padding(unsigned char *output, size_t output_len,
                             size_t data_len)
{
 ...
 */
static inline MBEDTLS_STATIC_TESTABLE int mbedtls_get_pkcs_padding(unsigned char *input,
                                                     size_t input_len,
                                                     size_t *data_len,
 ...
 */
static inline  void add_one_and_zeros_padding(unsigned char *output,
...
static inline  int get_one_and_zeros_padding(unsigned char *input, size_t input_len,
 ...
 */
static inline  void add_zeros_and_len_padding(unsigned char *output,
                                      size_t output_len, size_t data_len)
{
    size_t padding_len = output_len - data_len;
    unsigned char i = 0;
...
static inline  int get_zeros_and_len_padding(unsigned char *input, size_t input_len,
                                     size_t *data_len, size_t *invalid_padding)
{
    size_t i, pad_idx;
    unsigned char padding_len;
 ...
 */
static inline  void add_zeros_padding(unsigned char *output,
                              size_t output_len, size_t data_len)
{
    memset(output + data_len, 0, output_len - data_len);
}

static inline  int get_zeros_padding(unsigned char *input, size_t input_len,
                             size_t *data_len, size_t *invalid_padding)
{
    size_t i;
 ...
 */
static inline  int get_no_padding(unsigned char *input, size_t input_len,
                          size_t *data_len, size_t *invalid_padding)
{
    if (NULL == input || NULL == data_len) {
        return MBEDTLS_ERR_CIPHER_BAD_INPUT_DATA;
...
static inline int mbedtls_cipher_finish_padded(mbedtls_cipher_context_t *ctx,
...
static inline int mbedtls_cipher_finish(mbedtls_cipher_context_t *ctx,
                          unsigned char *output, size_t *olen)
{
...
#if defined(MBEDTLS_CIPHER_MODE_WITH_PADDING)
static inline int mbedtls_cipher_set_padding_mode(mbedtls_cipher_context_t *ctx,
...
#if defined(MBEDTLS_GCM_C) || defined(MBEDTLS_CHACHAPOLY_C)
static inline int mbedtls_cipher_write_tag(mbedtls_cipher_context_t *ctx,
...
static inline int mbedtls_cipher_check_tag(mbedtls_cipher_context_t *ctx,
 ...
 */
static inline int mbedtls_cipher_crypt(mbedtls_cipher_context_t *ctx,
 ...
 */
static inline  int mbedtls_cipher_aead_encrypt(mbedtls_cipher_context_t *ctx,
                                       const unsigned char *iv, size_t iv_len,
                                       const unsigned char *ad, size_t ad_len,
                                       const unsigned char *input, size_t ilen,
                                       unsigned char *output, size_t *olen,
 ...
 * mbedtls_cipher_auth_encrypt_ext().
 */
static inline  int mbedtls_cipher_aead_decrypt(mbedtls_cipher_context_t *ctx,
                                       const unsigned char *iv, size_t iv_len,
                                       const unsigned char *ad, size_t ad_len,
                                       const unsigned char *input, size_t ilen,
                                       unsigned char *output, size_t *olen,
 ...
 */
static inline int mbedtls_cipher_auth_encrypt_ext(mbedtls_cipher_context_t *ctx,
                                    const unsigned char *iv, size_t iv_len,
                                    const unsigned char *ad, size_t ad_len,
                                    const unsigned char *input, size_t ilen,
 ...
 */
static inline int mbedtls_cipher_auth_decrypt_ext(mbedtls_cipher_context_t *ctx,
                                    const unsigned char *iv, size_t iv_len,
                                    const unsigned char *ad, size_t ad_len,
                                    const unsigned char *input, size_t ilen,
                                    unsigned char *output, size_t output_len,
