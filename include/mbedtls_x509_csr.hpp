 ...
 */
static inline int mbedtls_x509_csr_parse_der(mbedtls_x509_csr *csr,
 ...
 * \return         0 if successful, or a specific X509 error code
 */
static inline int mbedtls_x509_csr_parse_der_with_ext_cb(mbedtls_x509_csr *csr,
                                           const unsigned char *buf, size_t buflen,
 ...
 */
static inline int mbedtls_x509_csr_parse(mbedtls_x509_csr *csr, const unsigned char *buf, size_t buflen);
 ...
 * \return         0 if successful, or a specific X509 or PEM error code
 */
static inline int mbedtls_x509_csr_parse_file(mbedtls_x509_csr *csr, const char *path);
#endif /* MBEDTLS_FS_IO */
 ...
 */
static inline int mbedtls_x509_csr_info(char *buf, size_t size, const char *prefix,
 ...
 */
static inline void mbedtls_x509_csr_init(mbedtls_x509_csr *csr);
 ...
 */
static inline void mbedtls_x509_csr_free(mbedtls_x509_csr *csr);
 ...
 */
static inline void mbedtls_x509write_csr_init(mbedtls_x509write_csr *ctx);
 ...
 */
static inline void mbedtls_x509write_csr_set_key(mbedtls_x509write_csr *ctx, mbedtls_pk_context *key);
 ...
 */
static inline void mbedtls_x509write_csr_set_md_alg(mbedtls_x509write_csr *ctx, mbedtls_md_type_t md_alg);
 ...
 *                  function.
 */
static inline int mbedtls_x509write_csr_set_key_usage(mbedtls_x509write_csr *ctx, unsigned char key_usage);
 ...
 */
static inline int mbedtls_x509write_csr_set_subject_alternative_name(mbedtls_x509write_csr *ctx,
 ...
 * \return          0 if successful, or MBEDTLS_ERR_X509_ALLOC_FAILED
 */
static inline int mbedtls_x509write_csr_set_ns_cert_type(mbedtls_x509write_csr *ctx,
 ...
 */
static inline int mbedtls_x509write_csr_set_extension(mbedtls_x509write_csr *ctx,
 ...
 */
static inline void mbedtls_x509write_csr_free(mbedtls_x509write_csr *ctx);
 ...
 * \note            \p f_rng is used for the signature operation.
 */
static inline int mbedtls_x509write_csr_pem(mbedtls_x509write_csr *ctx, unsigned char *buf, size_t size,
