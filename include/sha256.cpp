...
static inline  int mbedtls_a64_crypto_sha256_determine_support(void)
{
...
static inline  size_t mbedtls_internal_sha256_process_many_a64_crypto(
...
static inline  int mbedtls_a64_crypto_sha256_has_support(void)
{
    static int done = 0;
...
static inline  size_t mbedtls_internal_sha256_process_many(mbedtls_sha256_context *ctx,
 ...
 */
static inline  const unsigned char sha_test_buf[3][57] =
{
    { "abc" },
...
static inline  const size_t sha_test_buflen[3] =
{
    3, 56, 1000
};
 ...
 */
#if defined(MBEDTLS_SHA224_C)
static inline  sha_test_sum_t sha224_test_sum[] =
{
 ...
 */
#if defined(MBEDTLS_SHA256_C)
static inline  sha_test_sum_t sha256_test_sum[] =
{
 ...
 * Checkup routine
 */
static inline  int mbedtls_sha256_common_self_test(int verbose, int is224)
{
    int i, buflen, ret = 0;
    unsigned char *buf;
...
#if defined(MBEDTLS_SHA256_C)
static inline int mbedtls_sha256_self_test(int verbose)
{
...
#if defined(MBEDTLS_SHA224_C)
static inline int mbedtls_sha224_self_test(int verbose)
{
