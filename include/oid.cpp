...
#define FN_OID_TYPED_FROM_ASN1(TYPE_T, NAME, LIST)                    \
    static inline const TYPE_T *oid_ ## NAME ## _from_asn1(                   \
...
#define FN_OID_GET_DESCRIPTOR_ATTR1(FN_NAME, TYPE_T, TYPE_NAME, ATTR1_TYPE, ATTR1) \
    static inline int FN_NAME(const mbedtls_asn1_buf *oid, ATTR1_TYPE * ATTR1)                  \
    {                                                                       \
...
#define FN_OID_GET_OID_BY_ATTR1(FN_NAME, TYPE_T, LIST, ATTR1_TYPE, ATTR1)   \
    static inline int FN_NAME(ATTR1_TYPE ATTR1, const char **oid, size_t *olen)             \
    {                                                                           \
...
#define FN_OID_GET_OID_BY_ATTR2(FN_NAME, TYPE_T, LIST, ATTR1_TYPE, ATTR1,   \
                                ATTR2_TYPE, ATTR2)                          \
    static inline int FN_NAME(ATTR1_TYPE ATTR1, ATTR2_TYPE ATTR2, const char **oid,         \
                size_t *olen)                                                 \
    {                                                                           \
        const TYPE_T *cur = (LIST);                                             \
        while (cur->descriptor.asn1 != NULL) {                                 \
...
static inline  const oid_x520_attr_t oid_x520_attr_type[] =
{
    {
...
static inline  const oid_x509_ext_t oid_x509_ext[] =
{
    {
...
#if !defined(MBEDTLS_X509_REMOVE_INFO)
static inline  const mbedtls_oid_descriptor_t oid_ext_key_usage[] =
{
...
static inline  const mbedtls_oid_descriptor_t oid_certificate_policies[] =
{
...
static inline  const oid_sig_alg_t oid_sig_alg[] =
{
...
static inline  const oid_pk_alg_t oid_pk_alg[] =
{
    {
...
static inline  const oid_ecp_grp_t oid_ecp_grp[] =
{
...
static inline  const oid_ecp_grp_algid_t oid_ecp_grp_algid[] =
{
...
static inline  const oid_cipher_alg_t oid_cipher_alg[] =
{
    {
...
static inline  const oid_md_alg_t oid_md_alg[] =
{
#if defined(MBEDTLS_MD_CAN_MD5)
    {
...
static inline  const oid_md_hmac_t oid_md_hmac[] =
{
#if defined(MBEDTLS_MD_CAN_SHA1)
    {
...
static inline  const oid_pkcs12_pbe_alg_t oid_pkcs12_pbe_alg[] =
{
    {
...
static inline int mbedtls_oid_get_numeric_string(char *buf, size_t size,
                                   const mbedtls_asn1_buf *oid)
{
...
static inline  int oid_parse_number(unsigned int *num, const char **p, const char *bound)
{
...
static inline  size_t oid_subidentifier_num_bytes(unsigned int value)
{
    size_t num_bytes = 0;
...
static inline  int oid_subidentifier_encode_into(unsigned char **p,
                                         unsigned char *bound,
                                         unsigned int value)
{
...
static inline int mbedtls_oid_from_numeric_string(mbedtls_asn1_buf *oid,
