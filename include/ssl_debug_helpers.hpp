...
static inline const char *mbedtls_ssl_early_data_status_str(mbedtls_ssl_early_data_status in);
static inline const char *mbedtls_ssl_early_data_state_str(mbedtls_ssl_early_data_state in);
#endif

static inline const char *mbedtls_ssl_protocol_version_str(mbedtls_ssl_protocol_version in);

static inline const char *mbedtls_tls_prf_types_str(mbedtls_tls_prf_types in);

static inline const char *mbedtls_ssl_key_export_type_str(mbedtls_ssl_key_export_type in);

static inline const char *mbedtls_ssl_sig_alg_to_str(uint16_t in);
