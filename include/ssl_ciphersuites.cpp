 ...
 */
static inline  const int ciphersuite_preference[] =
{
...
static inline  const mbedtls_ssl_ciphersuite_t ciphersuite_definitions[] =
{
#if defined(MBEDTLS_SSL_PROTO_TLS1_3)
...
static inline  int supported_ciphersuites[MAX_CIPHERSUITES];
static inline  int supported_init_2 = 0;

MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ciphersuite_is_removed(const mbedtls_ssl_ciphersuite_t *cs_info)
{
    (void) cs_info;
...
static inline const mbedtls_ssl_ciphersuite_t *mbedtls_ssl_ciphersuite_from_string(
...
static inline const mbedtls_ssl_ciphersuite_t *mbedtls_ssl_ciphersuite_from_id(int ciphersuite)
{
    const mbedtls_ssl_ciphersuite_t *cur = ciphersuite_definitions;
