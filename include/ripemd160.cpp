...
static inline void mbedtls_ripemd160_init(mbedtls_ripemd160_context *ctx)
{
    memset(ctx, 0, sizeof(mbedtls_ripemd160_context));
}

static inline void mbedtls_ripemd160_free(mbedtls_ripemd160_context *ctx)
{
    if (ctx == NULL) {
        return;
    }
...
static inline void mbedtls_ripemd160_clone(mbedtls_ripemd160_context *dst,
 ...
 */
static inline int mbedtls_ripemd160_starts(mbedtls_ripemd160_context *ctx)
{
    ctx->total[0] = 0;
    ctx->total[1] = 0;
 ...
 * Process one block
 */
static inline int mbedtls_internal_ripemd160_process(mbedtls_ripemd160_context *ctx,
 ...
 */
static inline int mbedtls_ripemd160_update(mbedtls_ripemd160_context *ctx,
...
static inline  const unsigned char ripemd160_padding[64] =
{
 ...
 */
static inline int mbedtls_ripemd160_finish(mbedtls_ripemd160_context *ctx,
 ...
 */
static inline int mbedtls_ripemd160(const unsigned char *input,
                      size_t ilen,
                      unsigned char output[20])
{
    int ret = MBEDTLS_ERR_ERROR_CORRUPTION_DETECTED;
 ...
 */
#define TESTS   8
static inline  const unsigned char ripemd160_test_str[TESTS][81] =
{
    { "" },
    { "a" },
    { "abc" },
...
static inline  const size_t ripemd160_test_strlen[TESTS] =
{
    0, 1, 3, 14, 26, 56, 62, 80
};

static inline  const unsigned char ripemd160_test_md[TESTS][20] =
{
 ...
 * Checkup routine
 */
static inline int mbedtls_ripemd160_self_test(int verbose)
{
    int i, ret = 0;
    unsigned char output[20];
