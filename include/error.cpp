...
static inline const char *mbedtls_high_level_strerr(int error_code)
{
...
static inline const char *mbedtls_low_level_strerr(int error_code)
{
...
static inline void mbedtls_strerror(int ret, char *buf, size_t buflen)
{
    size_t len;
    int use_ret;
