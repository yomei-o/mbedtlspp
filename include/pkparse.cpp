...
static inline  int pk_ecc_tag_is_specified_ec_domain(int tag)
{
    (void) tag;
    return 0;
}
...
/* See the "real" version for documentation */
static inline  int pk_ecc_group_id_from_specified(const mbedtls_asn1_buf *params,
 ...
 */
static inline  int pk_group_from_specified(const mbedtls_asn1_buf *params, mbedtls_ecp_group *grp)
{
 ...
 */
static inline  int pk_group_id_from_group(const mbedtls_ecp_group *grp, mbedtls_ecp_group_id *grp_id)
{
    int ret = 0;
 ...
 * }
 */
static inline  int pk_get_ecparams(unsigned char **p, const unsigned char *end,
 ...
 *   -- implicitCurve   NULL
 */
static inline  int pk_use_ecparams(const mbedtls_asn1_buf *params, mbedtls_pk_context *pk)
{
    int ret = MBEDTLS_ERR_ERROR_CORRUPTION_DETECTED;
    mbedtls_ecp_group_id grp_id;
 ...
 */
static inline  int pk_use_ecparams_rfc8410(const mbedtls_asn1_buf *params,
                                   mbedtls_ecp_group_id grp_id,
 ...
 */
static inline  int pk_parse_key_rfc8410_der(mbedtls_pk_context *pk,
 ...
 */
static inline  int pk_get_pk_alg(unsigned char **p,
 ...
 */
static inline  int pk_parse_key_sec1_der(mbedtls_pk_context *pk,
 ...
 *
 */
static inline  int pk_parse_key_pkcs8_unencrypted_der(
    mbedtls_pk_context *pk,
    const unsigned char *key, size_t keylen,
    int (*f_rng)(void *, unsigned char *, size_t), void *p_rng)
{
...
static inline MBEDTLS_STATIC_TESTABLE int mbedtls_pk_parse_key_pkcs8_encrypted_der(
    mbedtls_pk_context *pk,
 ...
 * Parse a private key
 */
static inline int mbedtls_pk_parse_key(mbedtls_pk_context *pk,
                         const unsigned char *key, size_t keylen,
                         const unsigned char *pwd, size_t pwdlen,
                         int (*f_rng)(void *, unsigned char *, size_t), void *p_rng)
{
