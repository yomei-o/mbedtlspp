...
static inline psa_status_t psa_mac_key_can_do(
 ...
 */
static inline  void (*psa_input_pre_copy_hook)(const uint8_t *input, size_t input_len);
static inline  void (*psa_input_post_copy_hook)(const uint8_t *input, size_t input_len);
static inline  void (*psa_output_pre_copy_hook)(const uint8_t *output, size_t output_len);
static inline  void (*psa_output_post_copy_hook)(const uint8_t *output, size_t output_len);
