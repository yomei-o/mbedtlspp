...
#include "mbedtls_ssl_ciphersuites.hpp"
 ...
 */
static inline const char *mbedtls_ssl_get_ciphersuite_name(const int ciphersuite_id);
 ...
 */
static inline int mbedtls_ssl_get_ciphersuite_id(const char *ciphersuite_name);
 ...
 */
static inline int mbedtls_ssl_check_record(mbedtls_ssl_context const *ssl,
                             unsigned char *buf,
                             size_t buflen);
 ...
 */
static inline void mbedtls_ssl_conf_async_private_cb(mbedtls_ssl_config *conf,
 ...
 */
static inline void mbedtls_ssl_conf_dtls_cookies(mbedtls_ssl_config *conf,
 ...
 */
static inline int mbedtls_ssl_set_client_transport_id(mbedtls_ssl_context *ssl,
 ...
 */
static inline void mbedtls_ssl_conf_handshake_timeout(mbedtls_ssl_config *conf, uint32_t min, uint32_t max);
#endif /* MBEDTLS_SSL_PROTO_DTLS */
 ...
 *                      is too large.
 */
static inline int mbedtls_ssl_conf_cid(mbedtls_ssl_config *conf, size_t len,
 ...
 */
static inline void MBEDTLS_DEPRECATED mbedtls_ssl_conf_curves(mbedtls_ssl_config *conf,
 ...
 */
static inline void MBEDTLS_DEPRECATED mbedtls_ssl_conf_sig_hashes(mbedtls_ssl_config *conf,
                                                    const int *hashes);
 ...
 */
static inline void MBEDTLS_DEPRECATED mbedtls_ssl_conf_max_version(mbedtls_ssl_config *conf, int major,
                                                     int minor);
#endif /* MBEDTLS_DEPRECATED_REMOVED */
 ...
 *                 #MBEDTLS_SSL_MINOR_VERSION_4 for TLS 1.3)
 */
static inline void MBEDTLS_DEPRECATED mbedtls_ssl_conf_min_version(mbedtls_ssl_config *conf, int major,
                                                     int minor);
#endif /* MBEDTLS_DEPRECATED_REMOVED */
 ...
 */
static inline void mbedtls_ssl_conf_preference_order(mbedtls_ssl_config *conf, int order);
#endif /* MBEDTLS_SSL_SRV_C */
 ...
 *
 */
static inline int mbedtls_ssl_check_pending(const mbedtls_ssl_context *ssl);
 ...
 *
 */
static inline size_t mbedtls_ssl_get_bytes_avail(const mbedtls_ssl_context *ssl);
 ...
 */
static inline int mbedtls_ssl_get_record_expansion(const mbedtls_ssl_context *ssl);
 ...
 */
static inline int mbedtls_ssl_write(mbedtls_ssl_context *ssl, const unsigned char *buf, size_t len);
 ...
 */
static inline int mbedtls_ssl_send_alert_message(mbedtls_ssl_context *ssl,
                                   unsigned char level,
 ...
 *                 #MBEDTLS_ERR_SSL_RECEIVED_EARLY_DATA.
 */
static inline int mbedtls_ssl_read_early_data(mbedtls_ssl_context *ssl,
 ...
 *                 completed.
 */
static inline int mbedtls_ssl_write_early_data(mbedtls_ssl_context *ssl,
 ...
 * \return         #MBEDTLS_ERR_SSL_BAD_INPUT_DATA if input data is invalid.
 */
static inline int mbedtls_ssl_context_load(mbedtls_ssl_context *ssl,
                             const unsigned char *buf,
                             size_t len);
