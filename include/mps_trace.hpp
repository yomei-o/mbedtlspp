...
static inline int mbedtls_mps_trace_get_depth(void);
static inline void mbedtls_mps_trace_inc_depth(void);
static inline void mbedtls_mps_trace_dec_depth(void);
