...
static inline  int pkcs5_parse_pbkdf2_params(const mbedtls_asn1_buf *params,
...
static inline int mbedtls_pkcs5_pbes2_ext(const mbedtls_asn1_buf *pbe_params, int mode,
...
static inline int mbedtls_pkcs5_pbes2(const mbedtls_asn1_buf *pbe_params, int mode,
                        const unsigned char *pwd,  size_t pwdlen,
                        const unsigned char *data, size_t datalen,
...
static inline  int pkcs5_pbkdf2_hmac(mbedtls_md_context_t *ctx,
...
static inline int mbedtls_pkcs5_pbkdf2_hmac_ext(mbedtls_md_type_t md_alg,
                                  const unsigned char *password,
                                  size_t plen, const unsigned char *salt, size_t slen,
                                  unsigned int iteration_count,
                                  uint32_t key_length, unsigned char *output)
...
static inline  const size_t plen_test_data[MAX_TESTS] =
{ 8, 8, 8, 24, 9 };

static inline  const unsigned char password_test_data[MAX_TESTS][32] =
{
    "password",
    "password",
    "password",
...
static inline  const size_t slen_test_data[MAX_TESTS] =
{ 4, 4, 4, 36, 5 };

static inline  const unsigned char salt_test_data[MAX_TESTS][40] =
{
    "salt",
    "salt",
    "salt",
...
static inline  const uint32_t it_cnt_test_data[MAX_TESTS] =
{ 1, 2, 4096, 4096, 4096 };

static inline  const uint32_t key_len_test_data[MAX_TESTS] =
{ 20, 20, 20, 25, 16 };

static inline  const unsigned char result_key_test_data[MAX_TESTS][32] =
{
