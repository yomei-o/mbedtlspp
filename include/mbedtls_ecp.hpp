 ...
 */
static inline int mbedtls_ecp_group_copy(mbedtls_ecp_group *dst,
 ...
 * \return          Another negative error code on other kinds of failure.
 */
static inline int mbedtls_ecp_tls_write_point(const mbedtls_ecp_group *grp,
 ...
 * \return          Another negative error code on other kinds of failure.
 */
static inline int mbedtls_ecp_group_load(mbedtls_ecp_group *grp, mbedtls_ecp_group_id id);
 ...
 * \return          Another negative error code on other kinds of failure.
 */
static inline int mbedtls_ecp_tls_write_group(const mbedtls_ecp_group *grp,
                                size_t *olen,
                                unsigned char *buf, size_t blen);
 ...
 *                  on failure.
 */
static inline int mbedtls_ecp_gen_keypair(mbedtls_ecp_group *grp, mbedtls_mpi *d,
                            mbedtls_ecp_point *Q,
                            int (*f_rng)(void *, unsigned char *, size_t),
                            void *p_rng);
 ...
 * \return          Another negative error code on different kinds of failure.
 */
static inline int MBEDTLS_DEPRECATED mbedtls_ecp_write_key(mbedtls_ecp_keypair *key,
                                             unsigned char *buf, size_t buflen);
 ...
 *                  error code on calculation failure.
 */
static inline int mbedtls_ecp_keypair_calc_public(
    mbedtls_ecp_keypair *key,
    int (*f_rng)(void *, unsigned char *, size_t), void *p_rng);
