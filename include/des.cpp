 ...
 */
static inline  const uint32_t SB1[64] =
{
...
static inline  const uint32_t SB2[64] =
{
...
static inline  const uint32_t SB3[64] =
{
...
static inline  const uint32_t SB4[64] =
{
...
static inline  const uint32_t SB5[64] =
{
...
static inline  const uint32_t SB6[64] =
{
...
static inline  const uint32_t SB7[64] =
{
...
static inline  const uint32_t SB8[64] =
{
 ...
 */
static inline  const uint32_t LHs[16] =
{
...
static inline  const uint32_t RHs[16] =
{
...
static inline  const unsigned char odd_parity_table[128] = { 1, 2, 4, 7, 8,
...
static inline void mbedtls_des_key_set_parity(unsigned char key[MBEDTLS_DES_KEY_SIZE])
{
    int i;
 ...
 */
static inline int mbedtls_des_key_check_key_parity(const unsigned char key[MBEDTLS_DES_KEY_SIZE])
{
    int i;
...
static inline  const unsigned char weak_key_table[WEAK_KEY_COUNT][MBEDTLS_DES_KEY_SIZE] =
{
...
static inline int mbedtls_des_key_check_weak(const unsigned char key[MBEDTLS_DES_KEY_SIZE])
{
    int i;
...
static inline void mbedtls_des_setkey(uint32_t SK[32], const unsigned char key[MBEDTLS_DES_KEY_SIZE])
{
    int i;
    uint32_t X, Y, T;
 ...
 */
static inline int mbedtls_des_setkey_enc(mbedtls_des_context *ctx, const unsigned char key[MBEDTLS_DES_KEY_SIZE])
{
 ...
 */
static inline int mbedtls_des_setkey_dec(mbedtls_des_context *ctx, const unsigned char key[MBEDTLS_DES_KEY_SIZE])
{
    int i;
...
static inline  void des3_set2key(uint32_t esk[96],
                         uint32_t dsk[96],
...
static inline  void des3_set3key(uint32_t esk[96],
                         uint32_t dsk[96],
 ...
 */
static inline  const unsigned char des3_test_keys[24] =
{
...
static inline  const unsigned char des3_test_buf[8] =
{
    0x4E, 0x6F, 0x77, 0x20, 0x69, 0x73, 0x20, 0x74
};

static inline  const unsigned char des3_test_ecb_dec[3][8] =
{
...
static inline  const unsigned char des3_test_ecb_enc[3][8] =
{
...
#if defined(MBEDTLS_CIPHER_MODE_CBC)
static inline  const unsigned char des3_test_iv[8] =
{
    0x12, 0x34, 0x56, 0x78, 0x90, 0xAB, 0xCD, 0xEF,
};

static inline  const unsigned char des3_test_cbc_dec[3][8] =
{
...
static inline  const unsigned char des3_test_cbc_enc[3][8] =
{
 ...
 * Checkup routine
 */
static inline int mbedtls_des_self_test(int verbose)
{
    int i, j, u, v, ret = 0;
