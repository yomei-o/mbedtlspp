...
/* mbedtlspp: the amalgamation ships a C++ THREADING_ALT implementation in
 * threading_alt.hpp, so enable the threading layer here. In mbedtls 4.x
 * these options moved from mbedtls_config.h into this file. */
#define MBEDTLS_THREADING_C
#define MBEDTLS_THREADING_ALT
