 ...
 */
static inline const mbedtls_cipher_info_t *mbedtls_cipher_info_from_string(const char *cipher_name);
 ...
 * \return              \c NULL if the associated cipher information is not found.
 */
static inline const mbedtls_cipher_info_t *mbedtls_cipher_info_from_type(const mbedtls_cipher_type_t cipher_type);
 ...
 * \return              \c NULL if the associated cipher information is not found.
 */
static inline const mbedtls_cipher_info_t *mbedtls_cipher_info_from_values(const mbedtls_cipher_id_t cipher_id,
                                                             int key_bitlen,
 ...
 *                      cipher-specific context fails.
 */
static inline int MBEDTLS_DEPRECATED mbedtls_cipher_setup_psa(mbedtls_cipher_context_t *ctx,
                                                const mbedtls_cipher_info_t *cipher_info,
                                                size_t taglen);
#endif /* MBEDTLS_DEPRECATED_REMOVED */
 ...
 * \return              A cipher-specific error code on failure.
 */
static inline int mbedtls_cipher_update(mbedtls_cipher_context_t *ctx,
