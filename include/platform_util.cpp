 ...
 */
    ...
    && !defined(_WIN32)
static inline  void *(*const volatile memset_func)(void *, int, size_t) = memset;
#endif
...
static inline void mbedtls_zeroize_and_free(void *buf, size_t len)
{
    if (buf != NULL) {
...
static inline struct tm *mbedtls_platform_gmtime_r(const mbedtls_time_t *tt,
                                     struct tm *tm_buf)
{
...
static inline void (*mbedtls_test_hook_test_fail)(const char *, int, const char *);
