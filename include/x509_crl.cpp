 ...
 */
static inline  int x509_crl_get_version(unsigned char **p,
 ...
 */
static inline  int x509_get_crl_ext(unsigned char **p,
                            const unsigned char *end,
 ...
 */
static inline  int x509_get_crl_entry_ext(unsigned char **p,
                                  const unsigned char *end,
                                  mbedtls_x509_buf *ext)
{
    int ret = MBEDTLS_ERR_ERROR_CORRUPTION_DETECTED;
 ...
 * X.509 CRL Entries
 */
static inline  int x509_get_entries(unsigned char **p,
                            const unsigned char *end,
 ...
 */
static inline int mbedtls_x509_crl_parse_der(mbedtls_x509_crl *chain,
 ...
 */
static inline int mbedtls_x509_crl_parse(mbedtls_x509_crl *chain, const unsigned char *buf, size_t buflen)
{
#if defined(MBEDTLS_PEM_PARSE_C)
    int ret = MBEDTLS_ERR_ERROR_CORRUPTION_DETECTED;
    size_t use_len = 0;
 ...
 */
static inline int mbedtls_x509_crl_parse_file(mbedtls_x509_crl *chain, const char *path)
{
    int ret = MBEDTLS_ERR_ERROR_CORRUPTION_DETECTED;
    size_t n;
    unsigned char *buf;
 ...
 */
static inline void mbedtls_x509_crl_init(mbedtls_x509_crl *crl)
{
 ...
 */
static inline void mbedtls_x509_crl_free(mbedtls_x509_crl *crl)
{
