 ...
 * Forward S-box
 */
static inline MBEDTLS_MAYBE_UNUSED const unsigned char FSb[256] =
{
 ...
 * Reverse S-box
 */
static inline MBEDTLS_MAYBE_UNUSED const unsigned char RSb[256] =
{
 ...
 * Round constants
 */
static inline MBEDTLS_MAYBE_UNUSED const uint32_t round_constants[10] =
{
 ...
 */
static inline MBEDTLS_MAYBE_UNUSED unsigned char FSb[256];
static inline MBEDTLS_MAYBE_UNUSED uint32_t FT0[256];
static inline MBEDTLS_MAYBE_UNUSED uint32_t FT1[256];
static inline MBEDTLS_MAYBE_UNUSED uint32_t FT2[256];
static inline MBEDTLS_MAYBE_UNUSED uint32_t FT3[256];

/*
 * Reverse S-box & tables
 */
static inline MBEDTLS_MAYBE_UNUSED unsigned char RSb[256];

static inline MBEDTLS_MAYBE_UNUSED uint32_t RT0[256];
static inline MBEDTLS_MAYBE_UNUSED uint32_t RT1[256];
static inline MBEDTLS_MAYBE_UNUSED uint32_t RT2[256];
static inline MBEDTLS_MAYBE_UNUSED uint32_t RT3[256];

/*
 * Round constants
 */
static inline MBEDTLS_MAYBE_UNUSED uint32_t round_constants[10];
...
static inline MBEDTLS_MAYBE_UNUSED int aes_init_done = 0;

static inline MBEDTLS_MAYBE_UNUSED void aes_gen_tables(void)
{
    int i;
    uint8_t x, y, z;
    uint8_t pow[256];
...
static inline mbedtls_aes_implementation mbedtls_aes_get_implementation(void)
{
...
static inline void mbedtls_aes_xts_init(mbedtls_aes_xts_context *ctx)
{
    mbedtls_aes_init(&ctx->crypt);
    mbedtls_aes_init(&ctx->tweak);
}

static inline void mbedtls_aes_xts_free(mbedtls_aes_xts_context *ctx)
{
    if (ctx == NULL) {
        return;
    }
...
static inline MBEDTLS_MAYBE_UNUSED unsigned mbedtls_aes_rk_offset(uint32_t *buf)
{
 ...
 */
static inline int mbedtls_aes_setkey_enc(mbedtls_aes_context *ctx, const unsigned char *key,
 ...
 */
#if !defined(MBEDTLS_BLOCK_CIPHER_NO_DECRYPT)
static inline int mbedtls_aes_setkey_dec(mbedtls_aes_context *ctx, const unsigned char *key,
                           unsigned int keybits)
{
#if !defined(MBEDTLS_AES_USE_HARDWARE_ONLY)
    uint32_t *SK;
...
#if defined(MBEDTLS_CIPHER_MODE_XTS)
static inline  int mbedtls_aes_xts_decode_keys(const unsigned char *key,
                                       unsigned int keybits,
...
static inline int mbedtls_aes_xts_setkey_enc(mbedtls_aes_xts_context *ctx,
...
static inline int mbedtls_aes_xts_setkey_dec(mbedtls_aes_xts_context *ctx,
                               const unsigned char *key,
                               unsigned int keybits)
{
    int ret = MBEDTLS_ERR_ERROR_CORRUPTION_DETECTED;
 ...
 */
MBEDTLS_CHECK_RETURN_TYPICAL
static inline  int mbedtls_internal_aes_decrypt(mbedtls_aes_context *ctx,
                                        const unsigned char input[16],
                                        unsigned char output[16])
{
    int i;
 ...
 */
#if defined(MAY_NEED_TO_ALIGN)
static inline MBEDTLS_MAYBE_UNUSED void aes_maybe_realign(mbedtls_aes_context *ctx)
{
 ...
 */
static inline int mbedtls_aes_crypt_cbc(mbedtls_aes_context *ctx,
                          int mode,
                          size_t length,
                          unsigned char iv[16],
...
MBEDTLS_OPTIMIZE_FOR_PERFORMANCE
#endif
static inline int mbedtls_aes_crypt_xts(mbedtls_aes_xts_context *ctx,
                          int mode,
                          size_t length,
 ...
 */
static inline int mbedtls_aes_crypt_cfb8(mbedtls_aes_context *ctx,
                           int mode,
                           size_t length,
                           unsigned char iv[16],
                           const unsigned char *input,
 ...
 */
static inline int mbedtls_aes_crypt_ofb(mbedtls_aes_context *ctx,
                          size_t length,
                          size_t *iv_off,
                          unsigned char iv[16],
                          const unsigned char *input,
 ...
 */
#if !defined(MBEDTLS_BLOCK_CIPHER_NO_DECRYPT)
static inline  const unsigned char aes_test_ecb_dec[][16] =
{
...
static inline  const unsigned char aes_test_ecb_enc[][16] =
{
...
#if defined(MBEDTLS_CIPHER_MODE_CBC)
static inline  const unsigned char aes_test_cbc_dec[][16] =
{
...
static inline  const unsigned char aes_test_cbc_enc[][16] =
{
 ...
 */
static inline  const unsigned char aes_test_cfb128_key[][32] =
{
...
static inline  const unsigned char aes_test_cfb128_iv[16] =
{
    0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07,
    0x08, 0x09, 0x0A, 0x0B, 0x0C, 0x0D, 0x0E, 0x0F
};

static inline  const unsigned char aes_test_cfb128_pt[64] =
{
...
static inline  const unsigned char aes_test_cfb128_ct[][64] =
{
 ...
 */
static inline  const unsigned char aes_test_ofb_key[][32] =
{
    { 0x2B, 0x7E, 0x15, 0x16, 0x28, 0xAE, 0xD2, 0xA6,
      0xAB, 0xF7, 0x15, 0x88, 0x09, 0xCF, 0x4F, 0x3C },
#if !defined(MBEDTLS_AES_ONLY_128_BIT_KEY_LENGTH)
...
static inline  const unsigned char aes_test_ofb_iv[16] =
{
    0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07,
    0x08, 0x09, 0x0A, 0x0B, 0x0C, 0x0D, 0x0E, 0x0F
};

static inline  const unsigned char aes_test_ofb_pt[64] =
{
    0x6B, 0xC1, 0xBE, 0xE2, 0x2E, 0x40, 0x9F, 0x96,
    0xE9, 0x3D, 0x7E, 0x11, 0x73, 0x93, 0x17, 0x2A,
    0xAE, 0x2D, 0x8A, 0x57, 0x1E, 0x03, 0xAC, 0x9C,
...
static inline  const unsigned char aes_test_ofb_ct[][64] =
{
    { 0x3B, 0x3F, 0xD9, 0x2E, 0xB7, 0x2D, 0xAD, 0x20,
      0x33, 0x34, 0x49, 0xF8, 0xE8, 0x3C, 0xFB, 0x4A,
...
static inline  const unsigned char aes_test_ctr_key[][16] =
{
...
static inline  const unsigned char aes_test_ctr_nonce_counter[][16] =
{
...
static inline  const unsigned char aes_test_ctr_pt[][48] =
{
...
static inline  const unsigned char aes_test_ctr_ct[][48] =
{
...
static inline  const int aes_test_ctr_len[3] =
{ 16, 32, 36 };
#endif /* MBEDTLS_CIPHER_MODE_CTR */
 ...
 */
static inline  const unsigned char aes_test_xts_key[][32] =
{
...
static inline  const unsigned char aes_test_xts_pt32[][32] =
{
    { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
      0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
      0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
...
static inline  const unsigned char aes_test_xts_ct32[][32] =
{
...
static inline  const unsigned char aes_test_xts_data_unit[][16] =
{
    { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
      0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 },
 ...
 * Checkup routine
 */
static inline int mbedtls_aes_self_test(int verbose)
{
