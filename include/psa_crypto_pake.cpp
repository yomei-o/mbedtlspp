...
static inline  psa_status_t mbedtls_ecjpake_to_psa_error(int ret)
{
    switch (ret) {
...
#if defined(MBEDTLS_PSA_BUILTIN_ALG_JPAKE)
static inline  psa_status_t psa_pake_ecjpake_setup(mbedtls_psa_pake_operation_t *operation)
{
...
static inline psa_status_t mbedtls_psa_pake_setup(mbedtls_psa_pake_operation_t *operation,
...
static inline  psa_status_t mbedtls_psa_pake_output_internal(
...
static inline psa_status_t mbedtls_psa_pake_output(mbedtls_psa_pake_operation_t *operation,
                                     psa_crypto_driver_pake_step_t step,
                                     uint8_t *output,
                                     size_t output_size,
                                     size_t *output_length)
...
static inline  psa_status_t mbedtls_psa_pake_input_internal(
    mbedtls_psa_pake_operation_t *operation,
    psa_crypto_driver_pake_step_t step,
    const uint8_t *input,
    size_t input_length)
...
static inline psa_status_t mbedtls_psa_pake_input(mbedtls_psa_pake_operation_t *operation,
                                    psa_crypto_driver_pake_step_t step,
                                    const uint8_t *input,
                                    size_t input_length)
{
...
static inline psa_status_t mbedtls_psa_pake_get_implicit_key(
    mbedtls_psa_pake_operation_t *operation,
...
static inline psa_status_t mbedtls_psa_pake_abort(mbedtls_psa_pake_operation_t *operation)
{
