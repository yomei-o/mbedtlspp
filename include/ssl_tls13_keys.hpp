...
#define MBEDTLS_SSL_TLS1_3_LABEL(name, string)       \
    const unsigned char name    [sizeof(string)] MBEDTLS_ATTRIBUTE_UNTERMINATED_STRING;
...
//static inline  const struct mbedtls_ssl_tls13_labels_struct mbedtls_ssl_tls13_labels;
 ...
 */
MBEDTLS_CHECK_RETURN_CRITICAL
static inline int mbedtls_ssl_tls13_populate_transform(mbedtls_ssl_transform *transform,
                                         int endpoint,
                                         int ciphersuite,
