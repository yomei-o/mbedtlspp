...
#include "mps_common.hpp"
#include "mps_trace.hpp"

#include <string.h>

#if defined(MBEDTLS_MPS_ENABLE_TRACE)
static inline  int mbedtls_mps_trace_id = MBEDTLS_MPS_TRACE_BIT_READER;
...
static inline int mbedtls_mps_reader_init(mbedtls_mps_reader *rd,
                            unsigned char *acc,
...
static inline int mbedtls_mps_reader_free(mbedtls_mps_reader *rd)
{
...
static inline int mbedtls_mps_reader_feed(mbedtls_mps_reader *rd,
...
static inline int mbedtls_mps_reader_get(mbedtls_mps_reader *rd,
...
static inline int mbedtls_mps_reader_commit(mbedtls_mps_reader *rd)
{
...
static inline int mbedtls_mps_reader_reclaim(mbedtls_mps_reader *rd,
                               int *paused)
{
