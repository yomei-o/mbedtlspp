...
static inline  const mbedtls_ssl_ciphersuite_t *ssl_tls13_validate_peer_ciphersuite(
...
static inline  void ssl_tls13_select_ciphersuite(
    mbedtls_ssl_context *ssl,
...
static inline  int ssl_tls13_parse_key_exchange_modes_ext(mbedtls_ssl_context *ssl,
...
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_tls13_key_exchange_is_psk_available(mbedtls_ssl_context *ssl);
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_tls13_key_exchange_is_psk_ephemeral_available(mbedtls_ssl_context *ssl);

#if defined(MBEDTLS_SSL_SESSION_TICKETS)
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_tls13_offered_psks_check_identity_match_ticket(
    mbedtls_ssl_context *ssl,
    ...
    mbedtls_ssl_session *session)
{
     ...
     */
    ticket_buffer = (unsigned char*)mbedtls_calloc(1, identity_len);
...
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_tls13_offered_psks_check_identity_match(
    mbedtls_ssl_context *ssl,
    const unsigned char *identity,
    size_t identity_len,
    uint32_t obfuscated_ticket_age,
...
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_tls13_offered_psks_check_binder_match(
    mbedtls_ssl_context *ssl,
...
#if defined(MBEDTLS_SSL_SESSION_TICKETS)
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_tls13_session_copy_ticket(mbedtls_ssl_session *dst,
 ...
 */
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_tls13_parse_pre_shared_key_ext(
    mbedtls_ssl_context *ssl,
 ...
 * } PreSharedKeyExtension;
 */
static inline  int ssl_tls13_write_server_pre_shared_key_ext(mbedtls_ssl_context *ssl,
                                                     unsigned char *buf,
                                                     unsigned char *end,
                                                     size_t *olen)
{
 ...
 */
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_tls13_parse_supported_versions_ext_2(mbedtls_ssl_context *ssl,
                                                  const unsigned char *buf,
                                                  const unsigned char *end)
{
    const unsigned char *p = buf;
 ...
 */
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_tls13_parse_supported_groups_ext(mbedtls_ssl_context *ssl,
                                                const unsigned char *buf,
                                                const unsigned char *end)
{
    const unsigned char *p = buf;
 ...
 */
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_tls13_parse_key_shares_ext(mbedtls_ssl_context *ssl,
                                          const unsigned char *buf,
                                          const unsigned char *end)
{
    int ret = MBEDTLS_ERR_ERROR_CORRUPTION_DETECTED;
...
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_tls13_client_hello_has_exts(mbedtls_ssl_context *ssl,
                                           int exts_mask)
{
...
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_tls13_client_hello_has_exts_for_ephemeral_key_exchange(
    mbedtls_ssl_context *ssl)
{
...
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_tls13_client_hello_has_exts_for_psk_key_exchange(
    mbedtls_ssl_context *ssl)
{
    return ssl_tls13_client_hello_has_exts(
        ssl,
...
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_tls13_client_hello_has_exts_for_psk_ephemeral_key_exchange(
    mbedtls_ssl_context *ssl)
{
    return ssl_tls13_client_hello_has_exts(
        ssl,
...
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_tls13_key_exchange_is_ephemeral_available(mbedtls_ssl_context *ssl)
{
#if defined(MBEDTLS_SSL_TLS1_3_KEY_EXCHANGE_MODE_EPHEMERAL_ENABLED)
...
#if defined(MBEDTLS_USE_PSA_CRYPTO)
static inline  psa_algorithm_t ssl_tls13_iana_sig_alg_to_psa_alg(uint16_t sig_alg)
{
    switch (sig_alg) {
 ...
 */
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_tls13_pick_key_cert(mbedtls_ssl_context *ssl)
{
...
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_tls13_parse_client_hello(mbedtls_ssl_context *ssl,
                                        const unsigned char *buf,
                                        const unsigned char *end)
{
    int ret = MBEDTLS_ERR_ERROR_CORRUPTION_DETECTED;
    ...
    if (ret == 1) {
        ret = ssl_tls13_parse_supported_versions_ext_2(ssl,
...
#if defined(MBEDTLS_SSL_EARLY_DATA)
static inline  int ssl_tls13_check_early_data_requirements(mbedtls_ssl_context *ssl)
{
    mbedtls_ssl_handshake_params *handshake = ssl->handshake;
...
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_tls13_postprocess_client_hello(mbedtls_ssl_context *ssl,
                                              int hrr_required)
{
    int ret = MBEDTLS_ERR_ERROR_CORRUPTION_DETECTED;
...
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_tls13_process_client_hello(mbedtls_ssl_context *ssl)
{
 ...
 */
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_tls13_prepare_server_hello(mbedtls_ssl_context *ssl)
{
    int ret = MBEDTLS_ERR_ERROR_CORRUPTION_DETECTED;
 ...
 */
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_tls13_write_server_hello_supported_versions_ext(
    mbedtls_ssl_context *ssl,
    unsigned char *buf,
    unsigned char *end,
    size_t *out_len)
...
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_tls13_generate_and_write_key_share(mbedtls_ssl_context *ssl,
                                                  uint16_t named_group,
                                                  unsigned char *buf,
                                                  unsigned char *end,
                                                  size_t *out_len)
 ...
 */
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_tls13_write_key_share_ext_2(mbedtls_ssl_context *ssl,
                                         unsigned char *buf,
                                         unsigned char *end,
                                         size_t *out_len)
{
...
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_tls13_write_hrr_key_share_ext(mbedtls_ssl_context *ssl,
                                             unsigned char *buf,
                                             unsigned char *end,
                                             size_t *out_len)
{
 ...
 */
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_tls13_write_server_hello_body(mbedtls_ssl_context *ssl,
                                             unsigned char *buf,
                                             unsigned char *end,
                                             size_t *out_len,
                                             int is_hrr)
    ...
    *p++ = MBEDTLS_SSL_COMPRESS_NULL;
    ...
    if (mbedtls_ssl_tls13_key_exchange_mode_with_ephemeral(ssl)) {
        if (is_hrr) {
            ...
            ret = ssl_tls13_write_key_share_ext_2(ssl, p, end, &output_len);
        }
        if (ret != 0) {
            return ret;
        }
...
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_tls13_finalize_server_hello(mbedtls_ssl_context *ssl)
{
    int ret = MBEDTLS_ERR_ERROR_CORRUPTION_DETECTED;
...
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_tls13_write_server_hello(mbedtls_ssl_context *ssl)
{
    int ret = MBEDTLS_ERR_ERROR_CORRUPTION_DETECTED;
    unsigned char *buf;
 ...
 */
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_tls13_prepare_hello_retry_request(mbedtls_ssl_context *ssl)
{
    int ret = MBEDTLS_ERR_ERROR_CORRUPTION_DETECTED;
    if (ssl->handshake->hello_retry_request_flag) {
...
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_tls13_write_hello_retry_request(mbedtls_ssl_context *ssl)
{
    int ret = MBEDTLS_ERR_ERROR_CORRUPTION_DETECTED;
    unsigned char *buf;
    size_t buf_len, msg_len;
 ...
 */
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_tls13_write_encrypted_extensions_body(mbedtls_ssl_context *ssl,
                                                     unsigned char *buf,
                                                     unsigned char *end,
                                                     size_t *out_len)
{
...
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_tls13_write_encrypted_extensions(mbedtls_ssl_context *ssl)
{
    int ret = MBEDTLS_ERR_ERROR_CORRUPTION_DETECTED;
    unsigned char *buf;
    size_t buf_len, msg_len;
 ...
 */
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_tls13_certificate_request_coordinate_2(mbedtls_ssl_context *ssl)
{
    int authmode;
 ...
 */
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_tls13_write_certificate_request_body(mbedtls_ssl_context *ssl,
                                                    unsigned char *buf,
                                                    const unsigned char *end,
                                                    size_t *out_len)
{
...
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_tls13_write_certificate_request(mbedtls_ssl_context *ssl)
{
    int ret = MBEDTLS_ERR_ERROR_CORRUPTION_DETECTED;

    MBEDTLS_SSL_DEBUG_MSG(2, ("=> write certificate request"));

    MBEDTLS_SSL_PROC_CHK_NEG(ssl_tls13_certificate_request_coordinate_2(ssl));
 ...
 */
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_tls13_write_server_certificate(mbedtls_ssl_context *ssl)
{
    int ret = MBEDTLS_ERR_ERROR_CORRUPTION_DETECTED;
 ...
 */
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_tls13_write_certificate_verify(mbedtls_ssl_context *ssl)
{
 ...
 * second flight.
 */
static inline  void ssl_tls13_prepare_for_handshake_second_flight(
    mbedtls_ssl_context *ssl)
{
 ...
 */
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_tls13_write_server_finished(mbedtls_ssl_context *ssl)
{
    int ret = MBEDTLS_ERR_ERROR_CORRUPTION_DETECTED;
 ...
 */
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_tls13_end_of_early_data_coordinate(mbedtls_ssl_context *ssl)
{
    int ret = MBEDTLS_ERR_ERROR_CORRUPTION_DETECTED;
...
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_tls13_parse_end_of_early_data(mbedtls_ssl_context *ssl,
                                             const unsigned char *buf,
                                             const unsigned char *end)
{
 ...
 */
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_tls13_process_end_of_early_data(mbedtls_ssl_context *ssl)
{
    int ret = MBEDTLS_ERR_ERROR_CORRUPTION_DETECTED;
 ...
 */
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_tls13_process_client_finished(mbedtls_ssl_context *ssl)
{
    int ret = MBEDTLS_ERR_ERROR_CORRUPTION_DETECTED;
 ...
 */
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_tls13_handshake_wrapup_2(mbedtls_ssl_context *ssl)
{
...
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_tls13_write_new_session_ticket_coordinate(mbedtls_ssl_context *ssl)
{
...
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_tls13_prepare_new_session_ticket(mbedtls_ssl_context *ssl,
 ...
 */
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_tls13_write_new_session_ticket_body(mbedtls_ssl_context *ssl,
                                                   unsigned char *buf,
                                                   unsigned char *end,
                                                   size_t *out_len,
                                                   unsigned char *ticket_nonce,
 ...
 * Handler for MBEDTLS_SSL_TLS1_3_NEW_SESSION_TICKET
 */
static inline  int ssl_tls13_write_new_session_ticket(mbedtls_ssl_context *ssl)
{
    int ret = MBEDTLS_ERR_ERROR_CORRUPTION_DETECTED;
...
static inline int mbedtls_ssl_tls13_handshake_server_step(mbedtls_ssl_context *ssl)
{
    ...
    switch (ssl->state) {
        ...
        case MBEDTLS_SSL_HANDSHAKE_WRAPUP:
            ret = ssl_tls13_handshake_wrapup_2(ssl);
            break;
