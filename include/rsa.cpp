 ...
 */
static inline  int asn1_get_nonzero_mpi(unsigned char **p,
...
static inline int mbedtls_rsa_parse_key(mbedtls_rsa_context *rsa, const unsigned char *key, size_t keylen)
{
    int ret, version;
    size_t len;
    unsigned char *p, *end;
...
static inline int mbedtls_rsa_parse_pubkey(mbedtls_rsa_context *rsa, const unsigned char *key, size_t keylen)
{
...
static inline int mbedtls_rsa_write_key(const mbedtls_rsa_context *rsa, unsigned char *start,
                          unsigned char **p)
{
    size_t len = 0;
    int ret;
 ...
 *  }
 */
static inline int mbedtls_rsa_write_pubkey(const mbedtls_rsa_context *rsa, unsigned char *start,
                             unsigned char **p)
{
    int ret = MBEDTLS_ERR_ERROR_CORRUPTION_DETECTED;
    size_t len = 0;
 ...
 */
static inline MBEDTLS_STATIC_TESTABLE int mbedtls_ct_rsaes_pkcs1_v15_unpadding(
...
static inline int mbedtls_rsa_decrypt_decompose_ret(
...
static inline int mbedtls_rsa_import(mbedtls_rsa_context *ctx,
                       const mbedtls_mpi *N,
...
static inline int mbedtls_rsa_import_raw(mbedtls_rsa_context *ctx,
 ...
 */
static inline  int rsa_check_context(mbedtls_rsa_context const *ctx, int is_priv,
                             int blinding_needed)
{
...
static inline int mbedtls_rsa_complete(mbedtls_rsa_context *ctx)
{
    int ret = 0;
...
static inline int mbedtls_rsa_export_raw(const mbedtls_rsa_context *ctx,
...
static inline int mbedtls_rsa_export(const mbedtls_rsa_context *ctx,
 ...
 */
static inline int mbedtls_rsa_export_crt(const mbedtls_rsa_context *ctx,
 ...
 */
static inline void mbedtls_rsa_init(mbedtls_rsa_context *ctx)
{
 ...
 */
static inline int mbedtls_rsa_set_padding(mbedtls_rsa_context *ctx, int padding,
 ...
 */
static inline int mbedtls_rsa_get_padding_mode(const mbedtls_rsa_context *ctx)
{
    return ctx->padding;
}
 ...
 */
static inline int mbedtls_rsa_get_md_alg(const mbedtls_rsa_context *ctx)
{
    return ctx->hash_id;
}
 ...
 */
static inline size_t mbedtls_rsa_get_bitlen(const mbedtls_rsa_context *ctx)
{
 ...
 */
static inline size_t mbedtls_rsa_get_len(const mbedtls_rsa_context *ctx)
{
    return ctx->len;
}
 ...
 */
static inline int mbedtls_rsa_check_pubkey(const mbedtls_rsa_context *ctx)
{
 ...
 */
static inline int mbedtls_rsa_check_privkey(const mbedtls_rsa_context *ctx)
{
 ...
 */
static inline int mbedtls_rsa_check_pub_priv(const mbedtls_rsa_context *pub,
 ...
 */
static inline int mbedtls_rsa_public(mbedtls_rsa_context *ctx,
 ...
 */
static inline  int rsa_apply_crt(mbedtls_mpi *T,
...
static inline  int rsa_gen_rand_with_inverse(const mbedtls_rsa_context *ctx,
                                     mbedtls_mpi *A,
                                     mbedtls_mpi *B,
                                     int (*f_rng)(void *, unsigned char *, size_t),
                                     void *p_rng)
 ...
 */
static inline  int rsa_prepare_blinding(mbedtls_rsa_context *ctx,
 ...
 * T = T * Vf mod N
 */
static inline  int rsa_unblind(mbedtls_mpi *T, mbedtls_mpi *Vf, const mbedtls_mpi *N)
{
    int ret = MBEDTLS_ERR_ERROR_CORRUPTION_DETECTED;
 ...
 */
static inline int mbedtls_rsa_private(mbedtls_rsa_context *ctx,
                        int (*f_rng)(void *, unsigned char *, size_t),
                        void *p_rng,
                        const unsigned char *input,
                        unsigned char *output)
 ...
 */
static inline  int mgf_mask(unsigned char *dst, size_t dlen, unsigned char *src,
 ...
 * \param md_alg    message digest to use
 */
static inline  int hash_mprime(const unsigned char *hash, size_t hlen,
 ...
 */
static inline  int compute_hash(mbedtls_md_type_t md_alg,
 ...
 */
static inline int mbedtls_rsa_rsaes_oaep_encrypt(mbedtls_rsa_context *ctx,
                                   int (*f_rng)(void *, unsigned char *, size_t),
                                   void *p_rng,
 ...
 */
static inline int mbedtls_rsa_rsaes_pkcs1_v15_encrypt(mbedtls_rsa_context *ctx,
                                        int (*f_rng)(void *, unsigned char *, size_t),
 ...
 */
static inline int mbedtls_rsa_pkcs1_encrypt(mbedtls_rsa_context *ctx,
                              int (*f_rng)(void *, unsigned char *, size_t),
                              void *p_rng,
                              size_t ilen,
                              const unsigned char *input,
 ...
 */
static inline int mbedtls_rsa_rsaes_oaep_decrypt(mbedtls_rsa_context *ctx,
                                   int (*f_rng)(void *, unsigned char *, size_t),
                                   void *p_rng,
                                   const unsigned char *label, size_t label_len,
                                   size_t *olen,
 ...
 */
static inline int mbedtls_rsa_rsaes_pkcs1_v15_decrypt(mbedtls_rsa_context *ctx,
                                        int (*f_rng)(void *, unsigned char *, size_t),
                                        void *p_rng,
                                        size_t *olen,
                                        const unsigned char *input,
 ...
 */
static inline int mbedtls_rsa_pkcs1_decrypt(mbedtls_rsa_context *ctx,
                              int (*f_rng)(void *, unsigned char *, size_t),
                              void *p_rng,
                              size_t *olen,
                              const unsigned char *input,
...
#if defined(MBEDTLS_PKCS1_V21)
static inline  int rsa_rsassa_pss_sign_no_mode_check(mbedtls_rsa_context *ctx,
                                             int (*f_rng)(void *, unsigned char *, size_t),
                                             void *p_rng,
...
static inline  int rsa_rsassa_pss_sign(mbedtls_rsa_context *ctx,
                               int (*f_rng)(void *, unsigned char *, size_t),
                               void *p_rng,
                               mbedtls_md_type_t md_alg,
                               unsigned int hashlen,
...
static inline int mbedtls_rsa_rsassa_pss_sign_no_mode_check(mbedtls_rsa_context *ctx,
                                              int (*f_rng)(void *, unsigned char *, size_t),
                                              void *p_rng,
                                              mbedtls_md_type_t md_alg,
                                              unsigned int hashlen,
 ...
 */
static inline int mbedtls_rsa_rsassa_pss_sign_ext(mbedtls_rsa_context *ctx,
                                    int (*f_rng)(void *, unsigned char *, size_t),
                                    void *p_rng,
                                    mbedtls_md_type_t md_alg,
                                    unsigned int hashlen,
 ...
 */
static inline int mbedtls_rsa_rsassa_pss_sign(mbedtls_rsa_context *ctx,
                                int (*f_rng)(void *, unsigned char *, size_t),
                                void *p_rng,
                                mbedtls_md_type_t md_alg,
                                unsigned int hashlen,
 ...
 *
 */
static inline  int rsa_rsassa_pkcs1_v15_encode(mbedtls_md_type_t md_alg,
                                       unsigned int hashlen,
                                       const unsigned char *hash,
                                       size_t dst_len,
                                       unsigned char *dst)
 ...
 */
static inline int mbedtls_rsa_rsassa_pkcs1_v15_sign(mbedtls_rsa_context *ctx,
                                      int (*f_rng)(void *, unsigned char *, size_t),
                                      void *p_rng,
                                      mbedtls_md_type_t md_alg,
                                      unsigned int hashlen,
 ...
 * Do an RSA operation to sign the message digest
 */
static inline int mbedtls_rsa_pkcs1_sign(mbedtls_rsa_context *ctx,
                           int (*f_rng)(void *, unsigned char *, size_t),
                           void *p_rng,
                           mbedtls_md_type_t md_alg,
                           unsigned int hashlen,
 ...
 */
static inline int mbedtls_rsa_rsassa_pss_verify_ext(mbedtls_rsa_context *ctx,
                                      mbedtls_md_type_t md_alg,
                                      unsigned int hashlen,
                                      const unsigned char *hash,
 ...
 */
static inline int mbedtls_rsa_rsassa_pss_verify(mbedtls_rsa_context *ctx,
                                  mbedtls_md_type_t md_alg,
                                  unsigned int hashlen,
                                  const unsigned char *hash,
                                  const unsigned char *sig)
 ...
 */
static inline int mbedtls_rsa_rsassa_pkcs1_v15_verify(mbedtls_rsa_context *ctx,
                                        mbedtls_md_type_t md_alg,
                                        unsigned int hashlen,
                                        const unsigned char *hash,
                                        const unsigned char *sig)
 ...
 */
static inline int mbedtls_rsa_pkcs1_verify(mbedtls_rsa_context *ctx,
                             mbedtls_md_type_t md_alg,
                             unsigned int hashlen,
                             const unsigned char *hash,
                             const unsigned char *sig)
 ...
 */
static inline int mbedtls_rsa_copy(mbedtls_rsa_context *dst, const mbedtls_rsa_context *src)
{
    int ret = MBEDTLS_ERR_ERROR_CORRUPTION_DETECTED;
 ...
 */
static inline void mbedtls_rsa_free(mbedtls_rsa_context *ctx)
{
    if (ctx == NULL) {
        return;
    }
...
#if defined(MBEDTLS_PKCS1_V15)
static inline  int myrand(void *rng_state, unsigned char *output, size_t len)
{
 ...
 * Checkup routine
 */
static inline int mbedtls_rsa_self_test(int verbose)
{
    int ret = 0;
#if defined(MBEDTLS_PKCS1_V15)
    size_t len;
