...
#undef PUBLIC_KEY_I_KEY_ID_OFFSET
...
static inline int (*mbedtls_lmots_sign_private_key_invalidated_hook)(unsigned char *) = NULL;
 ...
 */
static inline  unsigned short lmots_checksum_calculate(const mbedtls_lmots_parameters_t *params,
 ...
 *                      size P bytes).
 */
static inline  int create_digit_array_with_checksum(const mbedtls_lmots_parameters_t *params,
 ...
 *                      34.
 */
static inline  int hash_digit_array(const mbedtls_lmots_parameters_t *params,
 ...
 */
static inline  int public_key_from_hashed_digit_array(const mbedtls_lmots_parameters_t *params,
...
static inline int mbedtls_lms_error_from_psa(psa_status_t status)
{
    switch (status) {
        case PSA_SUCCESS:
            return 0;
...
static inline void mbedtls_lmots_public_init(mbedtls_lmots_public_t *ctx)
{
    memset(ctx, 0, sizeof(*ctx));
}

static inline void mbedtls_lmots_public_free(mbedtls_lmots_public_t *ctx)
{
    if (ctx == NULL) {
        return;
    }
...
static inline int mbedtls_lmots_import_public_key(mbedtls_lmots_public_t *ctx,
...
static inline int mbedtls_lmots_export_public_key(const mbedtls_lmots_public_t *ctx,
...
static inline int mbedtls_lmots_calculate_public_key_candidate(const mbedtls_lmots_parameters_t *params,
                                                 const unsigned char  *msg,
                                                 size_t msg_size,
...
static inline int mbedtls_lmots_verify(const mbedtls_lmots_public_t *ctx,
...
static inline void mbedtls_lmots_private_init(mbedtls_lmots_private_t *ctx)
{
    memset(ctx, 0, sizeof(*ctx));
}

static inline void mbedtls_lmots_private_free(mbedtls_lmots_private_t *ctx)
{
    if (ctx == NULL) {
        return;
    }
...
static inline int mbedtls_lmots_generate_private_key(mbedtls_lmots_private_t *ctx,
...
static inline int mbedtls_lmots_calculate_public_key(mbedtls_lmots_public_t *ctx,
...
static inline int mbedtls_lmots_sign(mbedtls_lmots_private_t *ctx,
