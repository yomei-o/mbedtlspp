...
static inline  int pkcs12_parse_pbe_params(mbedtls_asn1_buf *params,
...
static inline  int pkcs12_pbe_derive_key_iv(mbedtls_asn1_buf *pbe_params, mbedtls_md_type_t md_type,
...
static inline int mbedtls_pkcs12_pbe_ext(mbedtls_asn1_buf *pbe_params, int mode,
...
static inline int mbedtls_pkcs12_pbe(mbedtls_asn1_buf *pbe_params, int mode,
                       mbedtls_cipher_type_t cipher_type, mbedtls_md_type_t md_type,
                       const unsigned char *pwd,  size_t pwdlen,
                       const unsigned char *data, size_t len,
...
static inline  void pkcs12_fill_buffer(unsigned char *data, size_t data_len,
...
static inline  int calculate_hashes(mbedtls_md_type_t md_type, int iterations,
...
static inline int mbedtls_pkcs12_derivation(unsigned char *data, size_t datalen,
                              const unsigned char *pwd, size_t pwdlen,
