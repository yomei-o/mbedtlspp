...
#if defined(MBEDTLS_RSA_C)
static inline  int rsa_can_do(mbedtls_pk_type_t type)
{
...
#if defined(MBEDTLS_USE_PSA_CRYPTO)
static inline int mbedtls_pk_psa_rsa_sign_ext(psa_algorithm_t alg,
...
#if defined(MBEDTLS_USE_PSA_CRYPTO)
static inline  int rsa_sign_wrap(mbedtls_pk_context *pk, mbedtls_md_type_t md_alg,
                         const unsigned char *hash, size_t hash_len,
...
#if defined(MBEDTLS_USE_PSA_CRYPTO)
static inline  int rsa_decrypt_wrap(mbedtls_pk_context *pk,
...
#if defined(MBEDTLS_USE_PSA_CRYPTO)
static inline  int rsa_encrypt_wrap(mbedtls_pk_context *pk,
                            const unsigned char *input, size_t ilen,
                            unsigned char *output, size_t *olen, size_t osize,
                            int (*f_rng)(void *, unsigned char *, size_t), void *p_rng)
{
...
static inline  void *rsa_alloc_wrap(void)
{
...
static inline  void rsa_free_wrap(void *ctx)
{
 ...
 * Generic EC key
 */
static inline  int eckey_can_do(mbedtls_pk_type_t type)
{
...
static inline  int ecdsa_verify_psa(unsigned char *key, size_t key_len,
...
static inline  int ecdsa_opaque_verify_wrap(mbedtls_pk_context *pk,
...
#if defined(MBEDTLS_PK_USE_PSA_EC_DATA)
static inline  int ecdsa_verify_wrap(mbedtls_pk_context *pk,
                             mbedtls_md_type_t md_alg,
                             const unsigned char *hash, size_t hash_len,
                             const unsigned char *sig, size_t sig_len)
{
...
#endif /* MBEDTLS_PK_USE_PSA_EC_DATA */
#else /* MBEDTLS_USE_PSA_CRYPTO */
static inline  int ecdsa_verify_wrap(mbedtls_pk_context *pk, mbedtls_md_type_t md_alg,
                             const unsigned char *hash, size_t hash_len,
                             const unsigned char *sig, size_t sig_len)
{
    int ret = MBEDTLS_ERR_ERROR_CORRUPTION_DETECTED;
 ...
 */
static inline  int ecdsa_sign_psa(mbedtls_svc_key_id_t key_id, mbedtls_md_type_t md_alg,
                          const unsigned char *hash, size_t hash_len,
                          unsigned char *sig, size_t sig_size, size_t *sig_len)
{
    int ret = MBEDTLS_ERR_ERROR_CORRUPTION_DETECTED;
...
static inline  int ecdsa_opaque_sign_wrap(mbedtls_pk_context *pk,
                                  mbedtls_md_type_t md_alg,
                                  const unsigned char *hash, size_t hash_len,
                                  unsigned char *sig, size_t sig_size,
                                  size_t *sig_len,
...
#else /* MBEDTLS_PK_USE_PSA_EC_DATA */
static inline  int ecdsa_sign_wrap(mbedtls_pk_context *pk, mbedtls_md_type_t md_alg,
                           const unsigned char *hash, size_t hash_len,
                           unsigned char *sig, size_t sig_size, size_t *sig_len,
                           int (*f_rng)(void *, unsigned char *, size_t), void *p_rng)
{
...
static inline  int ecdsa_verify_rs_wrap(mbedtls_pk_context *ctx, mbedtls_md_type_t md_alg,
                                const unsigned char *hash, size_t hash_len,
                                const unsigned char *sig, size_t sig_len,
                                void *rs_ctx);

static inline  int ecdsa_sign_rs_wrap(mbedtls_pk_context *ctx, mbedtls_md_type_t md_alg,
                              const unsigned char *hash, size_t hash_len,
                              unsigned char *sig, size_t sig_size, size_t *sig_len,
                              int (*f_rng)(void *, unsigned char *, size_t), void *p_rng,
                              void *rs_ctx);
...
static inline  void *eckey_rs_alloc(void)
{
...
static inline  void eckey_rs_free(void *ctx)
{
    eckey_restart_ctx *rs_ctx;
...
static inline  int eckey_verify_rs_wrap(mbedtls_pk_context *pk, mbedtls_md_type_t md_alg,
                                const unsigned char *hash, size_t hash_len,
                                const unsigned char *sig, size_t sig_len,
                                void *rs_ctx)
{
...
static inline  int eckey_sign_rs_wrap(mbedtls_pk_context *pk, mbedtls_md_type_t md_alg,
                              const unsigned char *hash, size_t hash_len,
                              unsigned char *sig, size_t sig_size, size_t *sig_len,
                              int (*f_rng)(void *, unsigned char *, size_t), void *p_rng,
                              void *rs_ctx)
...
#else /* MBEDTLS_PK_USE_PSA_EC_DATA */
static inline  int ecdsa_opaque_check_pair_wrap(mbedtls_pk_context *pub,
...
#if !defined(MBEDTLS_PK_USE_PSA_EC_DATA)
static inline  void *eckey_alloc_wrap(void)
{
...
static inline  void eckey_free_wrap(void *ctx)
{
 ...
 */
static inline  int eckeydh_can_do(mbedtls_pk_type_t type)
{
    return type == MBEDTLS_PK_ECKEY ||
           type == MBEDTLS_PK_ECKEY_DH;
}
...
#if defined(MBEDTLS_PK_CAN_ECDSA_SOME)
static inline  int ecdsa_can_do(mbedtls_pk_type_t type)
{
    return type == MBEDTLS_PK_ECDSA;
}

#if defined(MBEDTLS_ECDSA_C) && defined(MBEDTLS_ECP_RESTARTABLE)
static inline  int ecdsa_verify_rs_wrap(mbedtls_pk_context *pk, mbedtls_md_type_t md_alg,
                                const unsigned char *hash, size_t hash_len,
                                const unsigned char *sig, size_t sig_len,
                                void *rs_ctx)
{
...
static inline  int ecdsa_sign_rs_wrap(mbedtls_pk_context *pk, mbedtls_md_type_t md_alg,
                              const unsigned char *hash, size_t hash_len,
                              unsigned char *sig, size_t sig_size, size_t *sig_len,
                              int (*f_rng)(void *, unsigned char *, size_t), void *p_rng,
                              void *rs_ctx)
...
static inline  void *ecdsa_rs_alloc(void)
{
...
static inline  void ecdsa_rs_free(void *ctx)
{
...
static inline const mbedtls_pk_info_t mbedtls_ecdsa_info = {
    .type = MBEDTLS_PK_ECDSA,
    .name = "ECDSA",
...
static inline  int rsa_alt_can_do(mbedtls_pk_type_t type)
{
    return type == MBEDTLS_PK_RSA;
}

static inline  size_t rsa_alt_get_bitlen(mbedtls_pk_context *pk)
{
...
static inline  int rsa_alt_sign_wrap(mbedtls_pk_context *pk, mbedtls_md_type_t md_alg,
                             const unsigned char *hash, size_t hash_len,
                             unsigned char *sig, size_t sig_size, size_t *sig_len,
                             int (*f_rng)(void *, unsigned char *, size_t), void *p_rng)
{
...
static inline  int rsa_alt_decrypt_wrap(mbedtls_pk_context *pk,
                                const unsigned char *input, size_t ilen,
                                unsigned char *output, size_t *olen, size_t osize,
                                int (*f_rng)(void *, unsigned char *, size_t), void *p_rng)
{
...
#if defined(MBEDTLS_RSA_C)
static inline  int rsa_alt_check_pair(mbedtls_pk_context *pub, mbedtls_pk_context *prv,
                              int (*f_rng)(void *, unsigned char *, size_t),
                              void *p_rng)
{
    ...
    unsigned char *sig = (unsigned char *) mbedtls_calloc(1, sig_size);
    if (sig == NULL) {
        return MBEDTLS_ERR_PK_ALLOC_FAILED;
    }
...
static inline  void *rsa_alt_alloc_wrap(void)
{
...
static inline  void rsa_alt_free_wrap(void *ctx)
{
    mbedtls_zeroize_and_free(ctx, sizeof(mbedtls_rsa_alt_context));
}

static inline const mbedtls_pk_info_t mbedtls_rsa_alt_info = {
...
static inline  int rsa_opaque_can_do(mbedtls_pk_type_t type)
{
    return type == MBEDTLS_PK_RSA ||
           type == MBEDTLS_PK_RSASSA_PSS;
}
...
static inline  int rsa_opaque_decrypt(mbedtls_pk_context *pk,
                              const unsigned char *input, size_t ilen,
                              unsigned char *output, size_t *olen, size_t osize,
                              int (*f_rng)(void *, unsigned char *, size_t), void *p_rng)
{
...
static inline  int rsa_opaque_sign_wrap(mbedtls_pk_context *pk, mbedtls_md_type_t md_alg,
                                const unsigned char *hash, size_t hash_len,
                                unsigned char *sig, size_t sig_size, size_t *sig_len,
                                int (*f_rng)(void *, unsigned char *, size_t), void *p_rng)
{
