...
static inline int mbedtls_debug_snprintf(char *dest, size_t maxlen,
                           const char *format, ...)
{
    va_list argp;
...
static inline void mbedtls_debug_print_ecp(const mbedtls_ssl_context *ssl, int level,
                             const char *file, int line,
...
static inline  void mbedtls_debug_print_ec_coord(const mbedtls_ssl_context *ssl, int level,
                                         const char *file, int line, const char *text,
                                         const unsigned char *buf, size_t len)
{
    char str[DEBUG_BUF_SIZE];
...
static inline  void mbedtls_debug_printf_ecdh_internal(const mbedtls_ssl_context *ssl,
...
static inline void mbedtls_debug_printf_ecdh(const mbedtls_ssl_context *ssl, int level,
                               const char *file, int line,
                               const mbedtls_ecdh_context *ecdh,
                               mbedtls_debug_ecdh_attr attr)
{
