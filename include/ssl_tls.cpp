...
static inline  int local_err_translation(psa_status_t status)
{
...
static inline  mbedtls_ssl_chk_buf_ptr_args chk_buf_ptr_fail_args;

static inline void mbedtls_ssl_set_chk_buf_ptr_fail_args(
...
static inline void mbedtls_ssl_reset_chk_buf_ptr_fail_args(void)
{
    memset(&chk_buf_ptr_fail_args, 0, sizeof(chk_buf_ptr_fail_args));
}

static inline int mbedtls_ssl_cmp_chk_buf_ptr_fail_args(mbedtls_ssl_chk_buf_ptr_args *args)
{
...
static inline int mbedtls_ssl_conf_cid(mbedtls_ssl_config *conf,
                         size_t len,
...
static inline int mbedtls_ssl_set_cid(mbedtls_ssl_context *ssl,
                        int enable,
...
static inline int mbedtls_ssl_get_own_cid(mbedtls_ssl_context *ssl,
                            int *enabled,
...
static inline int mbedtls_ssl_get_peer_cid(mbedtls_ssl_context *ssl,
                             int *enabled,
 ...
 */
static inline  unsigned int ssl_mfl_code_to_length(int mfl)
{
    switch (mfl) {
...
static inline int mbedtls_ssl_session_copy(mbedtls_ssl_session *dst,
...
static inline  int resize_buffer(unsigned char **buffer, size_t len_new, size_t *len_old)
{
...
static inline  void handle_buffer_resizing(mbedtls_ssl_context *ssl, int downsizing,
...
static inline  tls_prf_fn ssl_tls12prf_from_cs(int ciphersuite_id);
...
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_tls12_populate_transform(mbedtls_ssl_transform *transform,
                                        int ciphersuite,
...
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int tls_prf_sha256(const unsigned char *secret, size_t slen,
                          const char *label,
                          const unsigned char *random, size_t rlen,
                          unsigned char *dstbuf, size_t dlen);
static inline  int ssl_calc_verify_tls_sha256(const mbedtls_ssl_context *, unsigned char *, size_t *);
static inline  int ssl_calc_finished_tls_sha256(mbedtls_ssl_context *, unsigned char *, int);

#endif /* MBEDTLS_MD_CAN_SHA256*/

#if defined(MBEDTLS_MD_CAN_SHA384)
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int tls_prf_sha384(const unsigned char *secret, size_t slen,
                          const char *label,
                          const unsigned char *random, size_t rlen,
                          unsigned char *dstbuf, size_t dlen);

static inline  int ssl_calc_verify_tls_sha384(const mbedtls_ssl_context *, unsigned char *, size_t *);
static inline  int ssl_calc_finished_tls_sha384(mbedtls_ssl_context *, unsigned char *, int);
#endif /* MBEDTLS_MD_CAN_SHA384*/

MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_tls12_session_load(mbedtls_ssl_session *session,
                                  const unsigned char *buf,
                                  size_t len);
#endif /* MBEDTLS_SSL_PROTO_TLS1_2 */

static inline  int ssl_update_checksum_start(mbedtls_ssl_context *, const unsigned char *, size_t);

#if defined(MBEDTLS_MD_CAN_SHA256)
static inline  int ssl_update_checksum_sha256(mbedtls_ssl_context *, const unsigned char *, size_t);
#endif /* MBEDTLS_MD_CAN_SHA256*/

#if defined(MBEDTLS_MD_CAN_SHA384)
static inline  int ssl_update_checksum_sha384(mbedtls_ssl_context *, const unsigned char *, size_t);
#endif /* MBEDTLS_MD_CAN_SHA384*/

static inline int mbedtls_ssl_tls_prf(const mbedtls_tls_prf_types prf,
...
#if defined(MBEDTLS_X509_CRT_PARSE_C)
static inline  void ssl_clear_peer_cert(mbedtls_ssl_session *session)
{
#if defined(MBEDTLS_SSL_KEEP_PEER_CERTIFICATE)
...
static inline uint32_t mbedtls_ssl_get_extension_id(unsigned int extension_type)
{
...
static inline uint32_t mbedtls_ssl_get_extension_mask(unsigned int extension_type)
{
    return 1 << mbedtls_ssl_get_extension_id(extension_type);
}

#if defined(MBEDTLS_DEBUG_C)
static inline  const char *extension_name_table[] = {
...
static inline  const unsigned int extension_type_table[] = {
...
static inline  const char *ssl_tls13_get_hs_msg_name(int hs_msg_type)
{
    switch (hs_msg_type) {
...
static inline void mbedtls_ssl_print_extension(const mbedtls_ssl_context *ssl,
...
static inline  const char *ticket_flag_name_table[] =
{
...
static inline void mbedtls_ssl_print_ticket_flags(const mbedtls_ssl_context *ssl,
                                    int level, const char *file, int line,
                                    unsigned int flags)
{
    size_t i;
...
static inline void mbedtls_ssl_optimize_checksum(mbedtls_ssl_context *ssl,
...
static inline int mbedtls_ssl_add_hs_hdr_to_checksum(mbedtls_ssl_context *ssl,
                                       unsigned hs_type,
                                       size_t total_hs_len)
{
...
static inline int mbedtls_ssl_add_hs_msg_to_checksum(mbedtls_ssl_context *ssl,
                                       unsigned hs_type,
...
static inline int mbedtls_ssl_reset_checksum(mbedtls_ssl_context *ssl)
{
#if defined(MBEDTLS_MD_CAN_SHA256) || \
...
static inline  int ssl_update_checksum_start(mbedtls_ssl_context *ssl,
...
static inline  void ssl_handshake_params_init(mbedtls_ssl_handshake_params *handshake)
{
...
static inline void mbedtls_ssl_transform_init(mbedtls_ssl_transform *transform)
{
...
static inline void mbedtls_ssl_session_init(mbedtls_ssl_session *session)
{
    memset(session, 0, sizeof(mbedtls_ssl_session));
}

MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_handshake_init(mbedtls_ssl_context *ssl)
{
    int ret = MBEDTLS_ERR_ERROR_CORRUPTION_DETECTED;
 ...
 */
    ...
    if (ssl->conf->curve_list != NULL) {
        ...
        uint16_t *group_list = (uint16_t*)mbedtls_calloc(length + 1, sizeof(uint16_t));
        if (group_list == NULL) {
            return MBEDTLS_ERR_SSL_ALLOC_FAILED;
        }
    ...
    if (mbedtls_ssl_conf_is_tls12_only(ssl->conf) &&
        ...
        ssl->handshake->sig_algs = (const uint16_t*)mbedtls_calloc(1, sig_algs_len +
                                                  sizeof(uint16_t));
...
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_cookie_write_dummy(void *ctx,
...
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_cookie_check_dummy(void *ctx,
 ...
 */
static inline void mbedtls_ssl_init(mbedtls_ssl_context *ssl)
{
    memset(ssl, 0, sizeof(mbedtls_ssl_context));
}

MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_conf_version_check(const mbedtls_ssl_context *ssl)
{
...
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_conf_check(const mbedtls_ssl_context *ssl)
{
    int ret;
...
#endif
    ssl->in_buf = (unsigned char*)mbedtls_calloc(1, in_buf_len);
    if (ssl->in_buf == NULL) {
...
#endif
    ssl->out_buf = (unsigned char*)mbedtls_calloc(1, out_buf_len);
    if (ssl->out_buf == NULL) {
 ...
 */
static inline void mbedtls_ssl_session_reset_msg_layer(mbedtls_ssl_context *ssl,
                                         int partial)
{
#if defined(MBEDTLS_SSL_VARIABLE_BUFFER_LENGTH)
...
static inline int mbedtls_ssl_session_reset_int(mbedtls_ssl_context *ssl, int partial)
{
    int ret = MBEDTLS_ERR_ERROR_CORRUPTION_DETECTED;
 ...
 * all application-set variables, function pointers and data.
 */
static inline int mbedtls_ssl_session_reset(mbedtls_ssl_context *ssl)
{
 ...
 * SSL set accessors
 */
static inline void mbedtls_ssl_conf_endpoint(mbedtls_ssl_config *conf, int endpoint)
{
    conf->endpoint   = endpoint;
}

static inline void mbedtls_ssl_conf_transport(mbedtls_ssl_config *conf, int transport)
{
    conf->transport = transport;
}

#if defined(MBEDTLS_SSL_DTLS_ANTI_REPLAY)
static inline void mbedtls_ssl_conf_dtls_anti_replay(mbedtls_ssl_config *conf, char mode)
{
    conf->anti_replay = mode;
}
#endif

static inline void mbedtls_ssl_conf_dtls_badmac_limit(mbedtls_ssl_config *conf, unsigned limit)
{
...
static inline void mbedtls_ssl_set_datagram_packing(mbedtls_ssl_context *ssl,
                                      unsigned allow_packing)
{
    ssl->disable_datagram_packing = !allow_packing;
}

static inline void mbedtls_ssl_conf_handshake_timeout(mbedtls_ssl_config *conf,
...
#if defined(MBEDTLS_X509_CRT_PARSE_C)
static inline void mbedtls_ssl_conf_verify(mbedtls_ssl_config *conf,
...
static inline void mbedtls_ssl_conf_dbg(mbedtls_ssl_config *conf,
...
static inline void mbedtls_ssl_set_bio(mbedtls_ssl_context *ssl,
                         void *p_bio,
...
#if defined(MBEDTLS_SSL_PROTO_DTLS)
static inline void mbedtls_ssl_set_mtu(mbedtls_ssl_context *ssl, uint16_t mtu)
{
    ssl->mtu = mtu;
}
#endif

static inline void mbedtls_ssl_conf_read_timeout(mbedtls_ssl_config *conf, uint32_t timeout)
{
    conf->read_timeout   = timeout;
}

static inline void mbedtls_ssl_set_timer_cb(mbedtls_ssl_context *ssl,
                              void *p_timer,
...
#if defined(MBEDTLS_SSL_SRV_C)
static inline void mbedtls_ssl_conf_session_cache(mbedtls_ssl_config *conf,
                                    void *p_cache,
...
#if defined(MBEDTLS_SSL_CLI_C)
static inline int mbedtls_ssl_set_session(mbedtls_ssl_context *ssl, const mbedtls_ssl_session *session)
{
    int ret = MBEDTLS_ERR_ERROR_CORRUPTION_DETECTED;
...
static inline void mbedtls_ssl_conf_ciphersuites(mbedtls_ssl_config *conf,
...
#if defined(MBEDTLS_SSL_PROTO_TLS1_3)
static inline void mbedtls_ssl_conf_tls13_key_exchange_modes(mbedtls_ssl_config *conf,
                                               const int kex_modes)
{
...
#if defined(MBEDTLS_SSL_EARLY_DATA)
static inline void mbedtls_ssl_conf_early_data(mbedtls_ssl_config *conf,
...
#if defined(MBEDTLS_SSL_SRV_C)
static inline void mbedtls_ssl_conf_max_early_data_size(
...
#if defined(MBEDTLS_X509_CRT_PARSE_C)
static inline void mbedtls_ssl_conf_cert_profile(mbedtls_ssl_config *conf,
                                   const mbedtls_x509_crt_profile *profile)
{
    conf->cert_profile = profile;
}

static inline  void ssl_key_cert_free(mbedtls_ssl_key_cert *key_cert)
{
...
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_append_key_cert(mbedtls_ssl_key_cert **head,
...
static inline int mbedtls_ssl_conf_own_cert(mbedtls_ssl_config *conf,
...
static inline void mbedtls_ssl_conf_ca_chain(mbedtls_ssl_config *conf,
...
#if defined(MBEDTLS_X509_TRUSTED_CERTIFICATE_CALLBACK)
static inline void mbedtls_ssl_conf_ca_cb(mbedtls_ssl_config *conf,
...
#if defined(MBEDTLS_SSL_SERVER_NAME_INDICATION)
static inline const unsigned char *mbedtls_ssl_get_hs_sni(mbedtls_ssl_context *ssl,
                                            size_t *name_len)
{
...
static inline void mbedtls_ssl_set_hs_ca_chain(mbedtls_ssl_context *ssl,
                                 mbedtls_x509_crt *ca_chain,
                                 mbedtls_x509_crl *ca_crl)
{
...
static inline void mbedtls_ssl_set_hs_dn_hints(mbedtls_ssl_context *ssl,
...
static inline void mbedtls_ssl_set_hs_authmode(mbedtls_ssl_context *ssl,
                                 int authmode)
{
...
#if defined(MBEDTLS_X509_CRT_PARSE_C)
static inline void mbedtls_ssl_set_verify(mbedtls_ssl_context *ssl,
                            int (*f_vrfy)(void *, mbedtls_x509_crt *, int, uint32_t *),
                            void *p_vrfy)
{
    ssl->f_vrfy = f_vrfy;
...
static inline  psa_status_t mbedtls_ssl_set_hs_ecjpake_password_common(
...
static inline int mbedtls_ssl_set_hs_ecjpake_password(mbedtls_ssl_context *ssl,
...
static inline int mbedtls_ssl_set_hs_ecjpake_password_opaque(mbedtls_ssl_context *ssl,
                                               mbedtls_svc_key_id_t pwd)
{
    psa_status_t status;
...
static inline int mbedtls_ssl_conf_has_static_psk(mbedtls_ssl_config const *conf)
{
...
static inline  void ssl_conf_remove_psk(mbedtls_ssl_config *conf)
{
...
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_conf_set_psk_identity(mbedtls_ssl_config *conf,
                                     ...
                                     size_t psk_identity_len)
{
    ...
    conf->psk_identity = (unsigned char*)mbedtls_calloc(1, psk_identity_len);
    if (conf->psk_identity == NULL) {
        return MBEDTLS_ERR_SSL_ALLOC_FAILED;
    }
...
static inline int mbedtls_ssl_conf_psk(mbedtls_ssl_config *conf,
...
static inline  void ssl_remove_psk(mbedtls_ssl_context *ssl)
{
#if defined(MBEDTLS_USE_PSA_CRYPTO)
...
static inline int mbedtls_ssl_set_hs_psk(mbedtls_ssl_context *ssl,
                           const unsigned char *psk, size_t psk_len)
{
#if defined(MBEDTLS_USE_PSA_CRYPTO)
...
#if defined(MBEDTLS_USE_PSA_CRYPTO)
static inline int mbedtls_ssl_conf_psk_opaque(mbedtls_ssl_config *conf,
...
static inline int mbedtls_ssl_set_hs_psk_opaque(mbedtls_ssl_context *ssl,
                                  mbedtls_svc_key_id_t psk)
{
    if ((mbedtls_svc_key_id_is_null(psk)) ||
        (ssl->handshake == NULL)) {
...
#if defined(MBEDTLS_SSL_SRV_C)
static inline void mbedtls_ssl_conf_psk_cb(mbedtls_ssl_config *conf,
...
#if defined(MBEDTLS_USE_PSA_CRYPTO)
static inline  mbedtls_ssl_mode_t mbedtls_ssl_get_base_mode(
    psa_algorithm_t alg)
{
#if defined(MBEDTLS_SSL_SOME_SUITES_USE_MAC)
...
static inline  mbedtls_ssl_mode_t mbedtls_ssl_get_actual_mode(
...
static inline mbedtls_ssl_mode_t mbedtls_ssl_get_mode_from_transform(
...
static inline mbedtls_ssl_mode_t mbedtls_ssl_get_mode_from_ciphersuite(
#if defined(MBEDTLS_SSL_SOME_SUITES_USE_CBC_ETM)
    int encrypt_then_mac,
#endif /* MBEDTLS_SSL_SOME_SUITES_USE_CBC_ETM */
...
static inline psa_status_t mbedtls_ssl_cipher_to_psa(mbedtls_cipher_type_t mbedtls_cipher_type,
                                       size_t taglen,
                                       psa_algorithm_t *alg,
...
static inline int mbedtls_ssl_conf_dh_param_bin(mbedtls_ssl_config *conf,
...
static inline int mbedtls_ssl_conf_dh_param_ctx(mbedtls_ssl_config *conf, mbedtls_dhm_context *dhm_ctx)
{
    int ret = MBEDTLS_ERR_ERROR_CORRUPTION_DETECTED;
 ...
 */
static inline void mbedtls_ssl_conf_dhm_min_bitlen(mbedtls_ssl_config *conf,
                                     unsigned int bitlen)
{
 ...
 */
static inline void mbedtls_ssl_conf_sig_hashes(mbedtls_ssl_config *conf,
                                 const int *hashes)
{
...
static inline void mbedtls_ssl_conf_sig_algs(mbedtls_ssl_config *conf,
 ...
 *
 */
static inline void mbedtls_ssl_conf_curves(mbedtls_ssl_config *conf,
 ...
 */
static inline void mbedtls_ssl_conf_groups(mbedtls_ssl_config *conf,
 ...
 * `ssl->hostname == NULL`. */
static inline  const char *const ssl_hostname_skip_cn_verification = "";
 ...
 *         otherwise \c 0.
 */
static inline  int mbedtls_ssl_has_set_hostname_been_called(
    const mbedtls_ssl_context *ssl)
{
...
static
#endif
static inline const char *mbedtls_ssl_get_hostname_pointer(const mbedtls_ssl_context *ssl)
{
...
static inline  void mbedtls_ssl_free_hostname(mbedtls_ssl_context *ssl)
{
...
static inline int mbedtls_ssl_set_hostname(mbedtls_ssl_context *ssl, const char *hostname)
{
...
#if defined(MBEDTLS_SSL_SERVER_NAME_INDICATION)
static inline void mbedtls_ssl_conf_sni(mbedtls_ssl_config *conf,
...
#if defined(MBEDTLS_SSL_ALPN)
static inline int mbedtls_ssl_conf_alpn_protocols(mbedtls_ssl_config *conf, const char **protos)
{
...
static inline const char *mbedtls_ssl_get_alpn_protocol(const mbedtls_ssl_context *ssl)
{
...
#if defined(MBEDTLS_SSL_DTLS_SRTP)
static inline void mbedtls_ssl_conf_srtp_mki_value_supported(mbedtls_ssl_config *conf,
                                               int support_mki_value)
{
    conf->dtls_srtp_mki_support = support_mki_value;
}

static inline int mbedtls_ssl_dtls_srtp_set_mki_value(mbedtls_ssl_context *ssl,
...
static inline int mbedtls_ssl_conf_dtls_srtp_protection_profiles(mbedtls_ssl_config *conf,
...
static inline void mbedtls_ssl_get_dtls_srtp_negotiation_result(const mbedtls_ssl_context *ssl,
...
#if !defined(MBEDTLS_DEPRECATED_REMOVED)
static inline void mbedtls_ssl_conf_max_version(mbedtls_ssl_config *conf, int major, int minor)
{
    conf->max_tls_version = (mbedtls_ssl_protocol_version) ((major << 8) | minor);
}

static inline void mbedtls_ssl_conf_min_version(mbedtls_ssl_config *conf, int major, int minor)
{
...
#if defined(MBEDTLS_SSL_SRV_C)
static inline void mbedtls_ssl_conf_cert_req_ca_list(mbedtls_ssl_config *conf,
...
static inline void mbedtls_ssl_conf_encrypt_then_mac(mbedtls_ssl_config *conf, char etm)
{
...
static inline void mbedtls_ssl_conf_extended_master_secret(mbedtls_ssl_config *conf, char ems)
{
...
#if defined(MBEDTLS_SSL_MAX_FRAGMENT_LENGTH)
static inline int mbedtls_ssl_conf_max_frag_len(mbedtls_ssl_config *conf, unsigned char mfl_code)
{
...
static inline void mbedtls_ssl_conf_legacy_renegotiation(mbedtls_ssl_config *conf, int allow_legacy)
{
    conf->allow_legacy_renegotiation = allow_legacy;
}

#if defined(MBEDTLS_SSL_RENEGOTIATION)
static inline void mbedtls_ssl_conf_renegotiation(mbedtls_ssl_config *conf, int renegotiation)
{
    conf->disable_renegotiation = renegotiation;
}

static inline void mbedtls_ssl_conf_renegotiation_enforced(mbedtls_ssl_config *conf, int max_records)
{
    conf->renego_max_records = max_records;
}

static inline void mbedtls_ssl_conf_renegotiation_period(mbedtls_ssl_config *conf,
...
static inline void mbedtls_ssl_conf_session_tickets(mbedtls_ssl_config *conf, int use_tickets)
{
...
#if defined(MBEDTLS_SSL_PROTO_TLS1_3)
static inline void mbedtls_ssl_conf_tls13_enable_signal_new_session_tickets(
...
#if defined(MBEDTLS_SSL_PROTO_TLS1_3) && defined(MBEDTLS_SSL_SESSION_TICKETS)
static inline void mbedtls_ssl_conf_new_session_tickets(mbedtls_ssl_config *conf,
...
static inline void mbedtls_ssl_conf_session_tickets_cb(mbedtls_ssl_config *conf,
...
static inline void mbedtls_ssl_set_export_keys_cb(mbedtls_ssl_context *ssl,
...
static inline void mbedtls_ssl_conf_async_private_cb(
...
static inline void *mbedtls_ssl_conf_get_async_config_data(const mbedtls_ssl_config *conf)
{
    return conf->p_async_config_data;
}

static inline void *mbedtls_ssl_get_async_operation_data(const mbedtls_ssl_context *ssl)
{
    if (ssl->handshake == NULL) {
        return NULL;
    } else {
...
static inline void mbedtls_ssl_set_async_operation_data(mbedtls_ssl_context *ssl,
                                          void *ctx)
{
    if (ssl->handshake != NULL) {
 ...
 * SSL get accessors
 */
static inline uint32_t mbedtls_ssl_get_verify_result(const mbedtls_ssl_context *ssl)
{
    if (ssl->session != NULL) {
...
static inline int mbedtls_ssl_get_ciphersuite_id_from_ssl(const mbedtls_ssl_context *ssl)
{
...
static inline size_t mbedtls_ssl_get_output_record_size_limit(const mbedtls_ssl_context *ssl)
{
...
#if defined(MBEDTLS_SSL_MAX_FRAGMENT_LENGTH)
static inline size_t mbedtls_ssl_get_input_max_frag_len(const mbedtls_ssl_context *ssl)
{
...
static inline size_t mbedtls_ssl_get_output_max_frag_len(const mbedtls_ssl_context *ssl)
{
    size_t max_len;
...
#if defined(MBEDTLS_SSL_PROTO_DTLS)
static inline size_t mbedtls_ssl_get_current_mtu(const mbedtls_ssl_context *ssl)
{
...
static inline int mbedtls_ssl_get_max_out_record_payload(const mbedtls_ssl_context *ssl)
{
...
static inline int mbedtls_ssl_get_max_in_record_payload(const mbedtls_ssl_context *ssl)
{
    size_t max_len = MBEDTLS_SSL_IN_CONTENT_LEN;
...
#if defined(MBEDTLS_X509_CRT_PARSE_C)
static inline const mbedtls_x509_crt *mbedtls_ssl_get_peer_cert(const mbedtls_ssl_context *ssl)
{
    if (ssl == NULL || ssl->session == NULL) {
        return NULL;
    }
...
#if defined(MBEDTLS_SSL_CLI_C)
static inline int mbedtls_ssl_get_session(const mbedtls_ssl_context *ssl,
 ...
 */
static inline  size_t ssl_tls12_session_save(const mbedtls_ssl_session *session,
                                     unsigned char *buf,
                                     size_t buf_len)
{
    unsigned char *p = buf;
                                  ...
                                  size_t len)
{
    ...
    if (session->endpoint == MBEDTLS_SSL_IS_CLIENT) {
        ...
        if (session->ticket_len != 0) {
            ...
            session->ticket = (unsigned char*)mbedtls_calloc(1, session->ticket_len);
            if (session->ticket == NULL) {
                return MBEDTLS_ERR_SSL_ALLOC_FAILED;
            }
...
#if defined(MBEDTLS_SSL_SESSION_TICKETS)
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_tls13_session_save(const mbedtls_ssl_session *session,
                                  unsigned char *buf,
                                  size_t buf_len,
                                  size_t *olen)
{
...
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_tls13_session_load(mbedtls_ssl_session *session,
                                  const unsigned char *buf,
                                  size_t len)
{
    const unsigned char *p = buf;
...
static inline  int ssl_tls13_session_load(const mbedtls_ssl_session *session,
                                  const unsigned char *buf,
                                  size_t buf_len)
{
    ((void) session);
...
static inline  const unsigned char ssl_serialized_session_header[] = {
...
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_session_save(const mbedtls_ssl_session *session,
 ...
 */
static inline int mbedtls_ssl_session_save(const mbedtls_ssl_session *session,
                             unsigned char *buf,
                             size_t buf_len,
                             size_t *olen)
{
 ...
 */
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_session_load(mbedtls_ssl_session *session,
                            unsigned char omit_header,
                            const unsigned char *buf,
                            size_t len)
{
 ...
 */
static inline int mbedtls_ssl_session_load(mbedtls_ssl_session *session,
                             const unsigned char *buf,
                             size_t len)
{
 ...
 */
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_prepare_handshake_step(mbedtls_ssl_context *ssl)
{
    int ret = MBEDTLS_ERR_ERROR_CORRUPTION_DETECTED;
...
static inline int mbedtls_ssl_handshake_step(mbedtls_ssl_context *ssl)
{
    int ret = MBEDTLS_ERR_ERROR_CORRUPTION_DETECTED;
 ...
 */
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_write_hello_request(mbedtls_ssl_context *ssl)
{
    int ret = MBEDTLS_ERR_ERROR_CORRUPTION_DETECTED;
 ...
 */
static inline int mbedtls_ssl_start_renegotiation(mbedtls_ssl_context *ssl)
{
    int ret = MBEDTLS_ERR_ERROR_CORRUPTION_DETECTED;
 ...
 */
static inline int mbedtls_ssl_renegotiate(mbedtls_ssl_context *ssl)
{
...
static inline void mbedtls_ssl_handshake_free(mbedtls_ssl_context *ssl)
{
...
static inline void mbedtls_ssl_session_free(mbedtls_ssl_session *session)
{
    if (session == NULL) {
        return;
    }
...
static inline  const unsigned char ssl_serialized_context_header[] = {
    MBEDTLS_VERSION_MAJOR,
    MBEDTLS_VERSION_MINOR,
    MBEDTLS_VERSION_PATCH,
    MBEDTLS_BYTE_1(SSL_SERIALIZED_SESSION_CONFIG_BITFLAG),
 ...
 */
static inline int mbedtls_ssl_context_save(mbedtls_ssl_context *ssl,
                             unsigned char *buf,
                             size_t buf_len,
                             size_t *olen)
{
 ...
 */
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_context_load(mbedtls_ssl_context *ssl,
                            const unsigned char *buf,
                            size_t len)
{
    const unsigned char *p = buf;
 ...
 */
static inline int mbedtls_ssl_context_load(mbedtls_ssl_context *context,
                             const unsigned char *buf,
                             size_t len)
{
 ...
 * Free an SSL context
 */
static inline void mbedtls_ssl_free(mbedtls_ssl_context *ssl)
{
    if (ssl == NULL) {
        return;
    }
 ...
 */
static inline void mbedtls_ssl_config_init(mbedtls_ssl_config *conf)
{
 ...
 * about this list.
 */
static inline  const uint16_t ssl_preset_default_groups[] = {
...
static inline  const int ssl_preset_suiteb_ciphersuites[] = {
 ...
 */
static inline  const uint16_t ssl_preset_default_sig_algs[] = {
...
/* NOTICE: see above */
#if defined(MBEDTLS_SSL_PROTO_TLS1_2)
static inline  const uint16_t ssl_tls12_preset_default_sig_algs[] = {
...
/* NOTICE: see above */
static inline  const uint16_t ssl_preset_suiteb_sig_algs[] = {
...
/* NOTICE: see above */
#if defined(MBEDTLS_SSL_PROTO_TLS1_2)
static inline  const uint16_t ssl_tls12_preset_suiteb_sig_algs[] = {
...
static inline  const uint16_t ssl_preset_suiteb_groups[] = {
#if defined(MBEDTLS_ECP_HAVE_SECP256R1)
    MBEDTLS_SSL_IANA_TLS_GROUP_SECP256R1,
#endif
#if defined(MBEDTLS_ECP_HAVE_SECP384R1)
...
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_check_no_sig_alg_duplication(const uint16_t *sig_algs)
{
    size_t i, j;
    int ret = 0;
 ...
 */
static inline int mbedtls_ssl_config_defaults(mbedtls_ssl_config *conf,
 ...
 */
static inline void mbedtls_ssl_config_free(mbedtls_ssl_config *conf)
{
    if (conf == NULL) {
        return;
    }
 ...
 */
static inline unsigned char mbedtls_ssl_sig_from_pk(mbedtls_pk_context *pk)
{
#if defined(MBEDTLS_RSA_C)
...
static inline unsigned char mbedtls_ssl_sig_from_pk_alg(mbedtls_pk_type_t type)
{
    switch (type) {
        case MBEDTLS_PK_RSA:
            return MBEDTLS_SSL_SIG_RSA;
...
static inline mbedtls_pk_type_t mbedtls_ssl_pk_alg_from_sig(unsigned char sig)
{
    switch (sig) {
#if defined(MBEDTLS_RSA_C)
 ...
 */
static inline mbedtls_md_type_t mbedtls_ssl_md_alg_from_hash(unsigned char hash)
{
    switch (hash) {
 ...
 */
static inline unsigned char mbedtls_ssl_hash_from_md_alg(int md)
{
    switch (md) {
#if defined(MBEDTLS_MD_CAN_MD5)
        case MBEDTLS_MD_MD5:
 ...
 */
static inline int mbedtls_ssl_check_curve_tls_id(const mbedtls_ssl_context *ssl, uint16_t tls_id)
{
 ...
 */
static inline int mbedtls_ssl_check_curve(const mbedtls_ssl_context *ssl, mbedtls_ecp_group_id grp_id)
{
...
static inline int mbedtls_ssl_get_psa_curve_info_from_tls_id(uint16_t tls_id,
                                               psa_key_type_t *type,
                                               size_t *bits)
{
...
static inline mbedtls_ecp_group_id mbedtls_ssl_get_ecp_group_id_from_tls_id(uint16_t tls_id)
{
    for (int i = 0; tls_id_match_table[i].tls_id != 0; i++) {
        if (tls_id_match_table[i].tls_id == tls_id) {
...
static inline uint16_t mbedtls_ssl_get_tls_id_from_ecp_group_id(mbedtls_ecp_group_id grp_id)
{
...
static inline const char *mbedtls_ssl_get_curve_name_from_tls_id(uint16_t tls_id)
{
...
#if defined(MBEDTLS_USE_PSA_CRYPTO)
static inline int mbedtls_ssl_get_handshake_transcript(mbedtls_ssl_context *ssl,
...
#if defined(MBEDTLS_MD_CAN_SHA384)
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_get_handshake_transcript_sha384(mbedtls_ssl_context *ssl,
                                               unsigned char *dst,
                                               size_t dst_len,
                                               size_t *olen)
{
...
#if defined(MBEDTLS_MD_CAN_SHA256)
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_get_handshake_transcript_sha256(mbedtls_ssl_context *ssl,
                                               unsigned char *dst,
                                               size_t dst_len,
                                               size_t *olen)
{
 ...
 *
 */
static inline int mbedtls_ssl_parse_sig_alg_ext(mbedtls_ssl_context *ssl,
                                  const unsigned char *buf,
...
static inline  psa_status_t setup_psa_key_derivation(psa_key_derivation_operation_t *derivation,
...
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int tls_prf_generic(mbedtls_md_type_t md_type,
                           const unsigned char *secret, size_t slen,
                           ...
                           unsigned char *dstbuf, size_t dlen)
{
    ...
    tmp = (unsigned char*)mbedtls_calloc(1, tmp_len);
    if (tmp == NULL) {
        ret = MBEDTLS_ERR_SSL_ALLOC_FAILED;
        goto exit;
    }
 ...
 */
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_set_handshake_prfs(mbedtls_ssl_handshake_params *handshake,
 ...
 */
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_compute_master(mbedtls_ssl_handshake_params *handshake,
...
static inline int mbedtls_ssl_derive_keys(mbedtls_ssl_context *ssl)
{
    int ret = MBEDTLS_ERR_ERROR_CORRUPTION_DETECTED;
...
static inline int mbedtls_ssl_set_calc_verify_md(mbedtls_ssl_context *ssl, int md)
{
    switch (md) {
#if defined(MBEDTLS_MD_CAN_SHA384)
        case MBEDTLS_SSL_HASH_SHA384:
...
#if defined(MBEDTLS_USE_PSA_CRYPTO)
static inline  int ssl_calc_verify_tls_psa(const mbedtls_ssl_context *ssl,
...
#else
static inline  int ssl_calc_verify_tls_legacy(const mbedtls_ssl_context *ssl,
...
#if defined(MBEDTLS_MD_CAN_SHA256)
static inline int ssl_calc_verify_tls_sha256(const mbedtls_ssl_context *ssl,
                               unsigned char *hash,
                               size_t *hlen)
{
#if defined(MBEDTLS_USE_PSA_CRYPTO)
...
#if defined(MBEDTLS_MD_CAN_SHA384)
static inline int ssl_calc_verify_tls_sha384(const mbedtls_ssl_context *ssl,
                               unsigned char *hash,
                               size_t *hlen)
{
#if defined(MBEDTLS_USE_PSA_CRYPTO)
...
#if !defined(MBEDTLS_USE_PSA_CRYPTO) &&                      \
    defined(MBEDTLS_KEY_EXCHANGE_SOME_PSK_ENABLED)
static inline int mbedtls_ssl_psk_derive_premaster(mbedtls_ssl_context *ssl, mbedtls_key_exchange_type_t key_ex)
{
...
#if defined(MBEDTLS_SSL_PROTO_DTLS)
static inline int mbedtls_ssl_resend_hello_request(mbedtls_ssl_context *ssl)
{
...
static inline int mbedtls_ssl_write_certificate(mbedtls_ssl_context *ssl)
{
    const mbedtls_ssl_ciphersuite_t *ciphersuite_info =
        ssl->handshake->ciphersuite_info;
...
static inline int mbedtls_ssl_parse_certificate(mbedtls_ssl_context *ssl)
{
    const mbedtls_ssl_ciphersuite_t *ciphersuite_info =
        ssl->handshake->ciphersuite_info;
...
#if defined(MBEDTLS_SSL_KEEP_PEER_CERTIFICATE)
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_check_peer_crt_unchanged(mbedtls_ssl_context *ssl,
 ...
 */
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_parse_certificate_chain(mbedtls_ssl_context *ssl,
...
#if defined(MBEDTLS_SSL_SRV_C)
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_srv_check_client_no_crt_notification(mbedtls_ssl_context *ssl)
{
    if (ssl->conf->endpoint == MBEDTLS_SSL_IS_CLIENT) {
        return -1;
    }
...
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_parse_certificate_coordinate(mbedtls_ssl_context *ssl,
                                            int authmode)
{
    const mbedtls_ssl_ciphersuite_t *ciphersuite_info =
        ssl->handshake->ciphersuite_info;
...
#if !defined(MBEDTLS_SSL_KEEP_PEER_CERTIFICATE)
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_remember_peer_crt_digest(mbedtls_ssl_context *ssl,
...
MBEDTLS_CHECK_RETURN_CRITICAL
static inline  int ssl_remember_peer_pubkey(mbedtls_ssl_context *ssl,
                                    unsigned char *start, size_t len)
{
...
static inline int mbedtls_ssl_parse_certificate(mbedtls_ssl_context *ssl)
{
    ...
    chain = (mbedtls_x509_crt*)mbedtls_calloc(1, sizeof(mbedtls_x509_crt));
    if (chain == NULL) {
...
static inline  int ssl_calc_finished_tls_generic(mbedtls_ssl_context *ssl, void *ctx,
...
#else
    int ret = MBEDTLS_ERR_ERROR_CORRUPTION_DETECTED;
    mbedtls_md_context_t *hs_ctx = (mbedtls_md_context_t*)ctx;
    mbedtls_md_context_t cloned_ctx;
    mbedtls_md_init(&cloned_ctx);
#endif
...
#if defined(MBEDTLS_MD_CAN_SHA256)
static inline  int ssl_calc_finished_tls_sha256(
...
#if defined(MBEDTLS_MD_CAN_SHA384)
static inline  int ssl_calc_finished_tls_sha384(
    mbedtls_ssl_context *ssl, unsigned char *buf, int from)
{
...
static inline void mbedtls_ssl_handshake_wrapup_free_hs_transform(mbedtls_ssl_context *ssl)
{
...
static inline void mbedtls_ssl_handshake_wrapup(mbedtls_ssl_context *ssl)
{
...
static inline int mbedtls_ssl_write_finished(mbedtls_ssl_context *ssl)
{
    int ret;
...
static inline int mbedtls_ssl_parse_finished(mbedtls_ssl_context *ssl)
{
    int ret = MBEDTLS_ERR_ERROR_CORRUPTION_DETECTED;
...
static inline  mbedtls_tls_prf_types tls_prf_get_type(mbedtls_ssl_tls_prf_cb *tls_prf)
{
    ((void) tls_prf);
#if defined(MBEDTLS_MD_CAN_SHA384)
...
#if defined(MBEDTLS_KEY_EXCHANGE_ECJPAKE_ENABLED) && \
    defined(MBEDTLS_USE_PSA_CRYPTO)
static inline int mbedtls_psa_ecjpake_read_round(
...
static inline int mbedtls_psa_ecjpake_write_round(
    psa_pake_operation_t *pake_ctx,
    unsigned char *buf,
...
#if defined(MBEDTLS_USE_PSA_CRYPTO)
static inline int mbedtls_ssl_get_key_exchange_md_tls1_2(mbedtls_ssl_context *ssl,
...
static inline unsigned int mbedtls_ssl_tls12_get_preferred_hash_for_sig_alg(
    mbedtls_ssl_context *ssl,
...
static inline int mbedtls_ssl_validate_ciphersuite(
    const mbedtls_ssl_context *ssl,
 ...
 *
 */
static inline int mbedtls_ssl_write_sig_alg_ext(mbedtls_ssl_context *ssl, unsigned char *buf,
 ...
 */
MBEDTLS_CHECK_RETURN_CRITICAL
static inline int mbedtls_ssl_parse_server_name_ext(mbedtls_ssl_context *ssl,
                                      const unsigned char *buf,
                                      const unsigned char *end)
{
    int ret = MBEDTLS_ERR_ERROR_CORRUPTION_DETECTED;
...
#if defined(MBEDTLS_SSL_ALPN)
MBEDTLS_CHECK_RETURN_CRITICAL
static inline int mbedtls_ssl_parse_alpn_ext(mbedtls_ssl_context *ssl,
                               const unsigned char *buf,
                               const unsigned char *end)
{
    const unsigned char *p = buf;
...
static inline int mbedtls_ssl_write_alpn_ext(mbedtls_ssl_context *ssl,
                               unsigned char *buf,
                               unsigned char *end,
                               size_t *out_len)
{
...
static inline int mbedtls_ssl_session_set_hostname(mbedtls_ssl_session *session,
                                     const char *hostname)
{
    /* Initialize to suppress unnecessary compiler warning */
    size_t hostname_len = 0;
    ...
    if (hostname == NULL) {
        ...
        session->hostname = (char*)mbedtls_calloc(1, hostname_len + 1);
        if (session->hostname == NULL) {
            return MBEDTLS_ERR_SSL_ALLOC_FAILED;
        }
...
static inline int mbedtls_ssl_session_set_ticket_alpn(mbedtls_ssl_session *session,
                                        const char *alpn)
{
    size_t alpn_len = 0;
 ...
 */
#if defined(MBEDTLS_SSL_HANDSHAKE_WITH_CERT_ENABLED)
static inline int mbedtls_ssl_check_cert_usage(const mbedtls_x509_crt *cert,
...
static inline  int get_hostname_for_verification(mbedtls_ssl_context *ssl,
                                         const char **hostname)
{
...
static inline int mbedtls_ssl_verify_certificate(mbedtls_ssl_context *ssl,
                                   int authmode,
                                   mbedtls_x509_crt *chain,
                                   const mbedtls_ssl_ciphersuite_t *ciphersuite_info,
                                   void *rs_ctx)
