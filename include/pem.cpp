...
static inline void mbedtls_pem_init(mbedtls_pem_context *ctx)
{
 ...
 */
static inline  int pem_get_iv(const unsigned char *s, unsigned char *iv,
                      size_t iv_len)
{
    size_t i, j, k;
...
static inline  int pem_pbkdf1(unsigned char *key, size_t keylen,
                      unsigned char *iv,
 ...
 */
static inline  int pem_des_decrypt(unsigned char des_iv[8],
 ...
 */
static inline  int pem_des3_decrypt(unsigned char des3_iv[8],
                            unsigned char *buf, size_t buflen,
                            const unsigned char *pwd, size_t pwdlen)
{
 ...
 */
static inline  int pem_aes_decrypt(unsigned char aes_iv[16], unsigned int keylen,
                           unsigned char *buf, size_t buflen,
                           const unsigned char *pwd, size_t pwdlen)
{
...
static inline  int pem_check_pkcs_padding(unsigned char *input, size_t input_len, size_t *data_len)
{
...
static inline int mbedtls_pem_read_buffer(mbedtls_pem_context *ctx, const char *header, const char *footer,
...
static inline void mbedtls_pem_free(mbedtls_pem_context *ctx)
{
    if (ctx == NULL) {
        return;
    }
...
static inline int mbedtls_pem_write_buffer(const char *header, const char *footer,
