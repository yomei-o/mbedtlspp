...
static inline signed char mbedtls_aesce_has_support_result = -1;

#if !defined(MBEDTLS_AES_USE_HARDWARE_ONLY)
/*
 * AES instruction support detection routine
 */
static inline int mbedtls_aesce_has_support_impl(void)
{
...
static inline  uint8x16_t aesce_encrypt_block(uint8x16_t block,
                                      unsigned char *keys,
                                      int rounds)
{
...
static inline  uint8x16_t aesce_decrypt_block(uint8x16_t block,
                                      unsigned char *keys,
                                      int rounds)
{
    /* 10, 12 or 14 rounds. Unroll loop. */
 ...
 */
static inline int mbedtls_aesce_crypt_ecb(mbedtls_aes_context *ctx,
                            int mode,
 ...
 */
#if !defined(MBEDTLS_BLOCK_CIPHER_NO_DECRYPT)
static inline void mbedtls_aesce_inverse_key(unsigned char *invkey,
 ...
 */
static inline  void aesce_setkey_enc(unsigned char *rk,
 ...
 */
static inline int mbedtls_aesce_setkey_enc(unsigned char *rk,
                             const unsigned char *key,
                             size_t bits)
{
    switch (bits) {
 ...
 */
static inline void mbedtls_aesce_gcm_mult(unsigned char c[16],
