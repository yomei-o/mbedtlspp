...
static inline  unsigned long add_count, dbl_count;
#endif /* MBEDTLS_ECP_C */
static inline  unsigned long mul_count;
#endif
 ...
 */
static inline  unsigned ecp_max_ops = 0;

/*
 * Set ecp_max_ops
 */
static inline void mbedtls_ecp_set_max_ops(unsigned max_ops)
{
    ecp_max_ops = max_ops;
}
 ...
 */
static inline int mbedtls_ecp_restart_is_enabled(void)
{
 ...
 */
static inline  void ecp_restart_rsm_init(mbedtls_ecp_restart_mul_ctx *ctx)
{
 ...
 */
static inline  void ecp_restart_rsm_free(mbedtls_ecp_restart_mul_ctx *ctx)
{
    unsigned char i;
 ...
 */
static inline  void ecp_restart_ma_init(mbedtls_ecp_restart_muladd_ctx *ctx)
{
 ...
 */
static inline  void ecp_restart_ma_free(mbedtls_ecp_restart_muladd_ctx *ctx)
{
    if (ctx == NULL) {
        return;
    }
 ...
 */
static inline void mbedtls_ecp_restart_init(mbedtls_ecp_restart_ctx *ctx)
{
    ctx->ops_done = 0;
    ctx->depth = 0;
    ctx->rsm = NULL;
 ...
 */
static inline void mbedtls_ecp_restart_free(mbedtls_ecp_restart_ctx *ctx)
{
    if (ctx == NULL) {
        return;
    }
 ...
 */
static inline int mbedtls_ecp_check_budget(const mbedtls_ecp_group *grp,
...
#if defined(MBEDTLS_ECP_C)
static inline  void mpi_init_many(mbedtls_mpi *arr, size_t size)
{
    while (size--) {
...
static inline  void mpi_free_many(mbedtls_mpi *arr, size_t size)
{
    while (size--) {
 ...
 */
static inline  const mbedtls_ecp_curve_info ecp_supported_curves[] =
{
...
static inline  mbedtls_ecp_group_id ecp_supported_grp_id[ECP_NB_CURVES];
 ...
 */
static inline const mbedtls_ecp_group_id *mbedtls_ecp_grp_id_list(void)
{
 ...
 */
static inline const mbedtls_ecp_curve_info *mbedtls_ecp_curve_info_from_grp_id(mbedtls_ecp_group_id grp_id)
{
    const mbedtls_ecp_curve_info *curve_info;
 ...
 */
static inline const mbedtls_ecp_curve_info *mbedtls_ecp_curve_info_from_tls_id(uint16_t tls_id)
{
    const mbedtls_ecp_curve_info *curve_info;
 ...
 */
static inline const mbedtls_ecp_curve_info *mbedtls_ecp_curve_info_from_name(const char *name)
{
    const mbedtls_ecp_curve_info *curve_info;
 ...
 */
static inline mbedtls_ecp_curve_type mbedtls_ecp_get_type(const mbedtls_ecp_group *grp)
{
    if (grp->G.X.p == NULL) {
 ...
 */
static inline void mbedtls_ecp_point_init(mbedtls_ecp_point *pt)
{
 ...
 */
static inline void mbedtls_ecp_group_init(mbedtls_ecp_group *grp)
{
 ...
 */
static inline void mbedtls_ecp_keypair_init(mbedtls_ecp_keypair *key)
{
 ...
 */
static inline void mbedtls_ecp_point_free(mbedtls_ecp_point *pt)
{
    if (pt == NULL) {
        return;
    }
 ...
 */
static inline  int ecp_group_is_static_comb_table(const mbedtls_ecp_group *grp)
{
 ...
 */
static inline void mbedtls_ecp_group_free(mbedtls_ecp_group *grp)
{
    size_t i;
 ...
 */
static inline void mbedtls_ecp_keypair_free(mbedtls_ecp_keypair *key)
{
    if (key == NULL) {
        return;
    }
 ...
 */
static inline int mbedtls_ecp_copy(mbedtls_ecp_point *P, const mbedtls_ecp_point *Q)
{
 ...
 */
static inline int mbedtls_ecp_group_copy(mbedtls_ecp_group *dst, const mbedtls_ecp_group *src)
{
 ...
 * Set point to zero
 */
static inline int mbedtls_ecp_set_zero(mbedtls_ecp_point *pt)
{
    int ret = MBEDTLS_ERR_ERROR_CORRUPTION_DETECTED;
 ...
 */
static inline int mbedtls_ecp_is_zero(mbedtls_ecp_point *pt)
{
 ...
 */
static inline int mbedtls_ecp_point_cmp(const mbedtls_ecp_point *P,
 ...
 */
static inline int mbedtls_ecp_point_read_string(mbedtls_ecp_point *P, int radix,
 ...
 */
static inline int mbedtls_ecp_point_write_binary(const mbedtls_ecp_group *grp,
...
#if defined(MBEDTLS_ECP_SHORT_WEIERSTRASS_ENABLED)
static inline  int mbedtls_ecp_sw_derive_y(const mbedtls_ecp_group *grp,
                                   const mbedtls_mpi *X,
                                   mbedtls_mpi *Y,
                                   int parity_bit);
 ...
 */
static inline int mbedtls_ecp_point_read_binary(const mbedtls_ecp_group *grp,
 ...
 *      } ECPoint;
 */
static inline int mbedtls_ecp_tls_read_point(const mbedtls_ecp_group *grp,
                               mbedtls_ecp_point *pt,
 ...
 *      } ECPoint;
 */
static inline int mbedtls_ecp_tls_write_point(const mbedtls_ecp_group *grp, const mbedtls_ecp_point *pt,
                                int format, size_t *olen,
 ...
 */
static inline int mbedtls_ecp_tls_read_group(mbedtls_ecp_group *grp,
 ...
 */
static inline int mbedtls_ecp_tls_read_group_id(mbedtls_ecp_group_id *grp,
                                  const unsigned char **buf, size_t len)
{
    uint16_t tls_id;
    const mbedtls_ecp_curve_info *curve_info;
 ...
 */
static inline int mbedtls_ecp_tls_write_group(const mbedtls_ecp_group *grp, size_t *olen,
                                unsigned char *buf, size_t blen)
{
    const mbedtls_ecp_curve_info *curve_info;
 ...
 */
static inline  int ecp_modp(mbedtls_mpi *N, const mbedtls_ecp_group *grp)
{
    int ret = MBEDTLS_ERR_ERROR_CORRUPTION_DETECTED;
    ...
    mbedtls_mpi_uint c;
    c = mbedtls_mpi_core_sub(N->p, N->p, grp->P.p, grp->P.n);
 ...
 * RHS = X^3 + A X + B
 */
static inline  int ecp_sw_rhs(const mbedtls_ecp_group *grp,
                      mbedtls_mpi *rhs,
                      const mbedtls_mpi *X)
{
    int ret;
 ...
 * Cost: 1N := 1I + 3M + 1S
 */
static inline  int ecp_normalize_jac(const mbedtls_ecp_group *grp, mbedtls_ecp_point *pt)
{
 ...
 */
static inline  int ecp_normalize_jac_many(const mbedtls_ecp_group *grp,
 ...
 */
static inline  int ecp_safe_invert_jac(const mbedtls_ecp_group *grp,
                               mbedtls_ecp_point *Q,
                               unsigned char inv)
{
    int ret = MBEDTLS_ERR_ERROR_CORRUPTION_DETECTED;
 ...
 *             3M + 6S + 1a     otherwise
 */
static inline  int ecp_double_jac(const mbedtls_ecp_group *grp, mbedtls_ecp_point *R,
                          const mbedtls_ecp_point *P,
                          mbedtls_mpi tmp[4])
{
#if defined(MBEDTLS_SELF_TEST)
 ...
 * Cost: 1A := 8M + 3S
 */
static inline  int ecp_add_mixed(const mbedtls_ecp_group *grp, mbedtls_ecp_point *R,
 ...
 */
static inline  int ecp_randomize_jac(const mbedtls_ecp_group *grp, mbedtls_ecp_point *pt,
 ...
 */
static inline  void ecp_comb_recode_core(unsigned char x[], size_t d,
 ...
 */
static inline  int ecp_precompute_comb(const mbedtls_ecp_group *grp,
 ...
 */
static inline  int ecp_select_comb(const mbedtls_ecp_group *grp, mbedtls_ecp_point *R,
 ...
 * Cost: d A + d D + 1 R
 */
static inline  int ecp_mul_comb_core(const mbedtls_ecp_group *grp, mbedtls_ecp_point *R,
                             const mbedtls_ecp_point T[], unsigned char T_size,
 ...
 * See ecp_comb_recode_core() for background.
 */
static inline  int ecp_comb_recode_scalar(const mbedtls_ecp_group *grp,
                                  const mbedtls_mpi *m,
 ...
 */
static inline  int ecp_mul_comb_after_precomp(const mbedtls_ecp_group *grp,
                                      mbedtls_ecp_point *R,
                                      const mbedtls_mpi *m,
 ...
 */
static inline  unsigned char ecp_pick_window_size(const mbedtls_ecp_group *grp,
 ...
 */
static inline  int ecp_mul_comb(mbedtls_ecp_group *grp, mbedtls_ecp_point *R,
 ...
 * Cost: 1M + 1I
 */
static inline  int ecp_normalize_mxz(const mbedtls_ecp_group *grp, mbedtls_ecp_point *P)
{
 ...
 * Cost: 2M
 */
static inline  int ecp_randomize_mxz(const mbedtls_ecp_group *grp, mbedtls_ecp_point *P,
                             int (*f_rng)(void *, unsigned char *, size_t), void *p_rng)
{
 ...
 * Cost: 5M + 4S
 */
static inline  int ecp_double_add_mxz(const mbedtls_ecp_group *grp,
 ...
 */
static inline  int ecp_mul_mxz(mbedtls_ecp_group *grp, mbedtls_ecp_point *R,
                       const mbedtls_mpi *m, const mbedtls_ecp_point *P,
                       int (*f_rng)(void *, unsigned char *, size_t),
                       void *p_rng)
{
 ...
 */
static inline  int ecp_mul_restartable_internal(mbedtls_ecp_group *grp, mbedtls_ecp_point *R,
                                        const mbedtls_mpi *m, const mbedtls_ecp_point *P,
                                        int (*f_rng)(void *, unsigned char *, size_t), void *p_rng,
                                        mbedtls_ecp_restart_ctx *rs_ctx)
{
 ...
 * Restartable multiplication R = m * P
 */
static inline int mbedtls_ecp_mul_restartable(mbedtls_ecp_group *grp, mbedtls_ecp_point *R,
                                const mbedtls_mpi *m, const mbedtls_ecp_point *P,
                                int (*f_rng)(void *, unsigned char *, size_t), void *p_rng,
                                mbedtls_ecp_restart_ctx *rs_ctx)
{
 ...
 */
static inline  int ecp_check_pubkey_sw(const mbedtls_ecp_group *grp, const mbedtls_ecp_point *pt)
{
    int ret = MBEDTLS_ERR_ERROR_CORRUPTION_DETECTED;
    mbedtls_mpi YY, RHS;
 ...
 */
static inline  int mbedtls_ecp_mul_shortcuts(mbedtls_ecp_group *grp,
                                     mbedtls_ecp_point *R,
                                     const mbedtls_mpi *m,
                                     const mbedtls_ecp_point *P,
                                     mbedtls_ecp_restart_ctx *rs_ctx)
 ...
 * NOT constant-time
 */
static inline int mbedtls_ecp_muladd_restartable(
 ...
 * NOT constant-time
 */
static inline int mbedtls_ecp_muladd(mbedtls_ecp_group *grp, mbedtls_ecp_point *R,
                       const mbedtls_mpi *m, const mbedtls_ecp_point *P,
                       const mbedtls_mpi *n, const mbedtls_ecp_point *Q)
{
 ...
 */
static inline  const mbedtls_mpi_uint x25519_bad_point_1[] = {
    MBEDTLS_BYTES_TO_T_UINT_8(0xe0, 0xeb, 0x7a, 0x7c, 0x3b, 0x41, 0xb8, 0xae),
    MBEDTLS_BYTES_TO_T_UINT_8(0x16, 0x56, 0xe3, 0xfa, 0xf1, 0x9f, 0xc4, 0x6a),
    MBEDTLS_BYTES_TO_T_UINT_8(0xda, 0x09, 0x8d, 0xeb, 0x9c, 0x32, 0xb1, 0xfd),
    MBEDTLS_BYTES_TO_T_UINT_8(0x86, 0x62, 0x05, 0x16, 0x5f, 0x49, 0xb8, 0x00),
};
static inline  const mbedtls_mpi_uint x25519_bad_point_2[] = {
    MBEDTLS_BYTES_TO_T_UINT_8(0x5f, 0x9c, 0x95, 0xbc, 0xa3, 0x50, 0x8c, 0x24),
    MBEDTLS_BYTES_TO_T_UINT_8(0xb1, 0xd0, 0xb1, 0x55, 0x9c, 0x83, 0xef, 0x5b),
    MBEDTLS_BYTES_TO_T_UINT_8(0x04, 0x44, 0x5c, 0xc4, 0x58, 0x1c, 0x8e, 0x86),
    MBEDTLS_BYTES_TO_T_UINT_8(0xd8, 0x22, 0x4e, 0xdd, 0xd0, 0x9f, 0x11, 0x57),
};
static inline  const mbedtls_mpi ecp_x25519_bad_point_1 = ECP_MPI_INIT_ARRAY(
    x25519_bad_point_1);
static inline  const mbedtls_mpi ecp_x25519_bad_point_2 = ECP_MPI_INIT_ARRAY(
    x25519_bad_point_2);
 ...
 */
static inline  int ecp_check_bad_points_mx(const mbedtls_mpi *X, const mbedtls_mpi *P,
 ...
 */
static inline  int ecp_check_pubkey_mx(const mbedtls_ecp_group *grp, const mbedtls_ecp_point *pt)
{
 ...
 */
static inline int mbedtls_ecp_check_pubkey(const mbedtls_ecp_group *grp,
 ...
 */
static inline int mbedtls_ecp_check_privkey(const mbedtls_ecp_group *grp,
                              const mbedtls_mpi *d)
{
#if defined(MBEDTLS_ECP_MONTGOMERY_ENABLED)
    if (mbedtls_ecp_get_type(grp) == MBEDTLS_ECP_TYPE_MONTGOMERY) {
...
static inline int mbedtls_ecp_gen_privkey_mx(size_t high_bit,
                               mbedtls_mpi *d,
                               int (*f_rng)(void *, unsigned char *, size_t),
                               void *p_rng)
{
...
#if defined(MBEDTLS_ECP_SHORT_WEIERSTRASS_ENABLED)
static inline  int mbedtls_ecp_gen_privkey_sw(
 ...
 */
static inline int mbedtls_ecp_gen_privkey(const mbedtls_ecp_group *grp,
                            mbedtls_mpi *d,
                            int (*f_rng)(void *, unsigned char *, size_t),
                            void *p_rng)
{
 ...
 */
static inline int mbedtls_ecp_gen_keypair_base(mbedtls_ecp_group *grp,
 ...
 */
static inline int mbedtls_ecp_gen_keypair(mbedtls_ecp_group *grp,
                            mbedtls_mpi *d, mbedtls_ecp_point *Q,
                            int (*f_rng)(void *, unsigned char *, size_t),
                            void *p_rng)
{
 ...
 */
static inline int mbedtls_ecp_gen_key(mbedtls_ecp_group_id grp_id, mbedtls_ecp_keypair *key,
                        int (*f_rng)(void *, unsigned char *, size_t), void *p_rng)
{
    int ret = MBEDTLS_ERR_ERROR_CORRUPTION_DETECTED;
...
static inline int mbedtls_ecp_set_public_key(mbedtls_ecp_group_id grp_id,
 ...
 * Read a private key.
 */
static inline int mbedtls_ecp_read_key(mbedtls_ecp_group_id grp_id, mbedtls_ecp_keypair *key,
...
static inline int mbedtls_ecp_write_key(mbedtls_ecp_keypair *key,
                          unsigned char *buf, size_t buflen)
{
    int ret = MBEDTLS_ERR_ERROR_CORRUPTION_DETECTED;
...
static inline int mbedtls_ecp_write_key_ext(const mbedtls_ecp_keypair *key,
 ...
 * Write a public key.
 */
static inline int mbedtls_ecp_write_public_key(const mbedtls_ecp_keypair *key,
                                 int format, size_t *olen,
                                 unsigned char *buf, size_t buflen)
{
 ...
 */
static inline int mbedtls_ecp_check_pub_priv(
...
static inline int mbedtls_ecp_keypair_calc_public(mbedtls_ecp_keypair *key,
                                    int (*f_rng)(void *, unsigned char *, size_t),
                                    void *p_rng)
{
...
static inline mbedtls_ecp_group_id mbedtls_ecp_keypair_get_group_id(
 ...
 */
static inline int mbedtls_ecp_export(const mbedtls_ecp_keypair *key, mbedtls_ecp_group *grp,
                       mbedtls_mpi *d, mbedtls_ecp_point *Q)
{
    int ret = MBEDTLS_ERR_ERROR_CORRUPTION_DETECTED;
 ...
 */
static inline  int self_test_rng_2(void *ctx, unsigned char *out, size_t len)
{
...
static inline  int self_test_adjust_exponent(const mbedtls_ecp_group *grp,
                                     mbedtls_mpi *m)
{
    int ret = 0;
    switch (grp->id) {
...
static inline  int self_test_point(int verbose,
                           mbedtls_ecp_group *grp,
                           mbedtls_ecp_point *R,
                           mbedtls_mpi *m,
                           const mbedtls_ecp_point *P,
                           ...
                           size_t n_exponents)
{
    ...
    MBEDTLS_MPI_CHK(mbedtls_ecp_mul(grp, R, m, P, self_test_rng_2, NULL));
 ...
 * Checkup routine
 */
static inline int mbedtls_ecp_self_test(int verbose)
{
#if defined(MBEDTLS_ECP_C)
    int ret = MBEDTLS_ERR_ERROR_CORRUPTION_DETECTED;
    mbedtls_ecp_group grp;
    ...
    MBEDTLS_MPI_CHK(mbedtls_ecp_mul(&grp, &P, &m, &grp.G, self_test_rng_2, NULL));
