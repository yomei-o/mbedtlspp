...
static inline  int local_err_translation2(psa_status_t status)
{
...
#define PSA_TO_MBEDTLS_ERR(status) local_err_translation2(status)
 ...
 */
static inline  int create_merkle_leaf_value(const mbedtls_lms_parameters_t *params,
 ...
 *  out                 The output node value, which is a hash output.
 */
static inline  int create_merkle_internal_value(const mbedtls_lms_parameters_t *params,
...
static inline void mbedtls_lms_public_init(mbedtls_lms_public_t *ctx)
{
    memset(ctx, 0, sizeof(*ctx));
}

static inline void mbedtls_lms_public_free(mbedtls_lms_public_t *ctx)
{
    if (ctx == NULL) {
        return;
    }
...
static inline int mbedtls_lms_import_public_key(mbedtls_lms_public_t *ctx,
...
static inline int mbedtls_lms_export_public_key(const mbedtls_lms_public_t *ctx,
                                  unsigned char *key,
...
static inline int mbedtls_lms_verify(const mbedtls_lms_public_t *ctx,
 ...
 */
static inline  int calculate_merkle_tree(const mbedtls_lms_private_t *ctx,
                                 unsigned char *tree)
{
 ...
 */
static inline  int get_merkle_path(mbedtls_lms_private_t *ctx,
...
static inline void mbedtls_lms_private_init(mbedtls_lms_private_t *ctx)
{
    memset(ctx, 0, sizeof(*ctx));
}

static inline void mbedtls_lms_private_free(mbedtls_lms_private_t *ctx)
{
    if (ctx == NULL) {
        return;
    }
...
static inline int mbedtls_lms_calculate_public_key(mbedtls_lms_public_t *ctx,
...
static inline int mbedtls_lms_sign(mbedtls_lms_private_t *ctx,
                     int (*f_rng)(void *, unsigned char *, size_t),
