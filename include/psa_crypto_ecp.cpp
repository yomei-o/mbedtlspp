...
#include "tf-psa-crypto_private_everest_x25519.hpp"
#endif
 ...
 */
static inline  int check_ecc_parameters(psa_ecc_family_t family, size_t *bits)
{
    switch (family) {
...
static inline psa_status_t mbedtls_psa_ecp_load_representation(
...
static inline psa_status_t mbedtls_psa_ecp_import_key(
...
static inline psa_status_t mbedtls_psa_ecp_export_key(psa_key_type_t type,
...
static inline psa_status_t mbedtls_psa_ecp_export_public_key(
    const psa_key_attributes_t *attributes,
...
static inline psa_status_t mbedtls_psa_ecp_generate_key(
    const psa_key_attributes_t *attributes,
...
/****************************************************************/
    ...
    defined(MBEDTLS_PSA_BUILTIN_ALG_DETERMINISTIC_ECDSA)
static inline psa_status_t mbedtls_psa_ecdsa_sign_hash(
    const psa_key_attributes_t *attributes,
    const uint8_t *key_buffer, size_t key_buffer_size,
...
static inline psa_status_t mbedtls_psa_ecp_load_public_part(mbedtls_ecp_keypair *ecp)
{
    int ret = 0;
...
static inline psa_status_t mbedtls_psa_ecdsa_verify_hash(
    const psa_key_attributes_t *attributes,
    const uint8_t *key_buffer, size_t key_buffer_size,
    psa_algorithm_t alg, const uint8_t *hash, size_t hash_length,
...
static inline  psa_status_t ecdh_write_secret(const mbedtls_ecp_group *grp,
...
#if defined(MBEDTLS_ECDH_VARIANT_EVEREST_ENABLED)
static inline  psa_status_t ecdh_everest_shared_secret(
    const uint8_t *key_buffer, size_t key_buffer_size,
...
static inline psa_status_t mbedtls_psa_key_agreement_ecdh(
    const psa_key_attributes_t *attributes,
    const uint8_t *key_buffer, size_t key_buffer_size,
...
static inline uint32_t mbedtls_psa_generate_key_iop_get_num_ops(
    mbedtls_psa_generate_key_iop_t *operation)
{
    return operation->num_ops;
}

static inline psa_status_t mbedtls_psa_ecp_generate_key_iop_setup(
    mbedtls_psa_generate_key_iop_t *operation,
    const psa_key_attributes_t *attributes)
{
...
static inline psa_status_t mbedtls_psa_ecp_generate_key_iop_complete(
    mbedtls_psa_generate_key_iop_t *operation,
    uint8_t *key_output,
...
static inline psa_status_t mbedtls_psa_ecp_generate_key_iop_abort(
    mbedtls_psa_generate_key_iop_t *operation)
{
...
static inline uint32_t mbedtls_psa_ecp_export_public_key_iop_get_num_ops(
    mbedtls_psa_export_public_key_iop_t *operation)
{
    return operation->num_ops;
}

static inline psa_status_t mbedtls_psa_ecp_export_public_key_iop_setup(
    mbedtls_psa_export_public_key_iop_t *operation,
    uint8_t *key,
    size_t key_len,
...
static inline psa_status_t mbedtls_psa_ecp_export_public_key_iop_complete(
    mbedtls_psa_export_public_key_iop_t *operation,
    uint8_t *pub_key,
    size_t pub_key_size,
    size_t *pub_key_len)
...
static inline psa_status_t mbedtls_psa_ecp_export_public_key_iop_abort(
    mbedtls_psa_export_public_key_iop_t *operation)
{
