 ...
 */
static inline psa_status_t psa_generate_key_internal(const psa_key_attributes_t *attributes,
                                       const psa_custom_key_parameters_t *custom,
 ...
 */
static inline psa_status_t psa_key_agreement_raw_builtin(
    const psa_key_attributes_t *attributes,
 ...
 */
static inline uint32_t mbedtls_psa_key_agreement_iop_get_num_ops(
 ...
 */
static inline psa_status_t mbedtls_psa_key_agreement_iop_setup(
    mbedtls_psa_key_agreement_interruptible_operation_t *operation,
 ...
 *         \p shared_secret_size is too small
 */
static inline psa_status_t mbedtls_psa_key_agreement_iop_complete(
    mbedtls_psa_key_agreement_interruptible_operation_t *operation,
    uint8_t *shared_secret,
    size_t shared_secret_size,
    size_t *shared_secret_length);
 ...
 */
static inline psa_status_t mbedtls_psa_key_agreement_iop_abort(
    mbedtls_psa_key_agreement_interruptible_operation_t *operation);
 ...
 */
static inline uint32_t mbedtls_psa_interruptible_get_max_ops(void);
