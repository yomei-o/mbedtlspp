 ...
 * Initialize context
 */
static inline void mbedtls_ccm_init(mbedtls_ccm_context *ctx)
{
 ...
 * Free context
 */
static inline void mbedtls_ccm_free(mbedtls_ccm_context *ctx)
{
    if (ctx == NULL) {
        return;
    }
 ...
 */
static inline  int mbedtls_ccm_crypt(mbedtls_ccm_context *ctx,
...
static inline  void mbedtls_ccm_clear_state(mbedtls_ccm_context *ctx)
{
...
static inline  int ccm_calculate_first_block_if_ready(mbedtls_ccm_context *ctx)
{
    int ret = MBEDTLS_ERR_ERROR_CORRUPTION_DETECTED;
    unsigned char i;
    size_t len_left;
...
static inline int mbedtls_ccm_starts(mbedtls_ccm_context *ctx,
                       int mode,
...
static inline int mbedtls_ccm_set_lengths(mbedtls_ccm_context *ctx,
                            size_t total_ad_len,
...
static inline int mbedtls_ccm_update_ad(mbedtls_ccm_context *ctx,
...
static inline int mbedtls_ccm_update(mbedtls_ccm_context *ctx,
...
static inline int mbedtls_ccm_finish(mbedtls_ccm_context *ctx,
 ...
 */
static inline  int ccm_auth_crypt(mbedtls_ccm_context *ctx, int mode, size_t length,
 ...
 */
static inline int mbedtls_ccm_star_encrypt_and_tag(mbedtls_ccm_context *ctx, size_t length,
                                     const unsigned char *iv, size_t iv_len,
                                     const unsigned char *add, size_t add_len,
                                     const unsigned char *input, unsigned char *output,
                                     unsigned char *tag, size_t tag_len)
...
static inline int mbedtls_ccm_encrypt_and_tag(mbedtls_ccm_context *ctx, size_t length,
                                const unsigned char *iv, size_t iv_len,
                                const unsigned char *add, size_t add_len,
                                const unsigned char *input, unsigned char *output,
                                unsigned char *tag, size_t tag_len)
 ...
 */
static inline  int mbedtls_ccm_compare_tags(const unsigned char *tag1,
...
static inline  int ccm_auth_decrypt(mbedtls_ccm_context *ctx, int mode, size_t length,
                            const unsigned char *iv, size_t iv_len,
                            const unsigned char *add, size_t add_len,
                            const unsigned char *input, unsigned char *output,
...
static inline int mbedtls_ccm_star_auth_decrypt(mbedtls_ccm_context *ctx, size_t length,
                                  const unsigned char *iv, size_t iv_len,
                                  const unsigned char *add, size_t add_len,
                                  const unsigned char *input, unsigned char *output,
                                  const unsigned char *tag, size_t tag_len)
...
static inline int mbedtls_ccm_auth_decrypt(mbedtls_ccm_context *ctx, size_t length,
                             const unsigned char *iv, size_t iv_len,
                             const unsigned char *add, size_t add_len,
                             const unsigned char *input, unsigned char *output,
                             const unsigned char *tag, size_t tag_len)
 ...
 */
static inline  const unsigned char key_test_data[] = {
    0x40, 0x41, 0x42, 0x43, 0x44, 0x45, 0x46, 0x47,
    0x48, 0x49, 0x4a, 0x4b, 0x4c, 0x4d, 0x4e, 0x4f
};

static inline  const unsigned char iv_test_data[] = {
    0x10, 0x11, 0x12, 0x13, 0x14, 0x15, 0x16, 0x17,
    0x18, 0x19, 0x1a, 0x1b
};

static inline  const unsigned char ad_test_data[] = {
    0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07,
    0x08, 0x09, 0x0a, 0x0b, 0x0c, 0x0d, 0x0e, 0x0f,
    0x10, 0x11, 0x12, 0x13
};

static inline  const unsigned char msg_test_data[CCM_SELFTEST_PT_MAX_LEN] = {
...
static inline  const unsigned char res_test_data[NB_TESTS][CCM_SELFTEST_CT_MAX_LEN] = {
...
static inline int mbedtls_ccm_self_test(int verbose)
{
