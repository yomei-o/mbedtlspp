...
static inline  psa_status_t mbedtls_psa_ffdh_set_prime_generator(size_t key_size,
                                                         mbedtls_mpi *P,
                                                         mbedtls_mpi *G)
{
...
#if defined(MBEDTLS_PSA_BUILTIN_KEY_TYPE_DH_KEY_PAIR_EXPORT) || \
    defined(MBEDTLS_PSA_BUILTIN_KEY_TYPE_DH_PUBLIC_KEY)
static inline psa_status_t mbedtls_psa_ffdh_export_public_key(
...
static inline psa_status_t mbedtls_psa_ffdh_generate_key(
    const psa_key_attributes_t *attributes,
...
static inline psa_status_t mbedtls_psa_ffdh_import_key(
    const psa_key_attributes_t *attributes,
...
static inline psa_status_t mbedtls_psa_ffdh_key_agreement(
    const psa_key_attributes_t *attributes,
