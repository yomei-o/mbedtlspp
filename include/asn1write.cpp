...
static inline int mbedtls_asn1_write_len(unsigned char **p, const unsigned char *start, size_t len)
{
...
static inline int mbedtls_asn1_write_tag(unsigned char **p, const unsigned char *start, unsigned char tag)
{
    if (*p - start < 1) {
        return MBEDTLS_ERR_ASN1_BUF_TOO_SMALL;
    }
...
static inline  int mbedtls_asn1_write_len_and_tag(unsigned char **p,
...
static inline int mbedtls_asn1_write_raw_buffer(unsigned char **p, const unsigned char *start,
...
static inline int mbedtls_asn1_write_oid(unsigned char **p, const unsigned char *start,
...
static inline int mbedtls_asn1_write_algorithm_identifier(unsigned char **p, const unsigned char *start,
                                            const char *oid, size_t oid_len,
                                            size_t par_len)
{
...
static inline int mbedtls_asn1_write_algorithm_identifier_ext(unsigned char **p, const unsigned char *start,
                                                const char *oid, size_t oid_len,
...
static inline int mbedtls_asn1_write_bool(unsigned char **p, const unsigned char *start, int boolean)
{
    size_t len = 0;
...
static inline  int asn1_write_tagged_int(unsigned char **p, const unsigned char *start, int val, int tag)
{
    size_t len = 0;
...
static inline int mbedtls_asn1_write_int(unsigned char **p, const unsigned char *start, int val)
{
    return asn1_write_tagged_int(p, start, val, MBEDTLS_ASN1_INTEGER);
}

static inline int mbedtls_asn1_write_enum(unsigned char **p, const unsigned char *start, int val)
{
    return asn1_write_tagged_int(p, start, val, MBEDTLS_ASN1_ENUMERATED);
}

static inline int mbedtls_asn1_write_tagged_string(unsigned char **p, const unsigned char *start, int tag,
...
static inline int mbedtls_asn1_write_utf8_string(unsigned char **p, const unsigned char *start,
                                   const char *text, size_t text_len)
{
    return mbedtls_asn1_write_tagged_string(p, start, MBEDTLS_ASN1_UTF8_STRING, text, text_len);
}

static inline int mbedtls_asn1_write_printable_string(unsigned char **p, const unsigned char *start,
                                        const char *text, size_t text_len)
{
...
static inline int mbedtls_asn1_write_ia5_string(unsigned char **p, const unsigned char *start,
                                  const char *text, size_t text_len)
{
    return mbedtls_asn1_write_tagged_string(p, start, MBEDTLS_ASN1_IA5_STRING, text, text_len);
}

static inline int mbedtls_asn1_write_named_bitstring(unsigned char **p,
                                       const unsigned char *start,
...
static inline int mbedtls_asn1_write_bitstring(unsigned char **p, const unsigned char *start,
...
static inline int mbedtls_asn1_write_octet_string(unsigned char **p, const unsigned char *start,
                                    const unsigned char *buf, size_t size)
{
    int ret = MBEDTLS_ERR_ERROR_CORRUPTION_DETECTED;
    size_t len = 0;
...
static inline  mbedtls_asn1_named_data *asn1_find_named_data(
...
static inline mbedtls_asn1_named_data *mbedtls_asn1_store_named_data(
...
static inline int mbedtls_asn1_write_integer(unsigned char **p,
                               unsigned char *start,
