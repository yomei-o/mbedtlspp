...
static inline unsigned char mbedtls_ct_base64_enc_char(unsigned char value)
{
...
MBEDTLS_STATIC_TESTABLE
static inline signed char mbedtls_ct_base64_dec_value(unsigned char c)
{
    unsigned char val = 0;
...
static inline  const unsigned char base64_test_dec[64] =
{
...
static inline  const unsigned char base64_test_enc[] =
 ...
 * Checkup routine
 */
static inline int mbedtls_base64_self_test(int verbose)
{
    size_t len;
