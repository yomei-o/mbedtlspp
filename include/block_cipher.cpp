...
#if defined(MBEDTLS_BLOCK_CIPHER_SOME_PSA)
static inline  psa_key_type_t psa_key_type_from_block_cipher_id(mbedtls_block_cipher_id_t cipher_id)
{
    switch (cipher_id) {
...
static inline  int mbedtls_cipher_error_from_psa(psa_status_t status)
{
...
static inline void mbedtls_block_cipher_free(mbedtls_block_cipher_context_t *ctx)
{
    if (ctx == NULL) {
        return;
    }
...
static inline int mbedtls_block_cipher_setup(mbedtls_block_cipher_context_t *ctx,
...
static inline int mbedtls_block_cipher_setkey(mbedtls_block_cipher_context_t *ctx,
...
static inline int mbedtls_block_cipher_encrypt(mbedtls_block_cipher_context_t *ctx,
