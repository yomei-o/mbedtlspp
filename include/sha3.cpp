...
static inline  const uint8_t iota_r_packed[24] = {
...
static inline  const uint32_t rho[6] = {
    0x3f022425, 0x1c143a09, 0x2c3d3615, 0x27191713, 0x312b382e, 0x3e030832
};

static inline  const uint32_t pi[6] = {
...
static inline  void keccak_f1600(mbedtls_sha3_context *ctx)
{
    uint64_t lane[5];
...
static inline void mbedtls_sha3_init(mbedtls_sha3_context *ctx)
{
    memset(ctx, 0, sizeof(mbedtls_sha3_context));
}

static inline void mbedtls_sha3_free(mbedtls_sha3_context *ctx)
{
    if (ctx == NULL) {
        return;
    }
...
static inline void mbedtls_sha3_clone(mbedtls_sha3_context *dst,
 ...
 * SHA-3 context setup
 */
static inline int mbedtls_sha3_starts(mbedtls_sha3_context *ctx, mbedtls_sha3_id id)
{
 ...
 */
static inline int mbedtls_sha3_update(mbedtls_sha3_context *ctx,
                        const uint8_t *input,
                        size_t ilen)
{
    if (ilen >= 8) {
...
static inline int mbedtls_sha3_finish(mbedtls_sha3_context *ctx,
 ...
 */
static inline int mbedtls_sha3(mbedtls_sha3_id id, const uint8_t *input,
...
static inline  const unsigned char test_data_2[2][4] =
{
    "",
    "abc",
};

static inline  const size_t test_data_len_2[2] =
{
    0, /* "" */
    3  /* "abc" */
};
...
#if defined(MBEDTLS_PSA_BUILTIN_ALG_SHA3_224)
static inline  const unsigned char test_hash_sha3_224[2][28] =
{
    { /* "" */
...
#if defined(MBEDTLS_PSA_BUILTIN_ALG_SHA3_256)
static inline  const unsigned char test_hash_sha3_256[2][32] =
{
    { /* "" */
...
#if defined(MBEDTLS_PSA_BUILTIN_ALG_SHA3_384)
static inline  const unsigned char test_hash_sha3_384[2][48] =
{
    { /* "" */
...
#if defined(MBEDTLS_PSA_BUILTIN_ALG_SHA3_512)
static inline  const unsigned char test_hash_sha3_512[2][64] =
{
    { /* "" */
...
#if defined(MBEDTLS_PSA_BUILTIN_ALG_SHA3_224)
static inline  const unsigned char long_kat_hash_sha3_224[28] =
{
...
#if defined(MBEDTLS_PSA_BUILTIN_ALG_SHA3_256)
static inline  const unsigned char long_kat_hash_sha3_256[32] =
{
...
#if defined(MBEDTLS_PSA_BUILTIN_ALG_SHA3_384)
static inline  const unsigned char long_kat_hash_sha3_384[48] =
{
...
#if defined(MBEDTLS_PSA_BUILTIN_ALG_SHA3_512)
static inline  const unsigned char long_kat_hash_sha3_512[64] =
{
...
static inline  int mbedtls_sha3_kat_test(int verbose,
                                 ...
                                 int test_num)
{
    ...
    result = mbedtls_sha3(id,
                          test_data_2[test_num], test_data_len_2[test_num],
                          hash, sizeof(hash));
    if (result != 0) {
        if (verbose != 0) {
...
static inline  int mbedtls_sha3_long_kat_test(int verbose,
                                      const char *type_name,
                                      mbedtls_sha3_id id)
{
    mbedtls_sha3_context ctx;
...
#if defined(MBEDTLS_SHA3_WANT_SHAKE128)
static inline  const unsigned char shake128_test_input[2][16] =
{
    {
...
static inline  const unsigned char shake128_test_output[2][16] =
{
    {
...
#if defined(MBEDTLS_SHA3_WANT_SHAKE256)
static inline  const unsigned char shake256_test_input[2][32] =
{
    {
...
static inline  const unsigned char shake256_test_output[2][32] =
{
    {
...
static inline  int mbedtls_shake_self_test(int verbose)
{
    uint8_t output[32];
    int i;
    int result;
...
static inline int mbedtls_sha3_self_test(int verbose)
{
    int i;
